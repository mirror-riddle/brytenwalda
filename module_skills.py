...
skills = [
  ...
  ("leadership","Leadership",sf_base_att_cha,10,"Every point increases maximum number of troops you can command by 1, and  every leader point reduces troop wages by 5%%. (Party/Leader skill)"), #cambiado chief motomataru
  ("prisoner_management", "Prisoner Management",sf_base_att_cha|sf_inactive,10,"Every level of this skill increases maximum number of prisoners by 10 and reduces imprisoned Lord escape chances by 2%%. Lords have a chance to escape captivity each week: 30%% held in the party, 15%% held in castle/town, 5%% held in a castle/town with prison tower. (Leader skill)"),
#  ("reserved_1","Reserved Skill 1",sf_base_att_cha|sf_inactive,10,"This is a reserved skill."),
 ("entertain","Entertain",sf_base_att_cha|sf_effects_party,15,"Every day that you rest, each hero with this skill increases the morale of the party. It also helps you while begging or performing. Drive it past 10, and you could become the next bardic sensation! (Personal skill)."),    #MOTO tweak entertainment
  ...
  ("trainer","Trainer",sf_base_att_int|sf_effects_party,10,"Every day, each hero with this skill adds some experience to every other member of the party whose level is lower than his/hers. Experience gained goes as: {0,4,10,16,23,30,38,46,55,65,80}. (Personal skill)"),
...
## Jrider + FORAGING 1.0 adding skill chief
  ...
  ("horse_archery","Horse Archery",sf_base_att_agi|sf_inactive,5,"Reduces damage and accuracy penalties for archery and throwing from horseback. Max level 5 (Personal skill)"),
  ...
  ("athletics","Athletics",sf_base_att_agi,6,"Improves your running speed. If you use heavy armor, you will be slower. Max Level 6 (Personal skill)"),
  ("shield","Shield",sf_base_att_agi,3,"Reduces damage to shields (by 8%% per skill level) and improves shield speed and coverage. Max level: 3 (Personal skill)"),
  ...
  ("power_draw","Power Draw",sf_base_att_str,5,"Lets character use more powerful bows. Each point to this skill (up to four plus power-draw requirement of the bow) increases bow damage by 14%%. Max Level 5 (Personal skill)"),
  ("power_throw","Power Throw",sf_base_att_str,5,"Each point to this skill increases throwing damage by 10%%.Max Level 5 (Personal skill)"),
  ("power_strike","Power Strike",sf_base_att_str,5,"Each point to this skill increases melee damage by 8%%. Max Level 5 (Personal skill)"),
