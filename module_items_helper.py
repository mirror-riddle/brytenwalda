...
all_robes_tunics_shirts = create_all_items_simple([
  ...
  (
    ...
    [
      ...
      weight(2)|abundance(60)|head_armor(0)|body_armor(14)|leg_armor(2)|difficulty(0),
  ...
  (
    ...
    [
      ...
      weight(2)|abundance(60)|head_armor(0)|body_armor(11)|leg_armor(2)|difficulty(0),
      imodbits_cloth, [], pictish_irish_kindoms
    ]
...
all_women_hats = create_all_items_simple([
  (
    ...
    [
      ...
      weight(0.5)|abundance(100)|head_armor(5)|body_armor(0)|leg_armor(0)|difficulty(0),
      imodbits_cloth
    ]
  ), # veils
  (
    ...
    [
      ...
      weight(0.5)|abundance(10)|head_armor(2)|body_armor(0)|leg_armor(0)|difficulty(0),
      imodbits_cloth
    ]
  ), # wimple
])
...
all_women_dresses = create_all_items_simple([
  (
    ...
    [
      itp_merchandise|itp_type_body_armor|itp_covers_legs|itp_civilian, 0, 500,
      weight(3)|abundance(100)|head_armor(0)|body_armor(10)|leg_armor(10)|difficulty(0),
      imodbits_cloth
    ]
  ), # women dress
])
...
all_pictish_clothes = create_all_items_simple([
  ...
  (
    ...
    [
      ...
      weight(5)|abundance(60)|head_armor(0)|body_armor(15)|leg_armor(6)|difficulty(0),
      imodbits_cloth, [], pictish_irish_kindoms
    ]
  ), # cloaked body
  (
...
all_heavy_armors = create_all_items_simple([
  (
    ...
    [
      ...
      imodbits_armor, [], pictish_irish_kindoms
    ]
...
all_light_armors = create_all_items_simple([
  ...
  (
    ...
    [
      ...
      weight(1)|abundance(100)|head_armor(0)|body_armor(5)|leg_armor(1)|difficulty(0),
      imodbits_armor
    ]
  ),
])
...
all_light_helments = create_all_items_simple([
  ...
  (
    ...
    [
      ...
      weight(1)|abundance(90)|head_armor(10)|body_armor(0)|leg_armor(0)|difficulty(0),
      imodbits_cloth
    ]
  ),
  (
  ...
  (
    ...
    [
      ...
      weight(0.5)|abundance(10)|head_armor(8)|body_armor(0)|leg_armor(0)|difficulty(0),
      imodbits_cloth
    ]
  ),
  (
    ...
    [
      ...
      weight(0.5)|abundance(10)|head_armor(6)|body_armor(0)|leg_armor(0)|difficulty(0),
      imodbits_cloth
    ]
  ),
  (
    ...
    [
      ...
      weight(2)|abundance(50)|head_armor(1)|body_armor(10)|leg_armor(5) ,imodbits_cloth, [], pictish_irish_kindoms
    ]
  ),
  (
    [
  ...
  (
    ...
    [
      itp_merchandise|itp_type_head_armor|itp_attach_armature|itp_doesnt_cover_hair|itp_fit_to_head|itp_civilian, 0, 580,
      weight(1)|abundance(50)|head_armor(1)|body_armor(10)|leg_armor(5), imodbits_cloth, [], angle_saxon_kingdoms
    ]
  ),
  (
    [
