...
from process_common import convert_to_identifier, replace_spaces, lf_open
...
def save_party_templates():
    ...
    for party_template in party_templates:
        ...
        file.write("pt_%s %s %d %d %d %d " % (convert_to_identifier(party_template[0]), replace_spaces(
            party_template[1]), party_template[2], party_template[3], party_template[4], party_template[5]))
...
def save_python_header():
    file = lf_open("./ID_party_templates.py", "w")
