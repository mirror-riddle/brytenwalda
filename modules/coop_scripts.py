...
from headers.presentations import tf_scrollable_style_2
...
coop_scripts = [
    ...
    ("coop_on_admin_panel_load",
     [
         ...
         # clamp(((15.0f + advantage) / 15.0f), 0.2f, 2.5f) * number of allies
         (dict_get_int, ":battle_advantage", "$coop_dict", "@battle_adv"),
         ...
         # clamp to 0.5 ~ 2.0 (this ends up reducing the effect of battle advantage)
         (val_clamp, "$coop_team_ratio", 500, 2000),
         ...
         (multiplayer_send_int_to_server, multiplayer_event_admin_set_friendly_fire_damage_self_ratio,
             "$coop_set_friendly_fire_damage_self_ratio"),
         (multiplayer_send_int_to_server, multiplayer_event_admin_set_friendly_fire_damage_friend_ratio,
             "$coop_set_friendly_fire_damage_friend_ratio"),
    ...
    ("coop_copy_settings_to_file",
     [
         ...
         (neg | is_vanilla_warband),
         (try_begin),
         # copy setting at end of battle (only ones that use native variables that may be changed in other modes)
    ...
    ("coop_server_player_joined_common",
        [
            ...
            (multiplayer_send_2_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
                coop_event_return_castle_party, "$coop_map_party"),
            (get_max_players, ":num_players"),
            (try_for_range, ":all_player_no", 0, ":num_players"),
            (player_is_active, ":all_player_no"),
            ...
            (multiplayer_send_4_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
                coop_event_player_set_slot, ":other_player_selected_troop", ":all_player_no", slot_player_coop_selected_troop),
            (try_end),
            ...
            (multiplayer_send_4_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
                coop_event_store_hero_troops, ":hero_troop", coop_temp_party_enemy_heroes),
            # NEW
            (try_begin),
            ...
            (multiplayer_send_4_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
                coop_event_troop_raise_attribute, ":value", ":hero_troop", ":attribut"),
            (try_end),
            ...
            (gt, ":value", 0),
            (multiplayer_send_4_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
                coop_event_troop_raise_skill, ":value", ":hero_troop", ":skill"),
            (try_end),
            (try_for_range, ":wprof", wpt_one_handed_weapon, 7),
            (store_proficiency_level, ":value", ":hero_troop", ":wprof"),
            (multiplayer_send_4_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
             coop_event_troop_raise_proficiency_linear, ":value", ":hero_troop", ":wprof"),
            (try_end),
            (try_end),
            ...
            (multiplayer_send_4_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
                coop_event_store_hero_troops, ":hero_troop", coop_temp_party_ally_heroes),
            # NEW
            (try_begin),
            # (neg|is_between, ":hero_troop", kings_begin, pretenders_end),
            (str_store_troop_name, s0, ":hero_troop"),
            ...
            (multiplayer_send_3_int_to_player, ":player_no", multiplayer_event_coop_send_to_player, coop_event_round,
                "$coop_round", "$coop_battle_started"),  # start welcome message after getting team data
        ]),
    ...
    ("coop_receive_network_message",
        [
            ...
            (try_for_range, ":all_player_no", 0, ":num_players"),
            (player_is_active, ":all_player_no"),
            (multiplayer_send_4_int_to_player, ":all_player_no", multiplayer_event_coop_send_to_player,
             coop_event_player_set_slot, ":troop", ":player_no", slot_player_coop_selected_troop),
            (try_end),
            (try_end),
            ...
            (player_is_active, ":all_player_no"),
            (multiplayer_send_4_int_to_player, ":all_player_no", multiplayer_event_coop_send_to_player,
             coop_event_player_set_slot, 0, ":player_no", slot_player_coop_selected_troop),
            (try_end),
            (try_end),
            (player_set_slot, ":player_no", slot_player_coop_selected_troop, 0),
            (try_end),
            (else_try),
            # also called from native script for slot_player_bot_type_1_wanted, slot_player_bot_type_4_wanted
            ...
            (try_begin),
            (is_between, ":slot_no", slot_player_coop_class_0_wanted,
             slot_player_coop_class_8_wanted + 1),  # coop only slots
            ...
            (multiplayer_send_2_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
             coop_event_return_battle_state, "$coop_battle_state"),
            (this_or_next | eq, "$g_multiplayer_game_type", multiplayer_game_type_coop_battle),
            (eq, "$g_multiplayer_game_type", multiplayer_game_type_coop_siege),
            ...
            (try_for_range, ":all_player_no", 0, ":num_players"),
            (player_is_active, ":all_player_no"),
            (multiplayer_send_4_int_to_player, ":all_player_no",
             multiplayer_event_coop_send_to_player, coop_event_set_scene_1, "$coop_time_of_day"),
            (multiplayer_send_4_int_to_player, ":all_player_no",
             multiplayer_event_coop_send_to_player, coop_event_set_scene_2, "$coop_rain"),
            (multiplayer_send_4_int_to_player, ":all_player_no",
             multiplayer_event_coop_send_to_player, coop_event_set_scene_3, "$coop_cloud"),
            (multiplayer_send_4_int_to_player, ":all_player_no",
             multiplayer_event_coop_send_to_player, coop_event_set_scene_4, "$coop_haze"),
            (multiplayer_send_4_int_to_player, ":all_player_no",
             multiplayer_event_coop_send_to_player, coop_event_set_scene_5, "$coop_castle_banner"),
            (try_end),
            ...
            (multiplayer_send_2_int_to_player, ":player_no",
             multiplayer_event_coop_send_to_player, coop_event_receive_next_string, 3),
            ...
            (multiplayer_send_2_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
             coop_event_return_battle_state, "$coop_battle_state"),
            (multiplayer_send_2_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
             coop_event_return_skip_menu, "$coop_skip_menu"),
            (try_end),
            (else_try),
            ...
            (call_script, "script_coop_server_send_admin_setttings_to_player", ":player_no"),
            (multiplayer_send_int_to_player, ":player_no",
             multiplayer_event_coop_send_to_player, coop_event_return_open_game_rules),
            (else_try),
            ...
            (multiplayer_send_4_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
             coop_event_inv_troop_set_slot, ":slot", ":player_cur_item", ":player_cur_imod"),
            (try_end),
            (multiplayer_send_int_to_player, ":player_no",
             multiplayer_event_coop_send_to_player, coop_event_prsnt_coop_item_select),  # done
            (try_end),
            ...
            (eq, reg0, 1),
            (multiplayer_send_4_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
             coop_event_send_inventory, ":slot", ":item", ":imod"),
            # (assign, reg1, ":slot"),
            ...
            (multiplayer_send_4_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
             coop_event_inv_troop_set_slot, ":equip_slot", ":player_cur_item", ":player_cur_imod"),
            (multiplayer_send_int_to_player, ":player_no",
             multiplayer_event_coop_send_to_player, coop_event_prsnt_coop_item_select),  # done
            ...
            (multiplayer_send_2_int_to_server, multiplayer_event_set_bot_selection,
             slot_player_bot_type_1_wanted, "$g_multiplayer_bot_type_1_wanted"),
            (multiplayer_send_2_int_to_server, multiplayer_event_set_bot_selection,
                slot_player_bot_type_2_wanted, "$g_multiplayer_bot_type_2_wanted"),
            (multiplayer_send_2_int_to_server, multiplayer_event_set_bot_selection,
                slot_player_bot_type_3_wanted, "$g_multiplayer_bot_type_3_wanted"),
            (multiplayer_send_2_int_to_server, multiplayer_event_set_bot_selection,
                slot_player_bot_type_4_wanted, "$g_multiplayer_bot_type_4_wanted"),

            (multiplayer_send_2_int_to_server, multiplayer_event_set_bot_selection,
                slot_player_coop_class_0_wanted, "$coop_class_0_wanted"),
            (multiplayer_send_2_int_to_server, multiplayer_event_set_bot_selection,
                slot_player_coop_class_1_wanted, "$coop_class_1_wanted"),
            (multiplayer_send_2_int_to_server, multiplayer_event_set_bot_selection,
                slot_player_coop_class_2_wanted, "$coop_class_2_wanted"),
            (multiplayer_send_2_int_to_server, multiplayer_event_set_bot_selection,
                slot_player_coop_class_3_wanted, "$coop_class_3_wanted"),
            (multiplayer_send_2_int_to_server, multiplayer_event_set_bot_selection,
                slot_player_coop_class_4_wanted, "$coop_class_4_wanted"),
            (multiplayer_send_2_int_to_server, multiplayer_event_set_bot_selection,
                slot_player_coop_class_5_wanted, "$coop_class_5_wanted"),
            (multiplayer_send_2_int_to_server, multiplayer_event_set_bot_selection,
                slot_player_coop_class_6_wanted, "$coop_class_6_wanted"),
            (multiplayer_send_2_int_to_server, multiplayer_event_set_bot_selection,
                slot_player_coop_class_7_wanted, "$coop_class_7_wanted"),
            (multiplayer_send_2_int_to_server, multiplayer_event_set_bot_selection,
                slot_player_coop_class_8_wanted, "$coop_class_8_wanted"),
            ...
            # slot matching multi_data_item_button_indices_begin stores which inventory slot this item is from
            (troop_set_slot, "trp_temp_troop", ":cur_slot_index", ":inv_slot"),
    ...
    ("coop_server_send_admin_setttings_to_player",
        [
            ...
            (multiplayer_send_int_to_player, ":player_no",
             multiplayer_event_return_renaming_server_allowed, "$g_multiplayer_renaming_server_allowed"),
            ...
            (multiplayer_send_int_to_player, ":player_no",
             multiplayer_event_return_melee_friendly_fire, ":server_melee_friendly_fire"),
            (server_get_friendly_fire_damage_self_ratio, ":friendly_fire_damage_self_ratio"),
            (multiplayer_send_int_to_player, ":player_no",
             multiplayer_event_return_friendly_fire_damage_self_ratio, ":friendly_fire_damage_self_ratio"),
            (server_get_friendly_fire_damage_friend_ratio, ":friendly_fire_damage_friend_ratio"),
            (multiplayer_send_int_to_player, ":player_no",
             multiplayer_event_return_friendly_fire_damage_friend_ratio, ":friendly_fire_damage_friend_ratio"),
            ...
            (multiplayer_send_int_to_player, ":player_no",
             multiplayer_event_return_control_block_dir, ":server_control_block_dir"),
            ...
            (multiplayer_send_int_to_player, ":player_no",
             multiplayer_event_return_add_to_servers_list, ":server_add_to_servers_list"),
            (multiplayer_send_int_to_player, ":player_no",
             multiplayer_event_return_player_respawn_as_bot, "$g_multiplayer_player_respawn_as_bot"),
            (multiplayer_send_int_to_player, ":player_no",
             multiplayer_event_return_valid_vote_ratio, "$g_multiplayer_valid_vote_ratio"),
            (str_store_server_name, s0),
            (multiplayer_send_string_to_player, ":player_no", multiplayer_event_return_server_name, s0),
            (multiplayer_send_3_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
             coop_event_return_team_faction, 1, "$coop_team_1_faction"),
            (multiplayer_send_3_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
             coop_event_return_team_faction, 2, "$coop_team_2_faction"),
            (multiplayer_send_2_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
             coop_event_return_spawn_formation, "$coop_battle_spawn_formation"),
            (multiplayer_send_2_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
             coop_event_return_battle_size, "$coop_battle_size"),
            (multiplayer_send_2_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
             coop_event_return_game_type, "$g_multiplayer_game_type"),
            (multiplayer_send_2_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
             coop_event_return_castle_party, "$coop_map_party"),
            (multiplayer_send_2_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
             coop_event_return_battle_scene, "$coop_battle_scene"),
            (multiplayer_send_2_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
             coop_event_return_disable_inventory, "$coop_disable_inventory"),
            (multiplayer_send_2_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
             coop_event_return_reduce_damage, "$coop_reduce_damage"),
        ]),
    ...
    ("coop_move_belfries_to_their_first_entry_point",
        [
            ...
            (store_add, ":belfry_first_entry_point_id", 5, ":belfry_no"),
            ...
            # this code block is taken from mission_templates.py (multiplayer_server_check_belfry_movement)
            ...
            # learn distance between 5 meters back of entry point(pos10) and ground level at left part of belfry
            (position_get_distance_to_terrain, ":height_to_terrain_1", pos10),

            (init_position, pos9),
            (position_set_y, pos9, -500),  # go 5.0 meters back
            (position_set_x, pos9, 300),  # go 3.0 meters right
            (position_transform_position_to_parent, pos10, pos1, pos9),
            # learn distance between 5 meters back of entry point(pos10) and ground level at right part of belfry
            (position_get_distance_to_terrain, ":height_to_terrain_2", pos10),
            ...
            # if there is 1 meters of distance (100cm) then next target position will rotate by 2 degrees. #ac sonra
            (store_div, ":rotate_angle_of_next_entry_point", ":height_to_terrain", 24),
            (init_position, pos20),
            ...
            (init_position, pos9),
            (position_set_x, pos9, -300),  # go 3.0 meters left
            # applying 3.0 meters in -x to position of next entry point target, final result is in pos10
            (position_transform_position_to_parent, pos10, pos1, pos9),
            # learn distance between 3.0 meters left of entry point(pos10) and ground level
            (position_get_distance_to_terrain, ":height_to_terrain_at_left", pos10),
            (init_position, pos9),
            (position_set_x, pos9, 300),  # go 3.0 meters left
            # applying 3.0 meters in x to position of next entry point target, final result is in pos10
            (position_transform_position_to_parent, pos10, pos1, pos9),
            # learn distance between 3.0 meters right of entry point(pos10) and ground level
            (position_get_distance_to_terrain, ":height_to_terrain_at_right", pos10),
            ...
            # if there is 1 meters of distance (100cm) then next target position will rotate by 25 degrees.
            (store_div, ":rotate_angle_of_next_entry_point", ":height_to_terrain", 24),
    ...
    ("coop_spawn_formation",
        [
            ...
            # agent_get_class only works after horsemen have horses
            (agent_get_division, ":agent_class", ":human_agent"),
    ...
    ("coop_change_leader_of_bot",
        [
            ...
            # use to store class in MP (so we dont affect ai classes too)
            (troop_get_slot, ":troop_class", ":agent_troop", slot_troop_current_rumor),
    ...
    ("coop_find_bot_troop_for_spawn",
        [
            ...
            # get one troop from each party per cycle
            (party_stack_get_troop_id, ":selected_troop", "$coop_cur_temp_party_enemy", 0),
            ...
            (try_for_range, ":unused", 0, ":end"),
            # get one troop from each party per cycle
            (party_stack_get_troop_id, ":selected_troop", "$coop_cur_temp_party_ally", 0),
            (try_begin),
            (gt, ":selected_troop", 0),
            ...
            (multiplayer_send_2_int_to_player, ":player_no",
             multiplayer_event_coop_send_to_player, coop_event_troop_banner, "$coop_agent_banner"),
            (try_end),
    ...
    ("coop_server_on_agent_killed_or_wounded_common",
        [
            ...
            (multiplayer_is_server),
            (agent_get_slot, ":killer_agent_party", ":killer_agent_no",
             slot_agent_coop_spawn_party),  # slot_agent_coop_spawn_party = SP party
            (agent_get_slot, ":dead_agent_party", ":dead_agent_no",
             slot_agent_coop_spawn_party),  # slot_agent_coop_spawn_party = SP party
    ...
    ("coop_copy_parties_to_file_sp",
        [
            ...
            (try_begin),
            # get number of troops for large or medium scene size
            (store_add, ":total_fit_for_battle", "$g_enemy_fit_for_battle", "$g_friend_fit_for_battle"),
            ...
            # store null (0 could be a valid number for this variable)
            (dict_set_int, "$coop_dict", "@p_castle_lord", -1),
            ...
            # can't store index of leader party here because we don't know it yet
            (party_get_slot, ":cur_leader", ":party_no", slot_town_lord),
            (ge, ":cur_leader", 0),
    ...
    ("coop_copy_file_to_parties_mp",
        [
            ...
            # when copy to MP wounded troops have already been removed
            (party_add_members, ":party_no", ":stack_troop", ":stack_size"),
            ...
            (troop_set_slot, ":stack_troop", slot_troop_current_rumor,
                ":troop_class"),  # store main party troop class in this slot
            (try_end),
            (try_begin),
            (troop_is_hero, ":stack_troop"),
            (eq, ":stack_size", 1),  # if alive
    ...
    ("coop_copy_file_to_parties_sp",
        [
            ...
            (party_add_members, "p_total_enemy_casualties", ":stack_troop",
             ":stack_total_casualties"),  # add casualties for loot
            (party_wound_members, "p_total_enemy_casualties", ":stack_troop", ":stack_wounded"),
            (party_add_members, "p_enemy_casualties", ":stack_troop",
             ":stack_total_casualties"),  # add casualties for reports/morale
    ...
    ("coop_copy_hero_to_file",
        [
            ...
            # start from "skl_trade" if all skills are needed
            (try_for_range, reg20, "skl_horse_archery", "skl_reserved_14"),
            ...
            (try_begin),
            # need this so we dont equip lords with civilian clothes in battle
            (neg | is_between, ":cur_troop", kings_begin, pretenders_end),
    ...
    ("coop_copy_file_to_hero",
        [
            ...
            (party_get_skill_level, ":player_party_first_aid", "p_main_party",
             "skl_first_aid"),  # currently we get medic skill before wounding heroes
            ...
            (try_begin),
            (neg | game_in_multiplayer_mode),
            # these items would need to copy correct quantity still need to copy to MP to take up inv capacity
