...
#  2) Scene prop flags. See headers.scene_props.py for a list of available flags
...
check_item_use_trigger = (ti_on_scene_prop_use,
                          [
                              ...
                              (multiplayer_send_2_int_to_player, ":player_no",
                               multiplayer_event_use_item, ":instance_id", ":agent_id"),
                              (try_end),
                          ])
...
check_sally_door_use_trigger_double = (ti_on_scene_prop_use,
                                       [
                                           ...
                                           (scene_prop_get_slot, ":opened_or_closed",
                                            ":instance_id", scene_prop_open_or_close_slot),
                                           ...
                                           # for only server itself-----------------------------------------------------------------------------------------------
                                           (get_max_players, ":num_players"),
                                           # 0 is server so starting from 1
...
scene_props = [
    ...
    ("fake_houses_steppe_a", 0, "fake_houses_steppe_a", "0", [
        (ti_on_init_scene_prop, [(assign, ":durability", never_broken), (store_trigger_param_1, ":instance_no"),
                                 (call_script, "script_flammable_object_initialize", ":instance_no", ":durability", 0), ]),
    ...
    ("catapult_destructible", sokf_moveable | sokf_show_hit_point_bar | sokf_destructible, "Catapult", "bo_Catapult", [
        ...
        (ti_on_scene_prop_destroy,
         [
             ...
             # 1 means destroyed object is a catapult
             (store_mul, ":target_no_mul_scene_prop_team", ":scene_prop_team_no_multiplier", 1),
             # for only server itself-----------------------------------------------------------------------------------------------
             (call_script, "script_show_multiplayer_message",
              multiplayer_message_type_target_destroyed, ":target_no_mul_scene_prop_team"),
             # for only server itself-----------------------------------------------------------------------------------------------
             (get_max_players, ":num_players"),
             (try_for_range, ":player_no", 1, ":num_players"),
             (player_is_active, ":player_no"),
             (multiplayer_send_2_int_to_player, ":player_no", multiplayer_event_show_multiplayer_message,
              multiplayer_message_type_target_destroyed, ":target_no_mul_scene_prop_team"),
             (try_end),
             (val_add, "$g_number_of_targets_destroyed", 1),
             (else_try),
             # 9 means attackers destroyed all targets
             (store_mul, ":target_no_mul_scene_prop_team", ":scene_prop_team_no_multiplier", 9),
             # for only server itself-----------------------------------------------------------------------------------------------
             (call_script, "script_show_multiplayer_message",
              multiplayer_message_type_target_destroyed, ":target_no_mul_scene_prop_team"),
             # for only server itself-----------------------------------------------------------------------------------------------
             ...
             # give money to player which helped flag to be owned by new_flag_owner team
    ...
    ("dungeon_door_direction_a", sokf_destructible | spr_hit_points(8000), "dungeon_door_direction_a", "bo_dungeon_door_direction_a", [
        (ti_on_init_scene_prop, [(assign, ":durability", 80000), (store_trigger_param_1, ":instance_no"), (call_script,
                                                                                                           "script_flammable_object_initialize", ":instance_no", ":durability", "spr_dungeon_door_direction_a"), ]),
        (ti_on_scene_prop_hit, [(assign, ":flammability", 10), (store_trigger_param_1, ":instance_no"), (store_trigger_param_2,
                                                                                                         ":damage"), (call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"), ]),
    ...
    ("dungeon_door_direction_b", sokf_destructible | spr_hit_points(8000), "dungeon_door_direction_b", "bo_dungeon_door_direction_a", [
        (ti_on_init_scene_prop, [(assign, ":durability", 80000), (store_trigger_param_1, ":instance_no"), (call_script,
                                                                                                           "script_flammable_object_initialize", ":instance_no", ":durability", "spr_dungeon_door_direction_b"), ]),
        (ti_on_scene_prop_hit, [(assign, ":flammability", 10), (store_trigger_param_1, ":instance_no"), (store_trigger_param_2,
                                                                                                         ":damage"), (call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"), ]),
        (ti_on_scene_prop_destroy, [(display_message, "@Gate was destroyed."), (store_trigger_param_1, ":instance_no"), (call_script, "script_object_destroy", ":instance_no"), ])]),
    ...
    ("castle_drawbridge_open", sokf_destructible | spr_hit_points(8000), "castle_drawbridges_open", "bo_castle_drawbridges_open", [
        (ti_on_init_scene_prop, [(assign, ":durability", 7500), (store_trigger_param_1, ":instance_no"),
                                 (call_script, "script_flammable_object_initialize", ":instance_no", ":durability", 0), ]),
        (ti_on_scene_prop_hit, [(assign, ":flammability", 10), (store_trigger_param_1, ":instance_no"), (store_trigger_param_2,
                                                                                                         ":damage"), (call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"), ]),
    ...
    ("belfry_a", sokf_moveable | sokf_destructible | spr_hit_points(15000), "belfry_a", "bo_belfry_a", [  # sokf_moveable
        (ti_on_init_scene_prop, [(assign, ":durability", 14800), (store_trigger_param_1, ":instance_no"),
                                 (call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_belfry_a"), ]),
        (ti_on_scene_prop_hit, [(assign, ":flammability", 10), (store_trigger_param_1, ":instance_no"), (store_trigger_param_2, ":damage"), (assign, reg60,
                                                                                                                                             ":damage"), (display_message, "str_delivered_damage"), (call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"), ]),
        (ti_on_scene_prop_destroy, [
            (store_trigger_param_1, ":instance_no"),
    ...
    ("belfry_b", sokf_moveable | sokf_destructible | spr_hit_points(15000), "belfry_b", "bo_belfry_b", [
        (ti_on_init_scene_prop, [(assign, ":durability", 14800), (store_trigger_param_1, ":instance_no"),
                                 (call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_belfry_b"), ]),
        (ti_on_scene_prop_hit, [(assign, ":flammability", 10), (store_trigger_param_1, ":instance_no"), (store_trigger_param_2, ":damage"), (assign, reg60,
                                                                                                                                             ":damage"), (display_message, "str_delivered_damage"), (call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"), ]),
        (ti_on_scene_prop_destroy, [
            (store_trigger_param_1, ":instance_no"),
    ...
    ("belfry_b_platform_a", sokf_moveable | sokf_destructible | spr_hit_points(15000), "belfry_b_platform_a", "bo_belfry_b_platform_a", [
        (ti_on_init_scene_prop, [(assign, ":durability", 14800), (store_trigger_param_1, ":instance_no"),
                                 (call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_belfry_platform_a"), ]),
        (ti_on_scene_prop_hit, [(assign, ":flammability", 10), (store_trigger_param_1, ":instance_no"), (store_trigger_param_2,
                                                                                                         ":damage"), (call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"), ]),
    ...
    ("belfry_platform_b", sokf_moveable | sokf_destructible | spr_hit_points(15000), "belfry_platform_b", "bo_belfry_platform_b", [  # sokf_moveable
        (ti_on_init_scene_prop, [(assign, ":durability", 14800), (store_trigger_param_1, ":instance_no"),
                                 (call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_belfry_platform_b"), ]),
        (ti_on_scene_prop_hit, [(assign, ":flammability", 10), (store_trigger_param_1, ":instance_no"), (store_trigger_param_2,
                                                                                                         ":damage"), (call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"), ]),
        (ti_on_scene_prop_destroy, [(display_message, "@Ladder was destroyed."), (store_trigger_param_1, ":instance_no"), (call_script, "script_object_destroy", ":instance_no"), ])]),
    ...
    ("ram_body", sokf_moveable | sokf_destructible | spr_hit_points(15000), "ram_body", "bo_ram_body", [
        (ti_on_init_scene_prop, [(assign, ":durability", 14800), (store_trigger_param_1, ":instance_no"),
                                 (call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_ram_body"), ]),
        (ti_on_scene_prop_hit, [(assign, ":flammability", 10), (store_trigger_param_1, ":instance_no"), (store_trigger_param_2, ":damage"), (assign, reg60,
                                                                                                                                             ":damage"), (display_message, "str_delivered_damage"), (call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"), ]),
        (ti_on_scene_prop_destroy, [
            (store_trigger_param_1, ":instance_no"),
    ...
    ("trebuchet_destructible", sokf_moveable | sokf_show_hit_point_bar | sokf_destructible, "trebuchet_new", "bo_trebuchet_old", [
        ...
        (ti_on_scene_prop_destroy,
         [
             ...
             # 2 means destroyed object is a trebuchet
             (store_mul, ":target_no_mul_scene_prop_team", ":scene_prop_team_no_multiplier", 2),
    ...
    ("ramp_12m", sokf_destructible | spr_hit_points(5000), "ramp_12m", "bo_ramp_12m", [
        (ti_on_init_scene_prop, [(assign, ":durability", 4800), (store_trigger_param_1, ":instance_no"),
                                 (call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_ramp_12m"), ]),
        (ti_on_scene_prop_hit, [(assign, ":flammability", 10), (store_trigger_param_1, ":instance_no"), (store_trigger_param_2,
                                                                                                         ":damage"), (call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"), ]),
        (ti_on_scene_prop_destroy, [(display_message, "@Ladder was destroyed."), (store_trigger_param_1, ":instance_no"), (call_script, "script_object_destroy", ":instance_no"), ])]),
    ("ramp_14m", sokf_destructible | spr_hit_points(5000), "ramp_14m", "bo_ramp_14m", [
        (ti_on_init_scene_prop, [(assign, ":durability", 4800), (store_trigger_param_1, ":instance_no"),
                                 (call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_ramp_14m"), ]),
        (ti_on_scene_prop_hit, [(assign, ":flammability", 10), (store_trigger_param_1, ":instance_no"), (store_trigger_param_2,
                                                                                                         ":damage"), (call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"), ]),
        (ti_on_scene_prop_destroy, [(display_message, "@Ladder was destroyed."), (store_trigger_param_1, ":instance_no"), (call_script, "script_object_destroy", ":instance_no"), ])]),
    ...
    ("portcullis", sokf_destructible | spr_hit_points(5000), "portcullis_a", "bo_portcullis_a", [
        (ti_on_init_scene_prop, [(assign, ":durability", 4800), (store_trigger_param_1, ":instance_no"),
                                 (call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_portcullis"), ]),
        (ti_on_scene_prop_hit, [(assign, ":flammability", 10), (store_trigger_param_1, ":instance_no"), (store_trigger_param_2,
                                                                                                         ":damage"), (call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"), ]),
    ...
    ("towngate_door_left", sokf_moveable, "door_g_left", "bo_door_left", [
        (ti_on_init_scene_prop, [(assign, ":durability", 5000), (store_trigger_param_1, ":instance_no"),
                                 (call_script, "script_flammable_object_initialize", ":instance_no", ":durability", 0), ]),
        (ti_on_scene_prop_hit, [(assign, ":flammability", 10), (store_trigger_param_1, ":instance_no"), (call_script, "script_cf_flammable_object_hit", ":instance_no", pos1, ":flammability")])]),
    ...
    ("draw_bridge_a", sokf_destructible | spr_hit_points(8000), "draw_bridge_a", "bo_draw_bridge_a", [
        (ti_on_init_scene_prop, [(assign, ":durability", 8000), (store_trigger_param_1, ":instance_no"),
                                 (call_script, "script_flammable_object_initialize", ":instance_no", ":durability", "spr_draw_bridge_a"), ]),
        (ti_on_scene_prop_hit, [(assign, ":flammability", 10), (store_trigger_param_1, ":instance_no"), (store_trigger_param_2,
                                                                                                         ":damage"), (call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"), ]),
    ...
    ("siege_large_shield_a", sokf_moveable | sokf_destructible | spr_hit_points(300), "siege_large_shield_a", "bo_siege_large_shield_a", [
        (ti_on_init_scene_prop, [(assign, ":durability", 1800), (store_trigger_param_1, ":instance_no"), (call_script,
                                                                                                          "script_flammable_object_initialize", ":instance_no", ":durability", "spr_siege_large_shield_a"), ]),
        (ti_on_scene_prop_hit, [(assign, ":flammability", 5), (store_trigger_param_1, ":instance_no"), (store_trigger_param_2, ":damage"), (assign, reg60,
                                                                                                                                            ":damage"), (display_message, "str_delivered_damage"), (call_script, "script_cf_object_set_damage", ":instance_no", ":damage", ":flammability"), ]),
        (ti_on_scene_prop_destroy,
         [
             (store_trigger_param_1, ":instance_no"),
    ...
    ("arabian_castle_battlement_b_destroyed", 0, "arabian_castle_battlement_b_destroyed",
        "bo_arabian_castle_battlement_b_destroyed", []),
