...
strings = [
  ...
  ### use these if there is a short period of time between the last meeting 
    ...
    ("npc7_backstory_response_2", "Actually, I'm rather fond of the place. And, no, I have not perceived anything. Good day to you."), #Bridei
    ...
    ("npc11_backstory_response_2", "Very interesting, milady, but I have work to do, and no time to chat about your miserable love life."), #Gwenllian
    ...
    ("npc15_backstory_response_2", "Sorry, I've got all the men that I can manage right now."), #Agasicles
    ("npc16_backstory_response_2", "Sorry, priest -- you sound like you might be trouble, as many of my warriors believe in the old gods, and I respect that."), #Aedh
    ("npc_bashe_backstory_response_2", "Take your leave."),
    ("npc_sange_backstory_response_2", "Take your leave."),
    ...
    ("npc_tank_backstory_response_2", "That was interesting, but I have to go."),
    ("npc_backwoodsharry_backstory_response_2", "Sorry, bye."),
    ...
    ("npc_enchantress_backstory_response_2", "You are too great for me."),
    ...
    ("npc2_signup", "Well, I will confess that I am not a warrior by trade, even though war runs through the blood of my people."), #Aleifr
    ("npc3_signup", "Do you? Really, would you help me escape and protect me? Well, I am in no position to be picky! I would be pleased to join you in exchange for my freedom."), #Eithne
    ("npc4_signup", "Good! I look forward to vanquishing your enemies and to finding my long lost father."), #Athrwys ap Gwawrddur
    ...
    ("npc7_signup", "I might be. I could certainly use the money."), #Bridei
    ...
    ("npc11_signup", "Why, maybe I could join you? Well, you seem a very fine future for me... I mean, working for you {handsome/beauty}..."), #Gwenllian
    ...
    ("npc15_signup", "Creta, eventually, but I'd welcome the opportunity to get a few scillingas in my pocket, first, so I don't arrive home empty-handed. So if you promise me food and a share of the loot, I'd be happy to fight with you for a while."), #Agasicles
    ("npc16_signup", "Well, {sir/madame}, let me tell you. Even though my main mission is spiritual, and I shall bring peace to every soul in this shield-wall, I can also fight and battle alongside your men, since God does not avert violence for a just and Christian cause."), #Aedh
    ...
    ("npc_sange_signup", "Thank you. My fate seemed uncertain, but you have given me a goal. I will be your bodyguard. An elite warrior fighting only by your side."),
    ...
    ("npc_tank_signup", "I have a proper education, and many years of experience."),
    ("npc_backwoodsharry_signup", "I come from Frisia. Frisian women are strong and beautiful."),
    ...
    ("npc_enchantress_signup", "I have many years of experience."),
    ...
    ("npc2_signup_2", "I'm a fast learner. I can ride, and know a fair bit about trade, prices, and such."), #Aleifr
    ("npc3_signup_2", "I think you would find that I would be a most valuable addition to your ranks. I am well-versed in the old traditions of the land and can declaim several of the epic poems of my people. I play the harp and am a skilled manager of household servants. I will also use everything my grandma taught me to keep my new companions healthy."), #Eithne
    ("npc4_signup_2", "Note however that as a gentleman and of righteous noble birth, I expect to be in a position of command, and not be treated as one of the common soldiers."), #Athrwys ap Gwawrddur
    ...
    ("npc7_signup_2", "But let your followers know that I do not suffer louts and brutes. Anyone who misbehaves around me will quickly find an arrow in their gullet."), #Bridei
    ...
    ("npc15_signup_2", "Siege work is my specialty, although I reckon can handle myself well enough in an open battle, if need be. The fortresses here do not compare to the ones in my homeland, and I can truly help you take any castle you might want in Britannia or Hibernia."), #Agasicles
    ("npc16_signup_2", "I will be useful in every kind of battle, be it mundane, be it spiritual -- be it even against the very hordes of Hell."), #Aedh
    ("npc_bashe_signup_2", "You have just gladdened my day, you could not have found a more faithful bodyguard."),
    ("npc_sange_signup_2", "You have just gladdened my day, you could not have found a more faithful bodyguard."),
    ...
    ("npc_tank_signup_2", "Allow me time to gather my few possessions and I'll join you outside."),
    ("npc_backwoodsharry_signup_2", "Allow me time to gather my few possessions and I'll join you outside."),
    ...
    ("npc_enchantress_signup_2", "Allow me time to gather my few possessions and I'll join you outside."),


    ("npc1_signup_response_1", "Good. You can be useful to us. Sober, I prefer."), #Osmund
    ("npc2_signup_response_1", "That will do."), #Aleifr
    ("npc3_signup_response_1", "Hum, that's a start. We can teach you the rest. Hurry, I am rescuing you right now."), #Eithne
    ("npc4_signup_response_1", "Very well. I'll be glad to have you with us, son of Gwawrddur."), #Athrwys ap Gwawrddur
    ...
    ("npc7_signup_response_1", "I will hire you. Try not to shoot anyone on your first day, though."), #Bridei
    ...
    ("npc11_signup_response_1", "It sounds like you'll be useful. You are hired. But stop calling me '{handsome/beauty}'. Please."), #Gwenllian
    ...
    ("npc15_signup_response_1", "That works for me. I will be pleased to hire you."), #Agasicles
    ("npc16_signup_response_1", "It sounds like you can do the job. I will hire you."), #Aedh
    ("npc_bashe_signup_response_1", "Hire the Pict."),
    ("npc_sange_signup_response_1", "Hire the Pict."),
    ...
    ("npc_tank_signup_response_1", "I could use someone of your experience."),
    ("npc_backwoodsharry_signup_response_1", "You are welcome."),
    ...
    ("npc_enchantress_signup_response_1", "I would be honored to have the opportunity to work with you."),


  #11
    ("npc1_signup_response_2", "I'd prefer not to take the risk. Good day, sir."), #Osmund
    ("npc2_signup_response_2", "I'm afraid I'm only looking for men with some experience. And I want none of your bad luck when I travel through the sea. Good day to you."), #Aleifr
    ("npc3_signup_response_2", "Actually, I think you are pretty useless. Go back to your butcher, slave."), #Eithne
    ("npc4_signup_response_2", "Actually, we are not in the habit of hiring men who might have other quests than war in mind. Good day, sir."), #Athrwys ap Gwawrddur
    ...
    ("npc7_signup_response_2", "Actually, on second thought, you sound like you might be trouble. Good day to you. "), #Bridei
    ...
    ("npc11_signup_response_2", "Sorry, milady. We've already got as many in our shield-wall as we can handle. Maybe you should start looking for your future elsewhere."), #Gwenllian
    ...
    ("npc15_signup_response_2", "Actually, I need a different kind of expertise. My apologies."), #Agasicles
    ("npc16_signup_response_2", "To be honest, I'd prefer someone who was not a religious fanatic."), #Aedh
    ("npc_bashe_signup_response_2", "Retract your offer and leave."),
    ("npc_sange_signup_response_2", "Retract your offer and leave."),
    ("npc_paintrain_signup_response_2", "I don't need your help."),
    ("npc_hammertime_signup_response_2", "I'll be fine without you."),
    ("npc_tank_signup_response_2", "I'll be fine without you."),
    ("npc_backwoodsharry_signup_response_2", "I'll be fine without you."),
    ...
    ("npc_enchantress_signup_response_2", "I don't need your help."),
    ...
    ("npc3_payment", "Before I sign up, I will need 300 coins here."), #Eithne
    ("npc4_payment", "Excellent. Before we depart, would you be so kind as to lend me {reg3} scillingas? I had to pawn a family heirloom at a pawnbroker here in {s20}, and I would like to retrieve it before we leave."), #Athrwys ap Gwawrddur
    ...
    ("npc7_payment", "All right then. I will come with you. But I want a payment of {reg3} scillingas first. You aren't expecting me to work for free, are you?"), #Bridei
    ...
    ("npc11_payment", "Hey thank you {handsome/beauty}. But before joining up with you, I would like a payment of {reg3} scillingas. You know, as a token of our new relation."), #Gwenllian
    ...
    ("npc15_payment", "Good. By the way, as a skilled engineer I would expect a payment for my services. A signing bonus of {reg3} scillingas would be fair, I think."), #Agasicles
    ...
    ("npc_sange_payment", "Nice, but I need to pay 300 coins to the quastuosa before we go. I assume you can take care of that for me?"),
    ...
    ("npc_tank_payment", "For the price of {reg3} scillingas, I would lend you my live."),
    ("npc_backwoodsharry_payment", "My service shall be yours, but I need {reg3} coins for a new shirt first."),
    ...
    ("npc_enchantress_payment", "I will support your for a donation of {reg3} scillingas."),

    ("npc1_payment_response", "Very well, here's {reg3} scillingas. Now, fall in with the rest."), #Osmund
    ("npc2_payment_response", "Very well."), #Aleifr
    ("npc3_payment_response", "Very well."), #Eithne
    ("npc4_payment_response", "Certainly. Here's {reg3} scillingas."), #Athrwys ap Gwawrddur
    ("npc5_payment_response", "Well... here's {reg3} scillingas, then. Your first payment."), #Frioc
    ("npc6_payment_response", "Very well."), #Bodero
    ("npc7_payment_response", "No, of course not. Here's {reg3} scillingas."), #Bridei
    ...
    ("npc11_payment_response", "Very well, here's {reg3} scillingas. Make yourself ready. We'll be leave soon. And stop... ah, well, forget it."), #Gwenllian
    ...
    ("npc15_payment_response", "All right, here's {reg3} scillingas. Glad to have you with us."), #Agasicles
    ("npc16_payment_response", "Very well."), #Aedh
    ("npc_bashe_payment_response", "All right, here's {reg3} scillingas. Glad to have you with us."), 
    ("npc_sange_payment_response", "All right, here's {reg3} scillingas. Glad to have you with us."),
    ...
    ("npc_tank_payment_response", "But of course, here is {reg3} scillingas."),
    ("npc_backwoodsharry_payment_response", "But of course, here is {reg3} scillingas."),
    ...
    ("npc_enchantress_payment_response", "All right, here's {reg3} scillingas for you. Let us conquer these lands."),
    ...
    ("npc4_morality_speech", "I beg your pardon, warlord -- just so you know, the men of the House of Gwawrddur do not care to {s21}. I will not be pleased if you continue to take this course."),
    ...
    ("npc7_morality_speech", "Warlord -- I do not like to see us {s21}. Such are the actions of a common bandit chief, with no regard for his followers."),
    ...
    ("npc11_morality_speech", "Excuse me, {handsome/beauty}. It's not good that we {s21}. The least the soldiers expect of a leader is to feed them, pay them, and do {his/her} best to keep their sorry skins intact as best {he/she} can."),
    ...
    ("npc15_morality_speech", "{Sir/Madame} -- just so you know my opinion, any commander with sense will not let his shield-wall {s21}.I hope you don't mind me speaking so bluntly."),
    ("npc16_morality_speech", "Warlord. I don't like to {s21}. God does not approve of this kind of behavior, it will surely lead you to Hell, if left unchecked by my holy teachings."),
    ...
    ("npc_sange_morality_speech", "I do not care to {s21}. No one with a reputation for blatant cowardice will be properly respected and obeyed by his shield-wall."),
    ...
    ("npc_tank_morality_speech", "Captain. I don't like to {s21}"),
    ("npc_backwoodsharry_morality_speech", "Captain. I don't like to {s21}"),
    ...
    ("npc_enchantress_morality_speech", "Captain. I don't like to {s21}. So many throats left uncut, and so many purses left unexplored..."),
    ...
    ("npc2_2ary_morality_speech", "{Sir/Madame} -- I'm not altogether happy that we {s21}. I'm a merchant, and in our business one is bounded by one's word. I don't want a reputation for dishonesty -- that would spell my end as a trader, {sir/madame}."),
    ...
    ("npc7_2ary_morality_speech", "I think it was a brave decision you took to {s21}. There is no shame in finding a way to avoid the spilling of blood."),
    ...
    ("npc11_2ary_morality_speech", "I think it was a brave decision you took to {s21}. There is no shame in finding a way to avoid the spilling of blood."),
    ...
    ("npc15_2ary_morality_speech", "You know, warlord, it's none too reassuring to see how you just {s21}. If you can break your word to them, you can break your word to me, that's how I figure it."),
    ("npc16_2ary_morality_speech", "I think it was a brave decision you took to {s21}. There is no shame in finding a way to avoid the spilling of blood."),
    ...
    ("npc_sange_2ary_morality_speech", "You know, friend {playername}, it's none too reassuring to see how you just {s21}. If you can break your word to them, you can break your word to me, that's how I figure it."),
    ...
    ("npc_tank_2ary_morality_speech", "You know, friend {playername}, it's none too reassuring to see how you just {s21}. If you can break your word to them, you can break your word to me, that's how I figure it."),
    ("npc_backwoodsharry_2ary_morality_speech", "You know, friend {playername}, it's none too reassuring to see how you just {s21}. If you can break your word to them, you can break your word to me, that's how I figure it."),
    ...
    ("npc_enchantress_2ary_morality_speech", "Captain -- just so you know, it's no problem by me that we {s21}. We do what we need to do to live, and they'd do the same to us if they were in our shoes."),
  ...
  ####Pausa - conflitos chief
    ...
    ("npc2_personalityclash_speech", "{Sir/Madame} -- as you recall I was a merchant before I signed on with you. I respect men who make their living peacefully, risking all to bring goods for faraway lands."), #Aleifr-Frioc
    ("npc3_personalityclash_speech", "Warlord -- in my opinion, {s11} is a terrible man. He has tried to seduce me into his bed many times, and I have already seen him following me during the night, when I am alone. I tell you, I am pretty scared of him."), #Eithne-Brian
    ("npc4_personalityclash_speech", "{Sir/Madame}. The House of Gwawrddur is one of the most ancient and respected families in this part of the world, with a provenance dating back to the Roman Empire. Yet {s11} openly shows me disrespect, and always calls me a ridiculous Briton."), #Athwrys-Ceawlin
    ...
    ("npc7_personalityclash_speech", "Warlord, I have done my best to put up with your followers' rude talk and filthy habits. But that one who calls himself {s11} is beyond tolerance."), #Bridei-Osmund
    ...
    ("npc15_personalityclash_speech", "Excuse me. I hope you don't mind me telling you that, in my opinion, the priest {s11} is a danger to the party. He only cares about religion and Hell, and is disrespectful of authority and the basic principles of the military art."), #Agasicles-Aedh
    ("npc16_personalityclash_speech", "Just so you know -- there's something demonic about {s11}. He makes strange scrawlings in the dirt, and mutters to himself all the time before battle."), #Aedh-Agasicles
    ("npc_bashe_personalityclash_speech", "Warlord, I am weary of {s11}, who talks of nothing but warrior codes and feats of arms."),
    ("npc_sange_personalityclash_speech", "Warlord, I am weary of {s11}, who talks of nothing but warrior codes and feats of arms."),
    ...
    ("npc_tank_personalityclash_speech", "There's something strange about {s11}. I do not like him."),
    ("npc_backwoodsharry_personalityclash_speech", "Dear, {s11} is strange. I dislike him."),
    ...
    ("npc_enchantress_personalityclash_speech", "Oy, captain. Just so you know -- there's something funny about {s11}. He makes strange scrawlings in the dirt, and mutters to himself."),
    ...
    ("npc2_personalityclash_speech_b", "I don't much care to hear {s11} gloat about the caravans he has looted, or plans to loot, he has no respect for good honest trade."), #Aleifr-Frioc
    ("npc3_personalityclash_speech_b", "I know that an army is usually a men's place, but I believe I deserve some respect as well. I am no one's whore. I hope you do not mind me saying so."), #Eithne-Brian
    ("npc4_personalityclash_speech_b", "{Sir/Madame}, these are indeed sorry days if common Saxon folk are allowed to mock Brythonic nobles. That is all."), #Athwrys-Ceawlin
    ...
    ("npc7_personalityclash_speech_b", "I do not care for how he stares at me around the campfire after a meal, as he picks his teeth and drinks his foul beer. What I cannot accept is that he keeps saying that he is a much better tracker than myself, which is obviously false. He is base, ignorant, and a completely idiotic drunkard, that could never compare to me in tracking, nor in anything else. I do not care to travel with such people."), #Bridei-Osmund
    ...
    ("npc16_personalityclash_speech_b", "Fearing witchcraft, I asked him about it, and he told me that I should mind my own business. So I had a look in his baggage, and found a heretical Greek book that loosely resembled our Holy Bible. I am sure that the words within it are corrupted, and they were probably written by the Devil himself. I think he's a sorcerer, {sir/madame}, and we should definitely get rid of him for the sake of our immortal souls."), #Aedh-Agasicles
    ...
    ("npc_sange_personalityclash_speech_b", "Valorous deeds are all very well, but they are not the only goals worth pursuing in life. Personally, I never trust any man who has not at least once woken up drunk in a ditch, or been beaten by the slipper of his lover before."), 
    ...
    ("npc_tank_personalityclash_speech_b", "I think {s11}'s a sorcerer, {sir/madame}, and if I catch him trying to hex me, he'll have a knife in his throat."),
    ("npc_backwoodsharry_personalityclash_speech_b", "I think {s11}'s a bad person. I hate him."),
    ...
    ("npc_enchantress_personalityclash_speech_b", "I think {s11}'s a sorcerer, {sir/madame}, and if I catch him trying to hex me, he'll have a knife in his throat."),
  ...
  ### set off by behavior after victorious battle
    ...
    ("npc2_personalityclash2_speech", "{Sir/Madame}. If you don't mind, I'd prefer not to be deployed anywhere near {s11}, after what he said to me during that last battle."), #Aleifr-Lothar
    ("npc3_personalityclash2_speech", "{Sir/Madame}. Since I have joined your shield-wall, I have tried hard to learn how to live like a soldier -- which is much better than being a slave, and how to honor the warrior's code. But some of your men do not respect me as an equal."), #Eithne-Siwi
    ("npc4_personalityclash2_speech", "Dryhten. I happened to exchange a few words with {s11} as we were dividing up the spoils of battle. Please inform her that when she speaks to me, she should remember that she is only a Pictish tracker, and has no right to address me only as 'Briton'."), #Athwrys-Bridei
    ...
    ("npc7_personalityclash2_speech", "Warlord -- I have grown tired of the insolence of this man that answers to the name of Athrwys. He thinks I am less a warrior than him just because I am also a tracker, a woman, and a Pict."), #Bridei-Athwrys
    ...
    ("npc11_personalityclash2_speech", "{Handsome/Beauty}, I do not think we should keep the company of that fellow Dumnonian called Frioc. Please, hear what I feel in my heart."), #Gwenllian-Frioc
    ...
    ("npc_sange_personalityclash2_speech", "Hello, warlord! {s11} is a temperamental one, isn't she? During that last battle, I was merely having a friendly chat with our foes about their mothers as we exchanged sword blows, and it caused her to throw a fit!."),
    ...
    ("npc_tank_personalityclash2_speech", "I'm a bit tired of {s11}"),
    ("npc_backwoodsharry_personalityclash2_speech", "I'm a bit tired of {s11}"),
    ...
    ("npc_enchantress_personalityclash2_speech", "I'm a bit tired of {s11}."),
    ...
    ("npc2_personalityclash2_speech_b", "The enemy was bearing down on us, and he says, 'Step aside, merchant, this is true man's work.' Next time I will step aside, and let him take a spear in the gut."), #Aleifr-Lothar
    ("npc3_personalityclash2_speech_b", "After our last victory I was picking through the slain, and that Frisian called Siwi pushed me aside saying that looting was no job for a simple slave girl that was just allowed to travel with the army. I believe that if I battle alongside the shield-wall, I deserve my share of the loot just like any other warrior. Even though I might be less experienced than the others, I also risked my life."), #Eithne-Siwi
    ("npc4_personalityclash2_speech_b", "I forgave her because she is only an ignorant northern woman, but I plead that you tell her that she is speaking to one of her superiors, and that she must remember her place."),#Athwrys-Bridei
    ...
    ("npc7_personalityclash2_speech_b", "He also insists that I should address him as 'My Lord', instead of his ridiculous name. I tell you, one day when I have my own band of Pictish warriors, I will hunt him down and ask him how much better a warrior he is with my axe buried in his skull."), #Bridei-Athwrys
    ...
    ("npc15_personalityclash2_speech_b", "{s11} responded that Hippocrates was an 'antiquated know-nothing', incomparable to the knowledge of Galenus. Warlord, no true medic would have such disrespect for the great masters of the past. I do not believe you should employ such an obvious impostor."), #Agasicles-Orosio
    ("npc16_personalityclash2_speech_b", "This awful man has openly declared that he follows the pagan gods of old, and that the teachings of Christ are nothing more than the babblings of weak men. He even made an absurd remark suggesting that I, a holy priest, brought us all bad luck with my 'gibberish preaching'. If you have no intention of leading all of your men to Hell, this Angle should be immediately sent to his afterlife."), #Aedh-Osmund
    ...
    ("npc_tank_personalityclash2_speech_b", "Captain. I can no longer abide the rank ignorance of {s11}."), #klethi - borcha
    ("npc_backwoodsharry_personalityclash2_speech_b", "Captain. I can no longer abide the rank ignorance of {s11}."), #klethi - borcha
    ...
    ("npc_enchantress_personalityclash2_speech_b", "Captain. I can no longer abide the rank ignorance of {s11}."), #klethi - borcha


    ("npc1_personalitymatch_speech", "Chief. {s11} didn't do badly in that last fight at all. He's a good egg, that one."), #Osmund-Aleifr
    ("npc2_personalitymatch_speech", "{Sir/Madame}. I just wanted to tell you that {s11} may be a rough sort, and I'll venture a complete drunkard as well, but I'm proud to call him my companion."), #Aleifr-Osmund
    ("npc3_personalitymatch_speech", "Hello, {sir/madame}! I had just wanted to tell you that {s11} is a most gallant and brave warrior. Did you see him in our last battle?"), #Eithne-Lothar
    ("npc4_personalitymatch_speech", "Excuse me, {sir/madame}. I just wanted to say a word in praise of {s11}. He did well in that last battle."), #Athwrys-Frioc
    ...
    ("npc7_personalitymatch_speech", "Warlord. I was just talking to {s11}. He might be an incisive man, but he holds no prejudice for me being a woman or a Pict."), #Bridei-Aedh
    ...
    ("npc11_personalitymatch_speech", "Oh {handsome/beauty}, I could not praise you more for having men of such quality as Ceawlin within our shield-wall. I do not care that he is a Saxon, and supposedly, an enemy of my people."), #Gwenllian-Ceawlin
    ...
    ("npc15_personalitymatch_speech", "Warlord. I was just having a word with {s11} after our last battle, and it strikes me that the man has got a good head on his shoulders."), #Agasicles-Brian
    ("npc16_personalitymatch_speech", "I must tell you that even though Bridei looks like a simple barbarian, I can see in her heart that she has, maybe unknown to herself, a good Christian soul."), #Aedh-Bridei
    ...
    ("npc_sange_personalitymatch_speech", "You have earned your name today, {sir/madame}! And {s11}, too! I like that one, a strong companion in the battlefield."),
    ...
    ("npc_tank_personalitymatch_speech", "I was just having a chat with {s11}, she shall be mine."),
    ("npc_backwoodsharry_personalitymatch_speech", "{s11} is a beauty. He looked at me, I think that I like him "),
    ...
    ("npc_enchantress_personalitymatch_speech", "I was just having a chat with {s11}, as we picked through the bodies after our last little scrap."),
    ...
    ("npc2_personalitymatch_speech_b", "Based on how he did in that last fight, I'd say that I'd trust my back to him any day, for he also knows how to share tales and legends by the campfire after a fine battle. I already promised to take him to a Nordic tavern someday."), #Aleifr-Osmund
    ("npc3_personalitymatch_speech_b", "I also confess that I find him a truly delightful companion, a man of both wit and manners. Perhaps, perhaps... Ah, but I say too much. Good day, {sir/madame}."), #Eithne-Lothar
    ("npc4_personalitymatch_speech_b", "You chose well to enlist him in our shield-wall. He knows a thing or two about a fight, and is a fine Brythonic warrior just like myself. I tell you, the noble blood that runs through his veins, just like in mine, makes him a truly admirable companion."), #Athwrys-Frioc
    ...
    ("npc11_personalitymatch_speech_b", "He is clearly a warrior that has profound respect and obedience to you. This, of course, makes me extremely happy. If only all of our warriors were like him, the lands of Britannia and Hibernia would soon bow to your magnificent greatness."), #Gwenllian-Ceawlin
    ...
    ("npc16_personalitymatch_speech_b", "She is open to hear the teachings of Christ, and I believe that, given due time, she will completely convert herself to the true faith. She is the living proof that the message of God is universal."), #Aedh-Bridei
    ...
    ("npc_sange_personalitymatch_speech_b", "He is a professional soldier, and a great killer of men. You showed good sense in bringing him into this shield-wall."),
    ...
    ("npc_tank_personalitymatch_speech_b", "{s11} sang for me. She is pretty."),
    ("npc_backwoodsharry_personalitymatch_speech_b", "{s11} told me that when we finish this trip with you, we can get married."),
    ...
    ("npc_enchantress_personalitymatch_speech_b", "{s11} is a good friend."),
    ...
    ("npc2_retirement_speech", "I'm getting a bit tired of the warrior's life. I'm going to invest my share of our loot into a cargo of goods -- furs, linens, and dyes probably -- and take them back over the sea to the Northland. I would like to thank you again for taking me on, and wish you the best of luck."), #Aleifr
    ...
    ("npc4_retirement_speech", "I have fought with you honorably, as befits a son of the House of Gwawrddur, but I am not altogether satisfied with your leadership. I will quest again, in search of my long lost father. May I find either him, or glorious death during my travels. Farewell, dryhten."), #Athrwys
    ...
    ("npc15_retirement_speech", "I appreciate that you took me on, but I'm not altogether happy about how things have worked out. I'm going to head off elsewhere -- maybe go home to Creta, maybe find another job, I haven't quite decided yet."), # Agasicles
    ...
    ("npc_sange_retirement_speech", "{Sir/Madame} I have decided to leave this joke you call a shield-wall. I can no longer stand your filthy company. Farewell."),
    ...
    ("npc_tank_retirement_speech", "I appreciate your friendship, Captain, but it's time for me to leave you."),
    ("npc_backwoodsharry_retirement_speech", "I appreciate your friendship, Captain, but it's time for me to leave you."),
    ...
    ("npc_enchantress_retirement_speech", "I appreciate your friendship, Captain, but it's time for me to leave you. Slan."),
    ...
    ("npc3_rehire_speech", "Well, hello {sir/madame}! It is very good to see you again. I have not fared so well since we parted, I am afraid. My savings from the time we travelled together, which I hoped would give me a start in trading, have not been enough to start a decent business. And, I must say, I fear being eventually found by my old master, and turned again into a slave. Perhaps I am better suited to war than to commerce, to share a meal over a campfire with rough fellows than to drink mead. {Sir/Madame}, I must ask you -- will you take me back?"), #Eithne
    ...
    ("npc7_rehire_speech", "Warlord! It is good to see you. Unfortunately, even with all the money I saved from my share of the loot, the absurd taunt of being a traitor still lingered upon me. So, no Pictish warrior considered joining a war band lead by me. Damn, that's just the way life goes, I guess. Will you have me back?"), #Bridei
    ...
    ("npc_sange_rehire_speech", "Well hello there {sir/madame}. Well, I was wrong. You are not that filthy, nor completely intolerable. Perhaps we might ride together again, for a little while?"),
    ...
    ("npc_tank_rehire_speech", "It is good indeed to see you again, Captain. Perhaps we can help one another again?"),
    ("npc_backwoodsharry_rehire_speech", "It is good indeed to see you again, Captain. Perhaps we can help one another again?"),
    ...
    ("npc_enchantress_rehire_speech", "It is good indeed to see you again, Captain. Perhaps we can help one another again?"),
  ...
  #local color strings
    ...
    ("npc2_home_intro", "We're approaching Cantwareburh. That's where I was headed when that terrible storm struck my ship and everything I had capsized along."), #Aleifr - Cantwareburh
    ("npc3_home_intro", "Can you smell that? Mistletoe, crabapples, and butter: it's the scent of Hibernia. I spent many a happy summer here when I was a girl, playing outside the cottage of my old grandma."), #Eithne - Dun Keltair
    ("npc4_home_intro", "We are very close to Caer Sws, a magnificent Brythonic fortress."), #Athrwys - Caer Sws
    ...
    ("npc7_home_intro", "Pay attention, and be careful. We are now in Pictland, near Dun Taruo. The Kingdom of Cait is, with Fortriu, the most powerful of Pictavia, which is our term for Pictland."), #Bridei - Dun Taruo
    ...
    ("npc11_home_intro", "I see the mountains. We must be getting near home."), #Gwenllian - Caer Segeint
    ...
    ("npc15_home_intro", "Do you see that small settlement over there? It is the town known as 'Ford of the Ox', or, as their Saxon inhabitants say: 'Oxenaforda'."), #Agasicles - Oxenaforda
    ("npc16_home_intro", "Pray now, and have fear, as only God can protect us now. For we are close to the demonic site of an ancient pagan ritual."), #Aedh - Cruaghan
    ("npc_bashe_home_intro", "Do you see that Pictish town? I spent many winters there some years back, during my childhood."), 
    ("npc_sange_home_intro", "Do you see that Pictish town? I spent many winters there some years back, during my childhood."), 
    ...
    ("npc_tank_home_intro", "I haven't a home."),
    ("npc_backwoodsharry_home_intro", "I haven't a home."),
    ...
    ("npc_enchantress_home_intro", "You can remember about the story of my life?. It was here..."),
    ...
    ("npc3_home_description", "Dun Keltair is named after a legendary hero called Keltar, who once built his fortress where the town now lies."), #Eithne
    ("npc4_home_description", "Swswen was an ancient Roman queen, from the time that the Roman Empire reached even the lands of Wales. The people here are very proud of their supposed Roman heritage."), #Athrwys
    ...
    ("npc7_home_description", "Southerners believe us Picts are a bunch of savage barbarians, but this is not true. Of course, we have war paints and tattoos, and we can be very brutal in battle. But most of us are also farmers living in small villages, just like almost everyone else in Britannia."), #Bridei 
    ...
    ("npc10_home_description", "Here once stood Londinium, the Roman Capital of Britannia. Lundenwic lies very close to the ruins of Londinium - from which now remains a fort usually called Lundenburh. Its name means 'trading town of Londinium', or, as us Saxons say, 'London'."), #Ceawlin
    ("npc11_home_description", "I'm from Din Gonwy, in the Kingdom of Gwynedd. I think I have managed to become a fine warrior by your side because war runs in the blood of every Brythonic man and woman of Gwynedd. And, as far as I've heard, we have recently taught a fine lesson to those Angle and Saxon invaders."), #Gwenllian
    ...
    ("npc15_home_description", "The name of the city is a curiosity from an architectural perspective. You see, this place was occupied because its ford is very secure and easy to use. Apparently, the Saxons are not good at building bridges, or else they would not have choosen a spot for a town based mostly on the presence of a ford for their herds."), #Agasicles
    ("npc16_home_description", "We are close to Rath Cruachan, near the town of Cruaghan, Capital of Connaught. Rath Cruachan is a horrid pagan cemetery, and it also hosted -- and sometimes still hosts -- ritual gatherings in the name of the old gods, where terrible deeds are committed my faithless lost souls."), #Aedh
    ...
    ("npc_sange_home_description", "It is the most pleasant countryside in this whole island, and a great place for a retired warrior to settle down."),
    ...
    ("npc_tank_home_description", "My home is with your party now."),
    ("npc_backwoodsharry_home_description", "My home is with your party now."),
    ...
    ("npc3_home_description_2", "Just like the rest of Hibernia, the place is plagued by constant wars and cattle raids. I, myself, you know, became a slave as a war prize. Anyways, this regions is my birthplace, and it is very good to see it again as a free woman."), #Eithne
    ("npc4_home_description_2", "Maybe their pride really has some foundation, because we can still see today two forts that are of clear Roman origin. I, myself, don't care about this at all, but Caer Sws is one of the finest towns in Britannia, if you want my opinion."), #Athrwys
    ...
    ("npc7_home_description_2", "We are also fine shepherds and hunters, and no one is as good as us in training dogs and falcons for the hunt. One day we shall get tired of being always taken for stupid barbarians, and, when this happens, all of Britannia will tremble before our armies."), #Bridei
    ...
    ("npc15_home_description_2", "So, if this town, or any other Saxon area ever becomes yours, I would strongly suggest the employment of experienced masons and architects like myself and some others to fully develop the lands and cities of your realm."), #Agasicles
    ("npc16_home_description_2", "This unholy site is commonly associated with that superstitious pagan feast called Samhain. The ignorant rabble still believes that during this time the gods and the dead walk on Earth alongside mortals. This is false, of course, but the Devil may very well use this kind of belief for his own purposes. If you ever rule over this land, I recommend that you destroy Rath Cruachan and level it to the ground."), #Aedh
    ...
    ("npc_sange_home_description_2", "If anyone were ever to unify these islands of ours, I'd eventually return to my birthplace, get a small house and a nice woman to raise some kids of my own. But, alas, I am only dreaming, of course."),
    ...
    ("npc_tank_home_description_2", "If anyone were ever to unify these islands of ours, I'd eventually return to my birthplace, get a small house and a nice woman to raise some kids of my own. But, alas, I am only dreaming, of course."),
    ("npc_backwoodsharry_home_description_2", "If anyone were ever to unify these islands of ours, I'd eventually return to my birthplace, get a small house and a nice man to raise some kids of my own. But, alas, I am only dreaming, of course."),
    ...
    ("npc_enchantress_home_description_2", "Having grown into the role of a leader of free men, a dauntless warrior, a tactician, and a horseman, I, Connor, never vowed himself to any one lord or Kingdom. Our enemies was united against us, I was betrayed and they ambushed us, my enemies killed my men and I only managed to escape. Now I'm here, alone, without fame or honour, and with the guilt of having failed my people."),

    ("npc1_home_recap", "I'm from Bernaccia, where I learnt to drink and track."), #Osmund
    ("npc2_home_recap", "I was born over the sea, in the Northland. I'm a merchant, the son of a merchant, and the grandson of a merchant."), #Aleifr
    ("npc3_home_recap", "I used to live as a slave in {s20}, but I spent much of my childhood in the countryside near Dun Keltair."), #Eithne
    ("npc4_home_recap", "I am a Briton, and my father is one of the heroes mentioned in Y Goddodin."), #Athrwys
    ...
    ("npc7_home_recap", "I was born in Pictland, in the Kingdom of Cait."), #Bridei
    ...
    ("npc11_home_recap", "Why, {handsome/beauty}? I am from Din Gonwy, in Gwynedd. But that man I do not speak of used to travel a lot, so I it has been awhile since I lived in my homeland."), #Gwenllian
    ...
    ("npc15_home_recap", "I come from Creta, the most beautiful of the Greek islands. My knowledge of siege craft and construction is unparalleled in Britannia."), #Agasicles
    ("npc16_home_recap", "I am from Cruaghan. And I will not say anything further."), #Aedh
    ("npc_bashe_home_recap", "I was born in Pictland. I'm just a man in this world of war."),
    ("npc_sange_home_recap", "I was born in Pictland. I'm just a man in this world of war."),
    ...
    ("npc_tank_home_recap", "I'm just a man in this world of war."),
    ("npc_backwoodsharry_home_recap", "I am Frisian. I'm just a woman in this world of war."),
    ...
    ("npc2_kingsupport_1", "Well, warlord -- I'd support you. I think you'd give Britannia the kind of enlightened rule which it has long needed."), #Aleifr
    ("npc3_kingsupport_1", "Well, my {lord/lady} -- I would worry for you. Our histories tell us that power tends to corrupt. But in the end, I am comforted by the mercy and judgment you have shown as warlord of this shield-wall."), #Eithne
    ("npc4_kingsupport_1", "Well, dryhten, I think that you would be the kind of {king/queen} that well-born gentlemen such as myself would be proud to follow into battle..."), #Athrwys
    ...
    ("npc7_kingsupport_1", "Aye -- you'll do well. You know how to correctly treat trackers, Picts, and women."), #Bridei
    ...
    ("npc11_kingsupport_1", "Why, that's a fine idea, {handsome/beauty}! I suppose I shall have to learn to call you 'Majesty', or 'Your Grace', then..."), #Gwenllian
    ...
    ("npc15_kingsupport_1", "Well, you pay your men on time, when you can, generally speaking. That's the best qualification for kingship there is, in my book. You show some respect for the rights of others."), #Agasicles
    ("npc16_kingsupport_1", "It seems to me that you hear my words, and that your soul stirs in the face of Christ's teachings. Yes, I am sure that God not only approves, but is also planning your ascension as a rightful king for the sinful people of Britannia and Hibernia."), #Aedh
    ...
    ("npc_sange_kingsupport_1", "Why not, warlord? I mean, in this war-torn and rainy island, you would be as good a King as any of those self-proclaimed conquerors that roam the fields stealing cattle and burning villages."), 
    ...
    ("npc_tank_kingsupport_1", "Why not, warlord? I mean, in this war-torn and rainy island, you would be as good a King as any of those self-proclaimed conquerors that roam the fields stealing cattle and burning villages."), 
    ("npc_backwoodsharry_kingsupport_1", "Why not? I mean, in this war-torn and rainy island, you would be as good a King as any of those self-proclaimed conquerors that roam the fields stealing cattle and burning villages."), 
    ...
    ("npc_enchantress_kingsupport_1", "Why not, warlord? I mean, in this war-torn and rainy island, you would be as good a King as any of those self-proclaimed conquerors that roam the fields stealing cattle and burning villages."), 
    ...
    ("npc2_kingsupport_2", "Most of the lords of this land -- well, let's just say that they never held a scillinga that they didn't collect as rent or take as pillage. You, on the other hand, have some experience of commerce and trade, of the effort and risk involved in making sure that men don't go hungry in Cantwareburh while there's a glut of grain in Lundenwic, to give an example.... If you like, warlord, I reckon I could find some support for you among the merchants and stockers of this realm."), #Aleifr
    ("npc3_kingsupport_2", "I would, my {lord/lady}. But I would ask you to establish at least a minimal amount of rights to slaves, as well as a recognized procedure for them to buy their own freedom. You know I have been a slave, and we are the most abused people in the land. Slaves really need to be protected by a rightful and fair ruler."), #Eithne
    ("npc4_kingsupport_2", "Of course, warlord. The trick is now to get others to follow you. As you know, one's lineage is a great determinant of one's worthiness. Perhaps you have a long-lost ancestor of whom you have not told me, who, maybe, even fought alongside some of the heroes of Y Goddodin?"), #Athrwys
    ...
    ("npc7_kingsupport_2", "Yes, warlord, I would. A {king/queen}'s duty is to adequately respect all men and women that serve under his banner. You have proven more than able to do this, for, to you, the hunter and the tracker, the woman and the Pict, are as important as the warrior and the soldier, as the man and the Briton."), #Bridei
    ...
    ("npc11_kingsupport_2", "Of course, I would! I am sure, by the way you act, command and fight, also by the way you walk, and speak and love... that you are the only man honorable enough to become what only King Arthur once was: 'Penteyrnedd yr Ynys hon', or 'Chief of the Lords of this Island'."), #Gwenllian
    ...
    ("npc_sange_kingsupport_2", "Of course, my {lord/lady}. I very well remember how you rescued me in that dark tavern, and gave me a new life. I shall travel the land, telling people how you can bring hope to even the most desperate man."), 
    ...
    ("npc_tank_kingsupport_2", "Of course, my {lord/lady}. I very well remember how you rescued me in that dark tavern, and gave me a new life. I shall travel the land, telling people how you can bring hope to even the most desperate man."), 
    ("npc_backwoodsharry_kingsupport_2", "Of course, my {lord/lady}. I very well remember how you rescued me in that dark tavern, and gave me a new life. I shall travel the land, telling people how you can bring hope to even the most desperate man."), 
    ...
    ("npc_enchantress_kingsupport_2", "Of course, my {lord/lady}. I very well remember how you rescued me in that dark tavern, and gave me a new life. I shall travel the land, telling people how you can bring hope to even the most desperate man."), 
    
    ("npc1_kingsupport_2a", "Please go on..."), #Osmund
    ("npc2_kingsupport_2a", "Please continue..."), #Aleifr
    ("npc3_kingsupport_2a", "Please continue..."), #Eithne
    ("npc4_kingsupport_2a", "Of course - let me tell you all about him."), #Athrwys
    ("npc5_kingsupport_2a", "Please go on..."), #Frioc
    ("npc6_kingsupport_2a", "Splendid, that was exactly what I was thinking."), #Bodero
    ("npc7_kingsupport_2a", "Well, yes, I try to be fair to everyone..."), #Bridei
    ...
    ("npc11_kingsupport_2a", "Tell me more."), #Gwenllian
    ...
    ("npc15_kingsupport_2a", "Well-spoken, my good man"), #Agasicles
    ("npc16_kingsupport_2a", "Of course I am - as we are nothing but instruments of God."), #Aedh
    ("npc_bashe_kingsupport_2a", "Interesting... Please continue"), 
    ("npc_sange_kingsupport_2a", "Interesting... Please continue"), 
    ...
    ("npc_tank_kingsupport_2a", "Interesting... Please continue"), #klethi
    ("npc_backwoodsharry_kingsupport_2a", "Interesting... Please continue"), #klethi
    ...
    ("npc_enchantress_kingsupport_2a", "Interesting... Please continue"), #klethi
    
    ("npc1_kingsupport_2b", "Well. We saw how that turned out, you drunk poor-sighted excuse of a tracker..."), #Osmund
    ("npc2_kingsupport_2b", "I do not ask for their support, as they would no doubt wish to make a profit on the transaction."), #Aleifr
    ("npc3_kingsupport_2b", "I have no intention of helping any more slaves, sorry."), #Eithne
    ("npc4_kingsupport_2b", "I don't have any, unfortunately."), #Athrwys
    ...
    ("npc7_kingsupport_2b", "Sorry, even though I respect you for your abilities, warriors, men, and Britons, are usually way more deserving than others."), #Bridei
    ...
    ("npc11_kingsupport_2b", "I am no Arthur. Forget about it."), #Gwenllian
    ...
    ("npc15_kingsupport_2b", "{King/Queen} of the weak and the poor, maybe. Enough of such talk."), #Agasicles
    ("npc16_kingsupport_2b", "No offense, but I'm not sure that's the approach I'd take -- you see, perhads Wotan or Thor, or even Macha would not like that at all."), #Aedh
    ("npc_bashe_kingsupport_2b", "No offense, but I'm not sure that's the approach I'd take. I am no hope-bringer."), 
    ("npc_sange_kingsupport_2b", "No offense, but I'm not sure that's the approach I'd take. I am no hope-bringer."), 
    ...
    ("npc_tank_kingsupport_2b", "No offense, but I'm not sure that's the approach I'd take"), #klethi
    ("npc_backwoodsharry_kingsupport_2b", "No offense, but I'm not sure that's the approach I'd take"), #klethi
    ...
    ("npc_enchantress_kingsupport_2b", "No offense, but I'm not sure that's the approach I'd take"), #klethi
    ...
    ("npc_sange_kingsupport_3", "Give me leave for a few weeks. If people start to see you as a glimmer of hope in these dark times, even a faint one, it will surely be easier for them to accept you as a rightful ruler. What do you say to that, warlord?"), 
    ...
    ("npc_tank_kingsupport_3", "Give me leave for a few weeks. If people start to see you as a glimmer of hope in these dark times, even a faint one, it will surely be easier for them to accept you as a rightful ruler. What do you say to that, warlord?"), 
    ("npc_backwoodsharry_kingsupport_3", "Give me leave for a few weeks. If people start to see you as a glimmer of hope in these dark times, even a faint one, it will surely be easier for them to accept you as a rightful ruler. What do you say to that, warlord?"), 
    ...
    ("npc_enchantress_kingsupport_3", "Give me leave for a few weeks. If people start to see you as a glimmer of hope in these dark times, even a faint one, it will surely be easier for them to accept you as a rightful ruler. What do you say to that, warlord?"), 
    ...
    ("npc_sange_kingsupport_objection", "Warlord -- I cannot agree with the arguments you allowed to be said in your name for the sake of your future as King. They are wrong, terribly wrong. And you know it. I am sorry to speak my mind in this rude tone, but I could no longer keep my mouth shut in face of such iniquity."), 
    ...
    ("npc_tank_kingsupport_objection", "I cannot agree with the arguments you allowed to be said in your name for the sake of your future as King. They are wrong, terribly wrong. And you know it. I am sorry to speak my mind in this rude tone, but I could no longer keep my mouth shut in face of such iniquity."), #klethi
    ("npc_backwoodsharry_kingsupport_objection", "I cannot agree with the arguments you allowed to be said in your name for the sake of your future as King. They are wrong, terribly wrong. And you know it. I am sorry to speak my mind in this rude tone, but I could no longer keep my mouth shut in face of such iniquity."), #klethi
    ...
    ("npc_enchantress_kingsupport_objection", "I cannot agree with the arguments you allowed to be said in your name for the sake of your future as King. They are wrong, terribly wrong. And you know it. I am sorry to speak my mind in this rude tone, but I could no longer keep my mouth shut in face of such iniquity."), #klethi
  ...
  #
    ...
    ("npc2_intel_mission", "{Sir/My lady}, if you're interested in events in {s18}, I can still make contact with my old trading partners in {s17}. They're usually well-informed about political events."), #Aleifr - Cantware
    ...
    ("npc_sange_intel_mission", "Warlord... As you may know, I grew up in the rural area of {s17}. One of my childhood mates has lately been in touch with me, and suggests that if I were to visit him, he could pass me information on events within the {s18}. I am willing to do this, if you can spare me. He is the one that still lives there, and can suffer the wrath of local rulers, anyways."), #
    ...
    ("npc_tank_intel_mission", "If you need, I can go to {s17} and gain insight into {s18}."), #klethi
    ("npc_backwoodsharry_intel_mission", "If you need, I can go to {s17} and gain insight into {s18}."), #klethi
    ...
    ("npc_enchantress_intel_mission", "If you need, I can go to {s17} and gain insight into {s18}."), #klethi
    ...
    ("npc2_fief_acceptance", "{s17} as a fief? Well, I've always thought in terms of buying and selling goods, not in terms of governing anything. But now that you mention it, I bet I could make that place turn a fair bit of revenue. I thank you, {my Lord/my lady} -- this is a very kind turn that you have done me."), #Aleifr
    ("npc3_fief_acceptance", "{Sire/My lady}, it is most generous of you to offer me {s17}, me, an ex-slave. I would be pleased to hold it, and dedicate myself to the moral and material uplift of its inhabitants. And I will not tolerate any kind of slavery in my fief."), #Eithne
    ("npc4_fief_acceptance", "It is good of you to grant me {s17} as a fief -- and most appropriate. Proud indeed is the king who has a lord of the House of Gwawrddur as {his/her} vassal."), #Athrwys
    ...
    ("npc7_fief_acceptance", "Aye, I'll hold {s17} -- and prove all across Britannia that Picts are more than capable of ruling and governing land and men. Thank you, {sire/madame}, for this opportunity."), #Bridei
    ...
    ("npc11_fief_acceptance", "Ay! You'd grant me a title of nobility? There can be no greater sigil of love, can there? My, the strange turns that life takes... Fancy this once-exploited and abused housewife finding love and becoming a great peer of a realm in Britannia."), #Gwenllian
    ...
    ("npc15_fief_acceptance", "You do me a great honor, warlord. In Creta, a youngest son such as myself has few opportunities to earn a fief of his own. But here, in Britannia, there is still the chance for a man to win with his sword what was denied him by his birth! I shall hold {s17} as your vassal, and raise an army to fight for your glory and for mine."), #Agasicles
    ("npc16_fief_acceptance", "You truly fear God and respect his will. This is good. {s17} will become a center of faith and truth, and will be a powerful beacon in the dark night of paganism and heresy that still haunts Britannia and Hibernia. Be in peace, and may God be with you."), #Aedh  
    ...
    ("npc_tank_fief_acceptance", "It would be my honor to serve you by governing a fief for you {sire/my lady}."), #klethi  
    ("npc_backwoodsharry_fief_acceptance", "It would be my honor to serve you by governing a fief for you {sire/my lady}."), #klethi  
    ...
    ("npc_enchantress_fief_acceptance", "Oh, that's most generous of you, {sire/my lady}. I've been in and out of many a great hall or manor -- not always with the master's permission, I should add -- but I never thought I'd own one myself. Let me think... When I collect my first year's rents, what baubles shall I buy myself?"), #klethi  
    ...
    ("npc2_turn_against", "This is a sad day. I never thought that I might meet my old warlord on the field of battle. Even if I triumph, it will bring me no joy."), #Aleifr
    ("npc3_turn_against", "Oh {playername} -- what a tragic turn our lives have taken! I can only hope that the tides of war that have made us enemies, will one day allow us to be friends."), #Eithne
    ("npc4_turn_against", "Aye, well.... I'm not sure what to say. If we must fight, let's get it over with."), #Athrwys
    ...
    ("npc7_turn_against", "Well, old leader. You made of me a great lady, and for that I am grateful. However, you did not buy me, and now the circumstances have caused our interests to clash, I can meet you in battle with a clear conscience. Still, I hope someday that circumstances may change again, and even though you will suffer defeat, we may meet as friends again."), #Bridei
    ...
    ("npc11_turn_against", "Great Heaven, my heart is now as broken as shattered glass. So it looks like you and I are enemies. Didn't I say that life and love takes us on some very strange turns? Destiny sometimes has a cruel sense of humor -- to turn love into hate so easily."), #Gwenllian
    ...
    ("npc15_turn_against", "Ah... I have not been looking forward to this day. I just want to say that in my sight, if you'd kept your faith in me, things would never have come to this. But no doubt you see it differently."), #Agasicles
    ("npc16_turn_against", "I now see that for the time we travelled together you intended only to use and deceive me. For your soul belongs to the Devil, and the darkness of passion for the old gods lingers within your heart. For the peace of Christ, I must now defeat you in the field. Do not doubt that God is by my side today, and nothing but defeat is prepared for you right now."), #Aedh  
    ...
    ("npc_sange_turn_against", "Hello, Warlord! So, I guess we're enemies! One small word of warning if we end up fighting each other -- once the rage of battle hits me, I can't always account for my actions. Just know that whatever I do, it's all because of the profound hate I now harbor against you. Maybe if we both walk away from this now, you will be able to spare you sorry life from my wrath."), 
    ...
    ("npc_tank_turn_against", "To think, that one day we would meet each other on the field of battle... Don't expect me to hold back."), #klethi
    ("npc_backwoodsharry_turn_against", "So we meet again, very well, I will have you taste my blade!"), #klethi
    ...
    ("npc_enchantress_turn_against", "Hello, Captain! So, I guess we're enemies! One small word of warning if we end up fighting each other -- once the rage of battle hits me, I can't always account for my actions. Just know that whatever I do, it's not personal. Maybe if we both walk away from this, we can meet once more as friends?"), #klethi
