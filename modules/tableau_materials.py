...
#  2) Tableau flags (int). See headers.tableau_materials.py for a list of available flags
...
#  10) Operations block (list): A list of operations. See headers.operations.py for reference.
...
tableaus = [
    ...
    ##       (cur_tableau_add_override_item, "itm_rich_greaves_red"),
    ...
    ##       (cur_tableau_add_override_item, "itm_carbatinae_greaves_white"),
    ##       (assign, ":animation", "anim_pose_4"),
    # (else_try),
    ##       (eq, ":type", 8),
