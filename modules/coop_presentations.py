...
from headers.presentations import *
...
#  2) Presentation flags. See headers.presentations.py for a list of available flags
#  3) Presentation background mesh: See meshes.py for a list of available background meshes
    ...
    ("coop_commander_select", prsntf_manual_end_only, 0, [
        (ti_on_presentation_load,
         [(set_fixed_point_multiplier, 1000),
          ...
          # assume all ally lords are in other parties
          (neg | is_between, "$coop_my_troop_no", kings_begin, pretenders_end),
    ...
    ("coop_escape_menu", prsntf_manual_end_only, 0, [
        ...
        (ti_on_presentation_event_state_change,
         [(store_trigger_param_1, ":object"),
          ...
          (presentation_set_duration, 0),
          (multiplayer_send_int_to_server, multiplayer_event_coop_send_to_server,
           coop_event_player_open_inventory_before_spawn),
          (else_try),
    ...
    ("coop_stats_chart", prsntf_read_only | prsntf_manual_end_only, 0, [
        (ti_on_presentation_load,
         [(set_fixed_point_multiplier, 1000),
          ...
          (else_try),
          # get kill count in "siege" or "battle" or "team deathmatch" or "deathmatch"
          ...
          (player_get_team_no, ":player_team", ":player_no"),
          # to not to allow dedicated server to pass below, dedicated servers have -1 for team_no not 2(multi_team_spectator).
          (eq, ":player_team", multi_team_spectator),
    ...
    ("coop_item_select", prsntf_manual_end_only, 0, [
        (ti_on_presentation_load,
         [(set_fixed_point_multiplier, 1000),
          ...
          (create_image_button_overlay, "$g_presentation_obj_item_select_1",
           "mesh_mp_inventory_slot_empty", "mesh_mp_inventory_slot_empty"),
          ...
          (else_try),
          (create_image_button_overlay, "$g_presentation_obj_item_select_1",
           "mesh_mp_inventory_slot_equip", "mesh_mp_inventory_slot_equip"),
          (try_end),
          (position_set_x, pos1, 800),
          ...
          (try_begin),
          (ge, ":selected_item_id", 0),
          (create_image_button_overlay, "$g_presentation_obj_item_select_2",
           "mesh_mp_inventory_slot_empty", "mesh_mp_inventory_slot_empty"),
          (create_mesh_overlay_with_item_id, reg0, ":selected_item_id"),
          (position_set_x, pos1, 950),
          ...
          (try_begin),
          (ge, ":selected_item_id", 0),
          (create_image_button_overlay, "$g_presentation_obj_item_select_3",
           "mesh_mp_inventory_slot_empty", "mesh_mp_inventory_slot_empty"),
          (create_mesh_overlay_with_item_id, reg0, ":selected_item_id"),
          (position_set_x, pos1, 950),
          ...
          (try_begin),
          (ge, ":selected_item_id", 0),
          (create_image_button_overlay, "$g_presentation_obj_item_select_4",
           "mesh_mp_inventory_slot_empty", "mesh_mp_inventory_slot_empty"),
          (create_mesh_overlay_with_item_id, reg0, ":selected_item_id"),
          (position_set_x, pos1, 950),
          ...
          (try_begin),
          (ge, ":selected_item_id", 0),
          (create_image_button_overlay, "$g_presentation_obj_item_select_5",
           "mesh_mp_inventory_slot_empty", "mesh_mp_inventory_slot_empty"),
          (create_mesh_overlay_with_item_id, reg0, ":selected_item_id"),
          ...
          (else_try),
          (create_image_button_overlay, "$g_presentation_obj_item_select_5",
           "mesh_mp_inventory_slot_helmet", "mesh_mp_inventory_slot_helmet"),
          (try_end),
          (position_set_x, pos1, 800),
          (position_set_y, pos1, 800),
          ...
          (try_begin),
          (ge, ":selected_item_id", 0),
          (create_image_button_overlay, "$g_presentation_obj_item_select_6",
           "mesh_mp_inventory_slot_empty", "mesh_mp_inventory_slot_empty"),
          (create_mesh_overlay_with_item_id, reg0, ":selected_item_id"),
          (position_set_x, pos1, 53),
          ...
          (else_try),
          (create_image_button_overlay, "$g_presentation_obj_item_select_6",
           "mesh_mp_inventory_slot_armor", "mesh_mp_inventory_slot_armor"),
          (try_end),
          (position_set_x, pos1, 800),
          (position_set_y, pos1, 800),
          ...
          (try_begin),
          (ge, ":selected_item_id", 0),
          (create_image_button_overlay, "$g_presentation_obj_item_select_7",
           "mesh_mp_inventory_slot_empty", "mesh_mp_inventory_slot_empty"),
          (create_mesh_overlay_with_item_id, reg0, ":selected_item_id"),
          (position_set_x, pos1, 53),
          ...
          (else_try),
          (create_image_button_overlay, "$g_presentation_obj_item_select_7",
           "mesh_mp_inventory_slot_boot", "mesh_mp_inventory_slot_boot"),
          (try_end),
          (position_set_x, pos1, 800),
          (position_set_y, pos1, 800),
          ...
          (try_begin),
          (ge, ":selected_item_id", 0),
          (create_image_button_overlay, "$g_presentation_obj_item_select_8",
           "mesh_mp_inventory_slot_empty", "mesh_mp_inventory_slot_empty"),
          (create_mesh_overlay_with_item_id, reg0, ":selected_item_id"),
          (position_set_x, pos1, 53),
          ...
          (else_try),
          (create_image_button_overlay, "$g_presentation_obj_item_select_8",
           "mesh_mp_inventory_slot_glove", "mesh_mp_inventory_slot_glove"),
          (try_end),
          (position_set_x, pos1, 800),
          (position_set_y, pos1, 800),
          ...
          (create_image_button_overlay, "$g_presentation_obj_item_select_9",
           "mesh_mp_inventory_slot_empty", "mesh_mp_inventory_slot_empty"),
          (create_mesh_overlay_with_item_id, reg0, ":selected_item_id"),
          (position_set_x, pos1, 53),
          ...
          (else_try),
          (create_image_button_overlay, "$g_presentation_obj_item_select_9",
           "mesh_mp_inventory_slot_horse", "mesh_mp_inventory_slot_horse"),
          (try_end),
          (position_set_x, pos1, 800),
          (position_set_y, pos1, 800),
          ...
          # add 3 to skip container, need to be > item11 + 2
          (store_add, "$g_presentation_obj_item_select_next", "$g_presentation_obj_item_select_11", 3),
        ...
        (ti_on_presentation_event_state_change,
         [(store_trigger_param_1, ":object"),
          ...
          (multiplayer_send_3_int_to_server, multiplayer_event_coop_send_to_server,
           coop_event_player_get_selected_item_types, itp_type_one_handed_wpn, itp_type_goods),
          (presentation_set_duration, 0),
          ...
          (multiplayer_send_3_int_to_server, multiplayer_event_coop_send_to_server,
           coop_event_player_get_selected_item_types, itp_type_head_armor, itp_type_body_armor),
          (presentation_set_duration, 0),
          #            (start_presentation, "prsnt_coop_item_select"),
          (else_try),
          (eq, ":object", "$g_presentation_obj_item_select_6"),
          ...
          (multiplayer_send_3_int_to_server, multiplayer_event_coop_send_to_server,
           coop_event_player_get_selected_item_types, itp_type_body_armor, itp_type_foot_armor),
          (presentation_set_duration, 0),
          #            (start_presentation, "prsnt_coop_item_select"),
          (else_try),
          (eq, ":object", "$g_presentation_obj_item_select_7"),
          ...
          (multiplayer_send_3_int_to_server, multiplayer_event_coop_send_to_server,
           coop_event_player_get_selected_item_types, itp_type_foot_armor, itp_type_hand_armor),
          (presentation_set_duration, 0),
          #            (start_presentation, "prsnt_coop_item_select"),
          (else_try),
          (eq, ":object", "$g_presentation_obj_item_select_8"),
          ...
          (multiplayer_send_3_int_to_server, multiplayer_event_coop_send_to_server,
           coop_event_player_get_selected_item_types, itp_type_hand_armor, itp_type_pistol),
          (presentation_set_duration, 0),
          #            (start_presentation, "prsnt_coop_item_select"),
          (else_try),
          (eq, ":object", "$g_presentation_obj_item_select_9"),
          ...
          (multiplayer_send_3_int_to_server, multiplayer_event_coop_send_to_server,
           coop_event_player_get_selected_item_types, itp_type_horse, itp_type_one_handed_wpn),
          (presentation_set_duration, 0),
          #            (start_presentation, "prsnt_coop_item_select"),
          (try_end),
          (else_try),
          ...
          (multiplayer_send_4_int_to_server, multiplayer_event_coop_send_to_server,
             coop_event_player_ask_for_selected_item, ":player_slot", ":item_no", ":party_inventory_slot"),
        ...
        (ti_on_presentation_mouse_press,
         [(store_trigger_param_1, ":object"),
          ...
          (multiplayer_send_3_int_to_server, multiplayer_event_coop_send_to_server,
           coop_event_player_remove_selected_item, 0, ":item_remove"),
          (presentation_set_duration, 0),
          (assign, "$g_presentation_state", 0),
          (start_presentation, "prsnt_coop_item_select"),
          (else_try),
          ...
          (multiplayer_send_3_int_to_server, multiplayer_event_coop_send_to_server,
           coop_event_player_remove_selected_item, 1, ":item_remove"),
          ...
          (multiplayer_send_3_int_to_server, multiplayer_event_coop_send_to_server,
           coop_event_player_remove_selected_item, 2, ":item_remove"),
          ...
          (multiplayer_send_3_int_to_server, multiplayer_event_coop_send_to_server,
           coop_event_player_remove_selected_item, 3, ":item_remove"),
          ...
          (multiplayer_send_3_int_to_server, multiplayer_event_coop_send_to_server,
           coop_event_player_remove_selected_item, 4, ":item_remove"),
          ...
          (multiplayer_send_3_int_to_server, multiplayer_event_coop_send_to_server,
           coop_event_player_remove_selected_item, 5, ":item_remove"),
          ...
          (multiplayer_send_3_int_to_server, multiplayer_event_coop_send_to_server,
           coop_event_player_remove_selected_item, 6, ":item_remove"),
          ...
          (multiplayer_send_3_int_to_server, multiplayer_event_coop_send_to_server,
           coop_event_player_remove_selected_item, 7, ":item_remove"),
          ...
          (multiplayer_send_3_int_to_server, multiplayer_event_coop_send_to_server,
           coop_event_player_remove_selected_item, 8, ":item_remove"),
