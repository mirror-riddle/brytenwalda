...
#  2) Map icon flags. See headers.map icons.py for a list of available flags
#  3) Mesh name.
#  4) Scale.
#  5) Sound.
...
map_icons = [
    ...
    ("town_desert", mcn_no_shadow, "map_tradeport", 0.25, 0),  # ciudad con puerto chief
    ...
    ("village_deserted_a", mcn_no_shadow, "map_village_deserted_a", 0.45, 0),  # para animales en agua chief
    ...
    ("village_deserted_c", mcn_no_shadow, "outpost", 0.22, 0),  # lo usamos para outpost chief
