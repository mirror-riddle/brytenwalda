...
#  3) Quest flags. See headers.quests.py for a list of available flags
...
quests = [
    # Note : This is defined as the first governer quest in constants.py:
    ...
    ##################
    # Note : This is defined as the first enemy lord quest in constants.py:
    ...
    # Kingdom Army quests
    ##################
    # Note : This is defined as lord quests end in constants.py:
    ...
    # Note : This is defined as the first army quest in constants.py:
    ...
    # Kingdom Lady quests
    ##################
    # Note : This is defined as the first kingdom lady quest in constants.py:
    ...
    # Mayor quests
    ##################
    # Note : This is defined as the first mayor quest in constants.py:
 ...
 In order to do that, you must either convince them or make sure they fall captive and remain so until a peace agreement is made."
    ...
    ############
    # Note : This is defined as the first village elder quest in constants.py:
    ...
    # Note : This is defined as the last village elder quest in constants.py:
    ...
    ("consult_with_minister", "Consult With Minister", qf_random_quest,
        "{!}Consult your minister, {s11}, currently at {s12}"),

    ("organize_feast",        "Organize Feast", qf_random_quest,
        "{!}Bring goods for a feast to your spouse {s11}, currently at {s12}"),
    ...
    ("offer_gift",            "Procure Gift", qf_random_quest,
        "{!}Give {s10} a gift to provide to {reg4?her:his} {s11}, {s12}"),
    ...
    ###chief quests###########
    ("mod_trouble", "Speak with the troublemakers in Cirren Ceaster", 0,
...
How you want to tackle the problem is up to you; He has promised a small purse if you succeed."
    ...
    ("espada_falcata", "The return of the Roman Empire: Londinium (Lundenwic)", 0,
        "{!}You must conquer Londinium (Lundenwic) and return to Hadrian's Wall for your reward."
     ),
    ###chief acaba#######
    # chief quest relic

    ("relic", "Find holy relic", 0,
     "{!}A cleric called Ulcagnus told me interesting story about heresi, Arrians that stolen holy relic. I must find them and after battle, persuade their leader to give me holy relic. Those bastards, now should be near Ynys Manaw!"
     ),
    # chief acaba
    ...
    # chief acaba
    ("talk_to_zamoshie_elder", "Talk to the Llan Forfael Elder", 0,
        "A man mentioned that the elder of Llan Forfael would pay you well for your services. Perhaps you might pay him a visit."),
    ("zamoshie_lower_taxes", "Peasant Taxes", 0, "Convince the warlord in Caer Ligualid to lower the taxes of the Llan Forfael."),
    ("deal_with_zamoshie_bandits", "North Bandits", 0, "Kill the North bandits."),
    ("oim_bring_goods_zamoshie", "Bring Goods to Llan Forfael", 0, "Deliver Salt to Llan Forfael."),
