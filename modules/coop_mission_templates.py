...
#
#  2) Mission-template flags (int): See headers.mission-templates.py for a list of available flags
...
#     See triggers.py for infomation about triggers.
#
        ...
        [
            ...
            (ti_after_mission_start, 0, 0, [],
             [
                ...
                # set player wants all troops in party (host will override clients)#this should be optional
                (assign, "$g_multiplayer_bot_type_1_wanted", 1),
            ...
            (0, 0, 0, [],
             [
                ...
                (add_visitors_to_current_scene, reg0, ":selected_troop",
                 1, ":selected_team", -1),  # don't assign group at spawn
            ...
            (3, 0, 0, [],
             [
                ...
                (multiplayer_send_3_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
                 coop_event_return_num_reserves, 1,  "$coop_num_bots_team_1"),
                (multiplayer_send_3_int_to_player, ":player_no", multiplayer_event_coop_send_to_player,
                 coop_event_return_num_reserves, 2,  "$coop_num_bots_team_2"),
                (try_end),
            ...
            (ti_on_agent_killed_or_wounded, 0, 0, [],
             [
                ...
                (call_script, "script_show_multiplayer_message",
                 multiplayer_message_type_round_result_in_battle_mode, "$coop_winner_team"),  # team 2 is winner
        ...
        [
            ...
            (ti_on_agent_spawn, 0, 0, [],
             [
                ...
                # keep defenders in castle until attackers reach wall
                (agent_set_scripted_destination, ":agent_no", pos25, 0),
                (try_end),
                (try_end),
                ...
                (call_script, "script_coop_equip_player_agent", ":agent_no"),  # ITEM BUG WORKAROUND
                (try_end),
                (agent_set_slot, ":agent_no", slot_agent_coop_banner,
                 "$coop_agent_banner"),  # store banner of agent for clients too
            ...
            (0, 0, 0, [],
             [
                ...
                # belfry entry points are 50..55 and 60..65 and 70..75
                ...
                # 0.2 * 0.2 * 100 = 4 (if distance between belfry and its destination already less than 20cm no need to move it anymore)
                (ge, ":dist_between_belfry_and_its_destination", 4),
                ...
                (call_script, "script_coop_form_line", pos4, "$attacker_team", grc_everyone,
                 200, 100, 3, 0),  # (pos, team, dist to row, dist to troop, rows)
                (try_end),


                # should be lower than 0 to allow belfry to go last entry point
                (assign, ":max_dist_between_entry_point_and_belfry_destination", -1),
                ...
                (gt, ":dist_between_entry_point_and_belfry_destination",
                 ":max_dist_between_entry_point_and_belfry_destination"),
                (assign, ":max_dist_between_entry_point_and_belfry_destination",
                 ":dist_between_entry_point_and_belfry_destination"),
                (assign, ":belfry_next_entry_point_id", ":entry_point_id"),
                (try_end),

                (try_begin),
                (ge, ":belfry_next_entry_point_id", 0),
                # pos5 holds belfry next entry point target during its path
                (entry_point_get_position, pos5, ":belfry_next_entry_point_id"),
                (else_try),
                ...
                (neg | scene_prop_has_agent_on_it, ":belfry_wheel_1_scene_prop_id",
                 ":agent_id"),  # can be removed to make faster
                (neg | scene_prop_has_agent_on_it, ":belfry_wheel_2_scene_prop_id",
                 ":agent_id"),  # can be removed to make faster
                (neg | scene_prop_has_agent_on_it, ":belfry_wheel_3_scene_prop_id",
                 ":agent_id"),  # can be removed to make faster
                ...
                (try_begin),
                (scene_prop_get_slot, ":pre_number_of_agents_around_belfry",
                 ":belfry_scene_prop_id", scene_prop_number_of_agents_pushing),
                ...
                (try_begin),
                # if we are still targetting same entry point subtract
                (eq, ":next_entry_point_id", ":belfry_next_entry_point_id"),
                ...
                # multiplying with 3 to make belfry pushing process slower,
                (val_mul, ":belfry_next_entry_point_distance", 8),
                ...
                (prop_instance_animate_to_position, ":belfry_platform_a_scene_prop_id",
                 pos8, ":belfry_next_entry_point_distance"),
                # belfry platform_b
                (try_begin),
                (eq, ":belfry_kind", 0),
                ...
                (position_transform_position_to_local, pos7, pos1, pos6),
                (position_transform_position_to_parent, pos8, pos22, pos7),
                (prop_instance_animate_to_position, ":belfry_platform_b_scene_prop_id",
                 pos8, ":belfry_next_entry_point_distance"),
                (try_end),
                # wheel rotation
                # -25 fixed bug rotation was reversed
                ...
                (prop_instance_rotate_to_position, ":belfry_wheel_1_scene_prop_id",
                    pos21, ":belfry_next_entry_point_distance", ":belfry_wheel_rotation"),
                ...
                (position_transform_position_to_local, pos7, pos20, pos13),
                (position_transform_position_to_parent, pos21, pos22, pos7),
                (prop_instance_rotate_to_position, ":belfry_wheel_2_scene_prop_id",
                    pos21, ":belfry_next_entry_point_distance", ":belfry_wheel_rotation"),
                ...
                (position_transform_position_to_local, pos7, pos20, pos13),
                (position_transform_position_to_parent, pos21, pos22, pos7),
                (prop_instance_rotate_to_position, ":belfry_wheel_3_scene_prop_id",
                    pos21, ":belfry_next_entry_point_distance", ":belfry_wheel_rotation"),
                ...
                (scene_prop_set_slot, ":belfry_scene_prop_id",
                 scene_prop_number_of_agents_pushing, ":number_of_agents_around_belfry"),
