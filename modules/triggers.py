...
# 4) Conditions block (list). This must be a valid operation block. See headers.operations.py for reference.
#    Every time the trigger is checked, the conditions block will be executed.
#    If the conditions block returns true, the consequences block will be executed.
#    If the conditions block is empty, it is assumed that it always evaluates to true.
# 5) Consequences block (list). This must be a valid operation block. See headers.operations.py for reference.
####################################################################################################################
...
triggers = [
    ...
    (0.1, 0, ti_once,
     [
        ...
        [
         ...
         # Since he is in the field, take him from the tavern
         (remove_troop_from_site, "trp_npc17", "scn_town_41_tavern"),
    ...
    (1.0, 0.0, 0.0, [
        ...
        # ie, the party has not respawned as a non-bandit
        (neg | is_between, ":bandit_party_faction", kingdoms_begin, kingdoms_end),
        ...
        #			(else_try),
        (call_script, "script_add_log_entry",  logent_party_spots_wanted_bandits,
         ":party",  ":nearest_center", ":bandit_party", -1),
        #			(try_end),
        (try_end),
    ...
    (0.5, 0.0, 0.0,
     [
         ...
         (try_end),
         (else_try),
         (store_distance_to_party_from_party, ":cur_distance",
             "$qst_follow_spy_spy_partners_party", "$qst_follow_spy_spy_party"),
         (le, ":cur_distance", 1),
