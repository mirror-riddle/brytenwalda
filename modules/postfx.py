...
postfx_params = [
    ...
    ("indoors", 0, 0, [128.0000, 1.0, 1.2549, 10.0000], [
        0.6471, 4.7843, 4.1616, 0.00155], [0.9804, 0.9804, 1.5294, 1.0000]),
    ("sunset", 0,  0, [128.0000, 0.5882, 0.9804, 0.9804], [
        0.0784, 2.1176, 1.3725, 0.1255], [0.9804, 0.9804, 1.7647, 1.0000]),
    ("night", 0, 0, [128.0000, 1.0, 1.2549, 10.0000], [
     0.6471, 4.7843, 1.2157, 0.0000], [0.9804, 0.9804, 1.5294, 1.0000]),
    ...
    ("sunny", 0,  0, [128.0000, 0.5882, 0.9804, 0.9804], [
        0.0784, 2.1176, 1.3725, 0.1255], [0.9804, 0.9804, 1.7647, 1.0000]),
    ("cloudy", 0, 0, [128.0000, 1.0, 0.9804, 0.0000], [
     0.3137, 2.6667, 2.0000, 0.4314], [0.9804, 0.9804, 1.4314, 1.0000]),
    ("overcast", 0, 0, [128.0000, 1.0, 0.9804, 0.0000], [
     0.3137, 2.6667, 2.0000, 0.0], [0.9804, 0.9804, 1.0314, 1.0000]),
