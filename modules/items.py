...
#  4) Item flags. See headers.items.py for a list of available flags.
#  5) Item capabilities. Used for which animations this item is used with. See headers.items.py for a list of available flags.
#  6) Item value.
...
items = [
    ...
    [
        ...
        itp_type_one_handed_wpn | itp_primary | itp_secondary, itc_longsword, 3,
        weight(1.5) | spd_rtng(103) | weapon_length(90) | swing_damage(16, blunt) | thrust_damage(10, blunt),
        imodbits_none
    ],

    [
        "tutorial_spear", "Spear", [("spear", 0)],
        itp_type_polearm | itp_primary | itp_penalty_with_shield | itp_wooden_parry, itc_spear, 0,
        weight(4.5) | spd_rtng(80) | weapon_length(158) | swing_damage(0, cut) | thrust_damage(19,  pierce),
        imodbits_polearm
    ],

    [
        "tutorial_club", "Club", [("club", 0)],
        itp_type_one_handed_wpn | itp_primary | itp_wooden_parry | itp_wooden_attack, itc_scimitar, 0,
        weight(2.5) | spd_rtng(95) | weapon_length(95) | swing_damage(11, blunt) | thrust_damage(0,  pierce),
        imodbits_none
    ],
    ...
    ["tutorial_bolts", "Bolts", [("bolt", 0), ("flying_bolt", ixmesh_flying_ammo), ("bolt_bag", ixmesh_carry), ("bolt_bag_b", ixmesh_carry | imodbit_large_bag)], itp_type_bolts,
     itcf_carry_quiver_right_vertical, 0, weight(2.25) | abundance(90) | weapon_length(55) | thrust_damage(0, pierce) | max_ammo(18), imodbits_missile, missile_distance_trigger],
    ["tutorial_short_bow", "Short Bow", [("short_bow", 0), ("short_bow_carry", ixmesh_carry)], itp_type_bow | itp_primary | itp_two_handed, itcf_shoot_bow |
     itcf_carry_bow_back, 0, weight(1) | spd_rtng(98) | shoot_speed(49) | thrust_damage(12,  pierce), imodbits_bow],
    ["tutorial_crossbow", "Crossbow", [("crossbow", 0)], itp_type_crossbow | itp_primary | itp_two_handed | itp_cant_reload_on_horseback, itcf_shoot_crossbow |
     itcf_carry_crossbow_back, 0, weight(3) | spd_rtng(42) | shoot_speed(68) | thrust_damage(32, pierce) | max_ammo(1), imodbits_crossbow],
    ["tutorial_throwing_daggers", "Throwing Daggers", [("throwing_dagger", 0)], itp_type_thrown | itp_primary, itcf_throw_knife, 0, weight(3.5) | difficulty(
        0) | spd_rtng(102) | shoot_speed(25) | thrust_damage(16,  cut) | max_ammo(14) | weapon_length(0), imodbits_missile, missile_distance_trigger],
    ["tutorial_saddle_horse", "Saddle Horse", [("saddle_horse", 0)], itp_type_horse, 0, 0, abundance(90) | body_armor(
     3) | horse_speed(40) | horse_maneuver(38) | horse_charge(8), imodbits_horse_basic],
    ["tutorial_shield", "Round Shield", [("leathershield_small_b", 0)], itp_type_shield | itp_wooden_parry, itcf_carry_kite_shield,  118, weight(
     2.5) | hit_points(480) | body_armor(1) | spd_rtng(82) | weapon_length(150), imodbits_shield],
    ["tutorial_staff_no_attack", "Staff", [("wooden_staff", 0)], itp_type_polearm | itp_offset_lance | itp_primary | itp_penalty_with_shield | itp_wooden_parry | itp_wooden_attack,
     itc_parry_polearm | itcf_carry_sword_back, 9, weight(3.5) | spd_rtng(120) | weapon_length(115) | swing_damage(0, blunt) | thrust_damage(0, blunt), imodbits_none],
    ["tutorial_staff", "Staff", [("wooden_staff", 0)], itp_type_polearm | itp_offset_lance | itp_primary | itp_penalty_with_shield | itp_wooden_parry | itp_wooden_attack,
     itc_staff | itcf_carry_sword_back, 9, weight(3.5) | spd_rtng(120) | weapon_length(115) | swing_damage(16, blunt) | thrust_damage(16, blunt), imodbits_none],
    ["tutorial_sword", "Sword", [("long_sword", 0), ("scab_longsw_a", ixmesh_carry)], itp_type_one_handed_wpn | itp_primary, itc_longsword | itcf_carry_sword_left_hip |
     itcf_show_holster_when_drawn, 0, weight(1.5) | spd_rtng(100) | weapon_length(102) | swing_damage(18, cut) | thrust_damage(15,  pierce), imodbits_sword],
    ["tutorial_axe", "Axe", [("iron_ax", 0)], itp_type_two_handed_wpn | itp_two_handed | itp_primary | itp_bonus_against_shield | itp_wooden_parry, itc_nodachi |
     itcf_carry_axe_back, 0, weight(4) | spd_rtng(91) | weapon_length(108) | swing_damage(19, cut) | thrust_damage(0,  pierce), imodbits_axe],

    ["tutorial_dagger", "Dagger", [("hunting_dagger", 0)], itp_type_one_handed_wpn | itp_primary | itp_secondary, itc_longsword, 3, weight(
        1.5) | spd_rtng(103) | weapon_length(40) | swing_damage(16, blunt) | thrust_damage(10, blunt), imodbits_none],


    ["horse_meat", "Horse Meat", [("raw_meat", 0)], itp_type_goods | itp_consumable | itp_food,
        0, 12, weight(40) | food_quality(30) | max_ammo(40), imodbits_none],
    # Items before this point are hardwired and their order should not be changed!
    # cambiados chief
    ["practice_sword", "Practice Sword", [("pattern_spatha", 0), ("sword_medieval_b_scabbard2", ixmesh_carry)], itp_type_one_handed_wpn | itp_primary, itc_longsword | itcf_carry_sword_left_hip |
     itcf_show_holster_when_drawn, 900, weight(1.25) | difficulty(1) | spd_rtng(82) | weapon_length(95) | swing_damage(35, cut) | thrust_damage(10,  pierce), imodbits_none],
    ...
    ["practice_dagger", "Practice Dagger", [("hunting_dagger", 0)], itp_type_one_handed_wpn | itp_primary | itp_secondary | itp_no_parry | itp_wooden_attack, itc_dagger |
        itcf_carry_dagger_front_left, 60, weight(0.5) | spd_rtng(97) | weapon_length(40) | swing_damage(11, cut) | thrust_damage(11,  pierce), imodbits_none],
    ...
    ["arena_axe", "Axe", [("le_werkaxt1", 0)], itp_type_one_handed_wpn | itp_primary | itp_secondary | itp_bonus_against_shield | itp_wooden_parry, itc_scimitar | itcf_carry_axe_left_hip,
        300, weight(1.5) | spd_rtng(77) | weapon_length(60) | swing_damage(26, pierce) | thrust_damage(0,  pierce), imodbits_axe],
    ["arena_sword", "Sword", [("pattern_spatha", 0), ("sword_medieval_b_scabbard2", ixmesh_carry)], itp_type_one_handed_wpn | itp_primary, itc_longsword | itcf_carry_sword_left_hip |
        itcf_show_holster_when_drawn, 900, weight(1.25) | spd_rtng(82) | weapon_length(95) | swing_damage(35, cut) | thrust_damage(10,  pierce), imodbits_sword_high],
    ["arena_sword_two_handed",  "War Axe", [("01tveirhendr_hedmarkox", 0)], itp_type_two_handed_wpn | itp_two_handed | itp_primary | itp_cant_use_on_horseback | itp_bonus_against_shield | itp_wooden_parry, itc_nodachi | itcf_carry_axe_back,
        620, weight(3) | difficulty(1) | spd_rtng(71) | weapon_length(100) | swing_damage(42, pierce) | thrust_damage(0,  pierce), imodbits_axe],
    ["arena_lance",         "Arena Spear", [("05krokaspjott1", 0)], itp_type_polearm | itp_offset_lance | itp_primary | itp_wooden_parry, itc_staff | itcf_carry_spear, 420, weight(
     4) | abundance(80) | difficulty(1) | spd_rtng(92) | weapon_length(160) | swing_damage(16, blunt) | thrust_damage(26,  pierce), imodbits_polearm],
    ["practice_staff", "Practice Spear", [("05krokaspjott1", 0)], itp_type_polearm | itp_offset_lance | itp_primary | itp_wooden_parry, itc_staff | itcf_carry_spear, 180, weight(
     2.25) | difficulty(1) | spd_rtng(82) | weapon_length(145) | swing_damage(15, blunt) | thrust_damage(28,  pierce), imodbits_polearm],
    ["practice_lance", "Practice Spear", [("05krokaspjott1", 0)], itp_type_polearm | itp_offset_lance | itp_primary | itp_wooden_parry, itc_staff | itcf_carry_spear, 180, weight(
     2.25) | difficulty(1) | spd_rtng(82) | weapon_length(145) | swing_damage(15, blunt) | thrust_damage(28,  pierce), imodbits_polearm],
    ["practice_shield", "Practice Shield", [("leathershield_small_b", 0)],  itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  400, weight(
     4.5) | hit_points(400) | body_armor(6) | spd_rtng(55) | shield_width(70), imodbits_shield],
    ["practice_bow", "Hunting Bow", [("hunting_bow", 0), ("hunting_bow_carry", ixmesh_carry)], itp_type_bow | itp_primary | itp_two_handed, itcf_shoot_bow | itcf_carry_bow_back,
        267, weight(1) | spd_rtng(70) | shoot_speed(45) | thrust_damage(14,  pierce) | accuracy(65), imodbits_bow],  # chief cambiado
    ...
    ["practice_crossbow", "Javelins", [("javelin", 0), ("javelins_quiver_new", ixmesh_carry)], itp_type_thrown | itp_primary | itp_secondary | itp_bonus_against_shield | itp_next_item_as_melee, itcf_throw_javelin | itcf_carry_quiver_back | itcf_show_holster_when_drawn,
        100, weight(2) | spd_rtng(60) | shoot_speed(28) | thrust_damage(21,  pierce) | max_ammo(6) | weapon_length(65), imodbits_thrown],
    ...
    ["practice_javelin", "Practice Javelins", [("javelin", 0), ("javelins_quiver_new", ixmesh_carry)], itp_type_thrown | itp_primary | itp_secondary | itp_bonus_against_shield | itp_next_item_as_melee, itcf_throw_javelin | itcf_carry_quiver_back | itcf_show_holster_when_drawn,
        100, weight(2) | spd_rtng(60) | shoot_speed(28) | thrust_damage(21,  pierce) | max_ammo(6) | weapon_length(65), imodbits_thrown, missile_distance_trigger],  # chief cambiado max_ammo
    ["practice_javelin_melee", "practice_javelin_melee", [("javelin", 0)], itp_type_polearm | itp_primary | itp_secondary | itp_wooden_parry, itc_staff,
        100, weight(2) | spd_rtng(70) | swing_damage(4, cut) | thrust_damage(19,  pierce) | weapon_length(65), imodbits_polearm],  # chief cambiado
    ["practice_throwing_daggers", "Throwing Daggers", [("throwing_dagger", 0)], itp_type_thrown | itp_primary, itcf_throw_knife, 0, weight(
     3.5) | spd_rtng(102) | shoot_speed(25) | thrust_damage(6, blunt) | max_ammo(10) | weapon_length(0), imodbits_thrown, missile_distance_trigger],
    ["practice_throwing_daggers_100_amount", "Throwing Daggers", [("throwing_dagger", 0)], itp_type_thrown | itp_primary, itcf_throw_knife, 0, weight(
     3.5) | spd_rtng(102) | shoot_speed(25) | thrust_damage(6, blunt) | max_ammo(100) | weapon_length(0), imodbits_thrown],
    ...
    ["practice_horse", "Practice Horse", [("saddle_horse", 0)], itp_type_horse, 0, 37, body_armor(
     10) | horse_speed(35) | horse_maneuver(37) | horse_charge(8), imodbits_none],
    ["practice_arrows", "Practice Arrows", [("arena_arrow", 0), ("flying_arrow", ixmesh_flying_ammo), ("quiver", ixmesh_carry)], itp_type_arrows | itp_default_ammo, itcf_carry_quiver_back, 100, weight(
     3) | abundance(110) | weapon_length(95) | thrust_damage(1, pierce) | max_ammo(60), imodbits_missile, missile_distance_trigger],  # chief cambiado
    ...
    ["practice_bolts", "Practice Dagger", [("hunting_dagger", 0)], itp_type_one_handed_wpn | itp_primary | itp_secondary | itp_no_parry | itp_wooden_attack, itc_dagger |
        itcf_carry_dagger_front_left, 60, weight(0.5) | spd_rtng(97) | weapon_length(40) | swing_damage(11, cut) | thrust_damage(11,  pierce), imodbits_none],
    ["practice_arrows_10_amount", "Practice Arrows", [("arrow", 0), ("flying_arrow", ixmesh_flying_ammo), ("quiver", ixmesh_carry)],
        itp_type_arrows, itcf_carry_quiver_back, 0, weight(1.5) | weapon_length(95) | max_ammo(10), imodbits_missile, missile_distance_trigger],
    ["practice_arrows_100_amount", "Practice Arrows", [("arrow", 0), ("flying_arrow", ixmesh_flying_ammo), ("quiver", ixmesh_carry)], itp_type_arrows, itcf_carry_quiver_back, 0, weight(
     1.5) | weapon_length(95) | max_ammo(100), imodbits_missile, missile_distance_trigger],
    ...
    ["blue_tourney_armor", "Blue Tourney Armor", [("arena_tunicB_new", 0)], itp_type_body_armor | itp_covers_legs, 0, 152, weight(
     15.0) | body_armor(20) | leg_armor(6), imodbits_none],
    ["green_tourney_armor", "Green Tourney Armor", [("arena_tunicG_new", 0)], itp_type_body_armor | itp_covers_legs, 0, 152, weight(
     15.0) | body_armor(20) | leg_armor(6), imodbits_none],
    ["gold_tourney_armor", "White Tourney Armor", [("arena_tunicW_new", 0)], itp_type_body_armor | itp_covers_legs, 0, 152, weight(
     15.0) | body_armor(20) | leg_armor(6), imodbits_none],
    ["red_tourney_helmet", "Red Tourney Helmet", [("skull_cap_new_c", 0)],
        itp_type_head_armor, 0, 126, weight(2) | head_armor(16), imodbits_none],
    ["blue_tourney_helmet", "Blue Tourney Helmet", [
     ("leather_cap", 0)], itp_type_head_armor, 0, 126, weight(2) | head_armor(16), imodbits_none],
    ["green_tourney_helmet", "Green Tourney Helmet", [
     ("leather_cap", 0)], itp_type_head_armor, 0, 126, weight(2) | head_armor(16), imodbits_none],
    ["gold_tourney_helmet", "Gold Tourney Helmet", [
     ("skull_cap_new_c", 0)], itp_type_head_armor, 0, 126, weight(2) | head_armor(16), imodbits_none],

    ["arena_shield_red", "Shield", [("leathershield_medium", 0)], itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  700, weight(
        4.5) | hit_points(300) | body_armor(20) | spd_rtng(65) | shield_width(70), imodbits_shield],  # chief cambiado
    ["arena_shield_blue", "Shield", [("woodenshield_small_d", 0)], itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  700, weight(
        4.5) | hit_points(300) | body_armor(20) | spd_rtng(65) | shield_width(70), imodbits_shield],  # chief cambiado
    ["arena_shield_green", "Shield", [("leathershield_medium_b", 0)], itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  700, weight(
        4.5) | hit_points(300) | body_armor(20) | spd_rtng(65) | shield_width(70), imodbits_shield],  # chief cambiado
    ["arena_shield_yellow", "Shield", [("leathershield_medium_y", 0)], itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  700, weight(
        4.5) | hit_points(300) | body_armor(20) | spd_rtng(65) | shield_width(70), imodbits_shield],  # chief cambiado
    ...
    ["arena_helmet_red", "Headwrapping", [("leather_cap", 0)], itp_type_head_armor | itp_fit_to_head, 0, 187, weight(
        1.25) | abundance(100) | head_armor(6) | body_armor(0) | leg_armor(0), imodbits_plate],  # cambiar chief
    ["arena_helmet_blue", "Headwrapping", [("leather_cap", 0)], itp_type_head_armor | itp_fit_to_head, 0, 187, weight(
        1.25) | abundance(100) | head_armor(6) | body_armor(0) | leg_armor(0), imodbits_plate],  # cambiar chief
    ["arena_helmet_green", "Headwrapping", [("leather_cap", 0)], itp_type_head_armor | itp_fit_to_head, 0, 187, weight(
        1.25) | abundance(100) | head_armor(6) | body_armor(0) | leg_armor(0), imodbits_plate],  # cambiar chief
    ["arena_helmet_yellow", "Headwrapping", [("leather_cap", 0)], itp_type_head_armor | itp_fit_to_head, 0, 400, weight(1.75) | abundance(
        70) | head_armor(6) | body_armor(0) | leg_armor(0), imodbits_plate],  # cambiar chief #cambiado chief
    ["steppe_helmet_white", "Headwrapping", [("leather_cap", 0)], itp_type_head_armor | itp_fit_to_head, 0, 187, weight(
        1.25) | abundance(100) | head_armor(13) | body_armor(0) | leg_armor(0), imodbits_plate],  # cambiar chief
    ["steppe_helmet_red", "Cap Red", [("leather_cap", 0)], itp_type_head_armor | itp_fit_to_head, 0, 187, weight(
        1.25) | abundance(100) | head_armor(13) | body_armor(0) | leg_armor(0), imodbits_plate],  # cambiar chief
    ["steppe_helmet_blue", "Cap Blue", [("leather_cap", 0)], itp_type_head_armor | itp_fit_to_head, 0, 187, weight(
        1.25) | abundance(100) | head_armor(13) | body_armor(0) | leg_armor(0), imodbits_plate],  # cambiar chief
    ["steppe_helmet_green", "Cap Green", [("leather_cap", 0)], itp_type_head_armor | itp_fit_to_head, 0, 187, weight(
        1.25) | abundance(100) | head_armor(13) | body_armor(0) | leg_armor(0), imodbits_plate],  # cambiar chief
    ["steppe_helmet_yellow", "Cap Yellow", [("leather_cap", 0)], itp_type_head_armor | itp_fit_to_head, 0, 187, weight(
        1.25) | abundance(100) | head_armor(13) | body_armor(0) | leg_armor(0), imodbits_plate],  # cambiar chief
    ["tourney_helm_white", "Tourney Helm", [("Rathos_Spangenhelm_a", 0)], itp_type_head_armor | itp_fit_to_head, 0, 600, weight(
        2) | abundance(50) | head_armor(30) | body_armor(0) | leg_armor(0), imodbits_plate],  # cambiar chief
    ["tourney_helm_red", "Tourney Helm", [("Rathos_Spangenhelm_a", 0)], itp_type_head_armor | itp_fit_to_head, 0, 600, weight(
        2) | abundance(50) | head_armor(30) | body_armor(0) | leg_armor(0), imodbits_plate],  # cambiar chief
    ["tourney_helm_blue", "Tourney Helm", [("Rathos_Spangenhelm_a", 0)], itp_type_head_armor | itp_fit_to_head, 0, 600, weight(
        2) | abundance(50) | head_armor(30) | body_armor(0) | leg_armor(0), imodbits_plate],  # cambiar chief
    ["tourney_helm_green", "Tourney Helm", [("Rathos_Spangenhelm_a", 0)], itp_type_head_armor | itp_fit_to_head, 0, 600, weight(
        2) | abundance(50) | head_armor(30) | body_armor(0) | leg_armor(0), imodbits_plate],  # cambiar chief
    ["tourney_helm_yellow", "Tourney Helm", [("Rathos_Spangenhelm_a", 0)], itp_type_head_armor | itp_fit_to_head, 0, 600, weight(
        2) | abundance(50) | head_armor(30) | body_armor(0) | leg_armor(0), imodbits_plate],  # cambiar chief
    ["arena_turban_red", "Cap", [("skull_cap_new_c", 0)], itp_type_head_armor | itp_fit_to_head, 0, 187, weight(
        1.25) | abundance(100) | head_armor(3) | body_armor(0) | leg_armor(0), imodbits_plate],  # cambiar chief
    ["arena_turban_blue", "Cap", [("skull_cap_new_c", 0)], itp_type_head_armor | itp_fit_to_head, 0, 187, weight(
        1.25) | abundance(100) | head_armor(3) | body_armor(0) | leg_armor(0), imodbits_plate],  # cambiar chief
    ["arena_turban_green", "Cap", [("skull_cap_new_c", 0)], itp_type_head_armor | itp_fit_to_head, 0, 187, weight(
        1.25) | abundance(100) | head_armor(3) | body_armor(0) | leg_armor(0), imodbits_plate],  # cambiar chief
    ["arena_turban_yellow", "Cap", [("skull_cap_new_c", 0)], itp_type_head_armor | itp_fit_to_head, 0, 187, weight(
        1.25) | abundance(100) | head_armor(3) | body_armor(0) | leg_armor(0), imodbits_plate],  # cambiar chief
    ...
    ["book_tactics", "History of the Peloponnesian War", [
        ("book_a", 0)], itp_type_book, 0, 4000, weight(2) | abundance(100), imodbits_none],
    ["book_persuasion", "Rhetorica ad Herennium", [
     ("book_b", 0)], itp_type_book, 0, 5000, weight(2) | abundance(100), imodbits_none],
    ["book_leadership", "The Life of Alexander the Great", [("book_d", 0)], itp_type_book, 0, 4200, weight(
        2) | abundance(100), imodbits_none],  # cambiar chief
    ["book_intelligence", "Paedeia", [("book_e", 0)], itp_type_book, 0, 2900,
     weight(2) | abundance(100), imodbits_none],
    ["book_trade", "Oeconomica, of Aristoteles", [("book_f", 0)], itp_type_book,
        0, 3100, weight(2) | abundance(100), imodbits_none],
    ["book_weapon_mastery", "Polity of the Lacedaemonians, of Xenofonte", [
     ("book_d", 0)], itp_type_book, 0, 4200, weight(2) | abundance(100), imodbits_none],
    ["book_engineering", "De architectura, of Vitrivius", [
     ("book_open", 0)], itp_type_book, 0, 4000, weight(2) | abundance(100), imodbits_none],

    # Reference books
    # This book must be at the beginning of reference books
    ["book_wound_treatment_reference", "De Materia Medica, of Dioscorides", [
     ("book_c", 0)], itp_type_book, 0, 3500, weight(2) | abundance(100), imodbits_none],
    ["book_training_reference", "Epitoma Rei Militaris", [
     ("book_open", 0)], itp_type_book, 0, 3500, weight(2) | abundance(100), imodbits_none],
    ["book_surgery_reference", "Synopsis of Aelius Galenus", [
     ("book_c", 0)], itp_type_book, 0, 3500, weight(2) | abundance(100), imodbits_none],
    # chief cambiados libros acaba
    # puesto chief quest
    ["relic", "Vulgata Biblia", [("book_e", 0)], itp_type_book, 0, 5000,
     weight(2) | abundance(10), imodbits_none],
    # other trade goods (first one is spice)
    ["spice", "Spice", [("spice_sack", 0)], itp_merchandise | itp_type_goods | itp_consumable, 0, 780,
        weight(40) | abundance(10) | max_ammo(20), imodbits_none, [], jute_kingdoms],
    ["salt", "Salt", [("salt_sack", 0)], itp_merchandise | itp_type_goods, 0, 305, weight(50) | abundance(
     120), imodbits_none, [], [fac_kingdom_6, fac_kingdom_4, fac_kingdom_16, fac_kingdom_9, fac_kingdom_11]],
    ...
    # cambios chief
    ["oil", "Oil", [("oil", 0)], itp_merchandise | itp_type_goods | itp_consumable, 0, 650,
        weight(50) | abundance(10) | max_ammo(20), imodbits_none, [], [fac_kingdom_8]],

    ["pottery", "Pottery", [("jug", 0)], itp_merchandise | itp_type_goods, 0, 200, weight(50) | abundance(90), imodbits_none, [], [
     fac_kingdom_4, fac_kingdom_3, fac_kingdom_5, fac_kingdom_16, fac_kingdom_11, fac_kingdom_9, fac_kingdom_15, fac_kingdom_14]],

    ["raw_flax", "Flax Bundle", [("raw_flax", 0)], itp_merchandise | itp_type_goods, 0, 280, weight(40) | abundance(90), imodbits_none, [], [
     fac_kingdom_4, fac_kingdom_5, fac_kingdom_17, fac_kingdom_19, fac_kingdom_27, fac_kingdom_28, fac_kingdom_29, fac_kingdom_30, fac_kingdom_31]],
    ["linen", "Linen", [("linen", 0)], itp_merchandise | itp_type_goods, 0, 365, weight(40) | abundance(
     50), imodbits_none, [], [fac_kingdom_28, fac_kingdom_26, fac_kingdom_15, fac_kingdom_20]],

    ["wool", "Wool", [("wool_sack", 0)], itp_merchandise | itp_type_goods, 0, 230, weight(40) | abundance(90), imodbits_none, [
    ], [fac_kingdom_14], [fac_kingdom_15, fac_kingdom_12, fac_kingdom_13, fac_kingdom_18, fac_kingdom_20]],
    ["wool_cloth", "Wool Cloth", [("wool_cloth", 0)], itp_merchandise | itp_type_goods, 0, 300, weight(
     40) | abundance(90), imodbits_none, [], [fac_kingdom_12, fac_kingdom_13, fac_kingdom_18, fac_kingdom_20]],

    ["raw_silk", "Tile", [("raw_silk_bundle", 0)], itp_merchandise | itp_type_goods, 0, 1000, weight(30) | abundance(10), imodbits_none, [], [
        fac_kingdom_16, fac_kingdom_9, fac_kingdom_11, fac_kingdom_15, fac_kingdom_14, fac_kingdom_20, fac_kingdom_18, fac_kingdom_13, fac_kingdom_12]],
    ["raw_dyes", "Dyes", [("dyes", 0)], itp_merchandise | itp_type_goods, 0, 400, weight(10) | abundance(
     50), imodbits_none, [], [fac_kingdom_3, fac_kingdom_5, fac_kingdom_11, fac_kingdom_17, fac_kingdom_28, fac_kingdom_30]],
    ["velvet", "Fine Cloth", [("velvet", 0)], itp_merchandise | itp_type_goods, 0, 425,
        weight(40) | abundance(30), imodbits_none, [], saxon_kingdoms],

    ["iron", "Mineral", [("ore_iron", 0)], itp_merchandise | itp_type_goods, 0, 304, weight(60) | abundance(10), imodbits_none, [], [
        fac_kingdom_2, fac_kingdom_7, fac_kingdom_8, fac_kingdom_6, fac_kingdom_21, fac_kingdom_22, fac_kingdom_23, fac_kingdom_24, fac_kingdom_25, fac_kingdom_26, fac_kingdom_10]],
    ["stone", "Stone", [("iron_bar", 0)], itp_merchandise | itp_type_goods, 0, 104, weight(60) | abundance(10), imodbits_none, [], [
     fac_kingdom_27, fac_kingdom_28, fac_kingdom_29, fac_kingdom_30, fac_kingdom_31, fac_kingdom_17, fac_kingdom_6, fac_kingdom_7, fac_kingdom_8]],
    ["tools", "Tools", [("iron_hammer", 0)], itp_merchandise | itp_type_goods, 0, 410, weight(50) | abundance(90), imodbits_none, [], [
     fac_kingdom_2, fac_kingdom_4, fac_kingdom_5, fac_kingdom_19, fac_kingdom_22, fac_kingdom_23, fac_kingdom_24, fac_kingdom_26, fac_kingdom_9, fac_kingdom_11]],

    ["raw_leather", "Hides", [("leatherwork_inventory", 0)], itp_merchandise | itp_type_goods, 0, 320, weight(
     40) | abundance(90), imodbits_none, [], [fac_kingdom_12, fac_kingdom_13, fac_kingdom_18, fac_kingdom_20]],
    ["leatherwork", "Leatherwork", [("leatherwork_frame", 0)], itp_merchandise | itp_type_goods, 0, 400, weight(
     40) | abundance(90), imodbits_none, [], [fac_kingdom_13, fac_kingdom_18, fac_kingdom_20]],

    ["raw_date_fruit", "Silver", [("ore_silver", 0)], itp_merchandise | itp_type_goods, 0, 320, weight(60) | abundance(10), imodbits_none, [], [
     fac_kingdom_6], [fac_kingdom_7, fac_kingdom_8, fac_kingdom_21, fac_kingdom_22, fac_kingdom_23, fac_kingdom_24, fac_kingdom_25, fac_kingdom_26]],
    ["furs", "Furs", [("fur_pack", 0)], itp_merchandise | itp_type_goods, 0, 391, weight(
     40) | abundance(90), imodbits_none, [], [fac_kingdom_13, fac_kingdom_18, fac_kingdom_20]],

    ["wine", "Wine", [("amphora_slim", 0)], itp_merchandise | itp_type_goods | itp_consumable | itp_food, 0, 350, weight(
     30) | abundance(10) | food_quality(10) | max_ammo(40), imodbits_none, [], [fac_kingdom_1, fac_kingdom_8]],
    ["ale", "Beer", [("ale_barrel", 0)], itp_merchandise | itp_type_goods | itp_consumable | itp_food, 0, 280, weight(
     30) | abundance(10) | food_quality(30) | max_ammo(50), imodbits_none, [], [fac_kingdom_4, fac_kingdom_9]],
    ["mead", "Mead", [("ale_barrel", 0)], itp_merchandise | itp_type_goods | itp_consumable | itp_food, 0, 310, weight(30) | abundance(10) | food_quality(30) | max_ammo(
     50), imodbits_none, [], [fac_kingdom_11, fac_kingdom_9, fac_kingdom_21, fac_kingdom_22, fac_kingdom_26, fac_kingdom_23, fac_kingdom_25, fac_kingdom_24, fac_kingdom_10]],
    ...
    ["smoked_fish", "Smoked Fish", [("smoked_fish", 0)], itp_merchandise | itp_type_goods | itp_consumable | itp_food, 0, 90, weight(
     15) | abundance(110) | food_quality(50) | max_ammo(150), imodbits_none],
    ["cheese", "Cheese", [("cheese_b", 0)], itp_merchandise | itp_type_goods | itp_consumable |
        itp_food, 0, 85, weight(6) | abundance(110) | food_quality(40) | max_ammo(90), imodbits_none],
    ["honey", "Honey", [("honey_pot", 0)], itp_merchandise | itp_type_goods | itp_consumable | itp_food,
        0, 220, weight(5) | abundance(90) | food_quality(40) | max_ammo(90), imodbits_none],
    ["sausages", "Sausages", [("sausages", 0)], itp_merchandise | itp_type_goods | itp_consumable |
        itp_food, 0, 35, weight(10) | abundance(110) | food_quality(40) | max_ammo(120), imodbits_none],
    ["cabbages", "Cabbages", [("cabbage", 0)], itp_merchandise | itp_type_goods | itp_consumable | itp_food, 0, 40, weight(
     15) | abundance(110) | food_quality(40) | max_ammo(150), imodbits_none],
    ["dried_meat", "Dried Meat", [("smoked_meat", 0)], itp_merchandise | itp_type_goods | itp_consumable |
        itp_food, 0, 150, weight(15) | abundance(100) | food_quality(70) | max_ammo(150), imodbits_none],
    ["apples", "Fruit", [("apple_basket", 0)], itp_merchandise | itp_type_goods | itp_consumable |
        itp_food, 0, 40, weight(20) | abundance(110) | food_quality(40) | max_ammo(150), imodbits_none],
    ["raw_grapes", "Grapes", [("grapes_inventory", 0)], itp_merchandise | itp_consumable | itp_type_goods, 0, 75, weight(
     40) | abundance(60) | food_quality(10) | max_ammo(30), imodbits_none],  # x2 for wine
    ["raw_olives", "Olives", [("olive_inventory", 0)], itp_merchandise | itp_consumable | itp_type_goods, 0, 150, weight(
     40) | abundance(60) | food_quality(10) | max_ammo(30), imodbits_none],  # x3 for oil
    ["grain", "Grain", [("wheat_sack", 0)], itp_merchandise | itp_type_goods | itp_consumable, 0, 20,
        weight(30) | abundance(110) | food_quality(40) | max_ammo(150), imodbits_none],

    ["cattle_meat", "Beef", [("raw_meat", 0)], itp_merchandise | itp_type_goods | itp_consumable | itp_food, 0, 120, weight(
     20) | abundance(100) | food_quality(80) | max_ammo(150), imodbits_none],
    ["bread", "Bread", [("bread_a", 0)], itp_merchandise | itp_type_goods | itp_consumable | itp_food,
        0, 20, weight(30) | abundance(110) | food_quality(40) | max_ammo(150), imodbits_none],
    ["chicken", "Chicken", [("chicken", 0)], itp_merchandise | itp_type_goods | itp_consumable |
        itp_food, 0, 65, weight(10) | abundance(110) | food_quality(40) | max_ammo(150), imodbits_none],
    ["pork", "Pork", [("pork", 0)], itp_merchandise | itp_type_goods | itp_consumable | itp_food, 0, 89,
        weight(15) | abundance(100) | food_quality(70) | max_ammo(150), imodbits_none],
    ["butter", "Butter", [("butter_pot", 0)], itp_merchandise | itp_type_goods | itp_consumable |
        itp_food, 0, 100, weight(6) | abundance(110) | food_quality(40) | max_ammo(90), imodbits_none],

    #-#-#-#-#-#-#-#-#-#-#-#-#-#-#
    #-#-#-#Hunting chief Mod begin#-#-#-#
    #-#-#-#-#-#-#-#-#-#-#-#-#-#-#
    ["deer_meat", "Venison", [("raw_meat", 0)], itp_merchandise | itp_type_goods | itp_consumable |
        itp_food, 0, 150, weight(30) | abundance(100) | food_quality(40) | max_ammo(30), imodbits_none],
    ["boar_meat", "Boar Meat", [("raw_meat", 0)], itp_merchandise | itp_type_goods | itp_consumable |
        itp_food, 0, 160, weight(30) | abundance(100) | food_quality(80) | max_ammo(50), imodbits_none],
    ["wolf_meat", "Wolf Meat", [("raw_meat", 0)], itp_merchandise | itp_type_goods | itp_consumable |
        itp_food, 0, 30, weight(30) | abundance(100) | food_quality(30) | max_ammo(50), imodbits_none],
    ["coat_meat", "Goat Meat", [("raw_meat", 0)], itp_merchandise | itp_type_goods | itp_consumable |
        itp_food, 0, 50, weight(30) | abundance(100) | food_quality(30) | max_ammo(50), imodbits_none],
    ["coat_2_meat", "Goat Meat", [("raw_meat", 0)], itp_merchandise | itp_type_goods | itp_consumable | itp_food, 0, 50, weight(
     30) | abundance(100) | food_quality(30) | max_ammo(50), imodbits_none],
    ["wilddonkey_meat", "Wild Donkey Meat", [("raw_meat", 0)], itp_merchandise | itp_type_goods | itp_consumable | itp_food, 0, 250, weight(
     30) | abundance(100) | food_quality(30) | max_ammo(50), imodbits_none],
    #-#-#-#-#-#-#-#-#-#-#-#-#-#-#
    ...
    [
        "siege_supply", "Supplies", [("ale_barrel", 0)],
        itp_type_goods, 0, 96, weight(40) | abundance(70), imodbits_none
    ],

    [
        "quest_wine", "Wine", [("amphora_slim", 0)],
        itp_type_goods, 0, 46, weight(40) | abundance(60) | max_ammo(50), imodbits_none
    ],

    [
        "quest_ale", "Ale", [("ale_barrel", 0)],
        itp_type_goods, 0, 31, weight(40) | abundance(70) | max_ammo(50), imodbits_none
    ],
    ...
    [
        "tutorial_sword", "Sword", [("long_sword", 0), ("scab_longsw_a", ixmesh_carry)],
        itp_type_one_handed_wpn | itp_primary, itc_longsword | itcf_carry_sword_left_hip | itcf_show_holster_when_drawn,
        0, weight(1.5) | spd_rtng(100) | weapon_length(102) | swing_damage(18, cut) | thrust_damage(15,  pierce),
        imodbits_sword
    ],

    [
        "tutorial_axe", "Axe", [("iron_ax", 0)],
        itp_type_two_handed_wpn | itp_two_handed | itp_primary | itp_bonus_against_shield | itp_wooden_parry,
        itc_nodachi | itcf_carry_axe_back, 0,
        weight(4) | spd_rtng(91) | weapon_length(108) | swing_damage(19, cut) | thrust_damage(0,  pierce),
        imodbits_axe
    ],
    ...
    [
        "tutorial_arrows", "Arrows", [("arrow", 0), ("flying_arrow", ixmesh_flying_ammo), ("quiver", ixmesh_carry)],
        itp_type_arrows, itcf_carry_quiver_back, 0,
        weight(3) | abundance(160) | weapon_length(95) | thrust_damage(0, pierce) | max_ammo(20),
        imodbits_missile, missile_distance_trigger
    ],

    [
        "tutorial_bolts", "Bolts",
        [
            ("bolt", 0),
        ...
        itp_type_bolts, itcf_carry_quiver_right_vertical, 0,
        weight(2.25) | abundance(90) | weapon_length(63) | thrust_damage(0, pierce) | max_ammo(18),
        imodbits_missile, missile_distance_trigger
    ],

    [
        "tutorial_short_bow", "Short Bow",
        [
            ("short_bow", 0),
            ("short_bow_carry", ixmesh_carry)],
        itp_type_bow | itp_primary | itp_two_handed, itcf_shoot_bow | itcf_carry_bow_back, 0,
        weight(1) | spd_rtng(98) | shoot_speed(49) | thrust_damage(12,  pierce),
        imodbits_bow
    ],

    [
        "tutorial_crossbow", "Crossbow", [("crossbow_a", 0)],
        itp_type_crossbow | itp_primary | itp_two_handed | itp_cant_reload_on_horseback, itcf_shoot_crossbow |
        itcf_carry_crossbow_back, 0, weight(3) | spd_rtng(42) | shoot_speed(68) | thrust_damage(32, pierce) | max_ammo(1), imodbits_crossbow],
    ...
    [
        "tutorial_staff", "Staff", [("wooden_staff", 0)],
        itp_type_polearm | itp_offset_lance | itp_primary | itp_penalty_with_shield | itp_wooden_parry |
        itp_wooden_attack, itc_staff | itcf_carry_sword_back, 9,
        weight(3.5) | spd_rtng(120) | weapon_length(115) | swing_damage(16, blunt) | thrust_damage(16, blunt),
        imodbits_none
    ],
    ...
    [
        ...
        horse_maneuver(36) | horse_charge(9) | horse_scale(86),
    ...
    *all_horses,
    ...
    [
        ...
        abundance(80) | hit_points(55) | body_armor(7) | horse_speed(32) |
        horse_maneuver(33) | horse_charge(8) | horse_scale(79),
        imodbits_horse_basic
    ],
    ...
    [
        ...
        abundance(70) | hit_points(65) | body_armor(10) | horse_speed(35) |
        horse_maneuver(35) | horse_charge(8) | horse_scale(86),
        imodbits_horse_basic
    ],
    ...
    [
        ...
        weight(1.25) | abundance(100) | head_armor(4) | body_armor(0) | leg_armor(0),
        imodbits_cloth
    ],  # cambiado chief
    ...
    [
        ...
        weight(0.25) | abundance(120) | body_armor(10),
        imodbits_cloth
    ],
    ...
    [
        ...
        weight(1.5) | abundance(10) | body_armor(20),
        imodbits_armor
    ],
    ...
    *all_light_helments,
    ...
    ["helm_captaina", "Leather Cap With Plum", [("helm_captainA", 0)], itp_merchandise | itp_type_head_armor | itp_fit_to_head, 0, 280, weight(
        1) | abundance(60) | head_armor(20) | body_armor(0) | leg_armor(0) | difficulty(4), imodbits_cloth],
    ["leather_cap", "Leather Cap", [("leather_cap_a_new_bry", 0)], itp_merchandise | itp_type_head_armor | itp_civilian, 0, 170, weight(
        0.5) | abundance(90) | head_armor(15) | body_armor(0) | leg_armor(0), imodbits_cloth],  # moficiado chief
    ["skull_cap_new_c", "Leather Cap", [("skull_cap_new_c", 0)], itp_merchandise | itp_type_head_armor | itp_fit_to_head, 0, 200, weight(
        1) | abundance(80) | head_armor(20) | body_armor(0) | leg_armor(0), imodbits_cloth],
    ["leather_warrior_cap", "Straw Hat", [("straw_hat_new_bry", 0)], itp_merchandise | itp_type_head_armor | itp_civilian, 0, 90, weight(
        1) | abundance(80) | head_armor(10) | body_armor(0) | leg_armor(0), imodbits_cloth],  # cambiado chief
    ["leather_steppe_cap_b", "Reinforced Skullcap", [("skull_cap_new_a_bry", 0)], itp_merchandise | itp_type_head_armor | itp_civilian, 0, 200, weight(
        1) | abundance(80) | head_armor(20) | body_armor(0) | leg_armor(0), imodbits_cloth],  # cambiado chief
    ["leather_steppe_cap_c", "Skullcap", [("skull_cap_new_b_bry", 0)], itp_merchandise | itp_type_head_armor | itp_civilian, 0, 190, weight(
        1) | abundance(80) | head_armor(18) | body_armor(0) | leg_armor(0), imodbits_cloth],  # cambiado chief


    #Coronas, solo reyes finales ####
    #################################
    # sajones
    ["sib_lombardy", "Crown", [("sib_Lombardy", 0)], itp_type_head_armor | itp_unique | itp_civilian | itp_doesnt_cover_hair, 0, 5000, weight(
        2) | head_armor(14) | body_armor(0) | leg_armor(0), imodbits_cloth],
    # britones#Pictos#Irish
    ["sib_couronne", "Crown", [("sib_couronne", 0)], itp_type_head_armor | itp_unique | itp_civilian | itp_doesnt_cover_hair, 0, 5000, weight(
        2) | head_armor(14) | body_armor(0) | leg_armor(0), imodbits_cloth],
    # coronas finales#############3
    ##########################
    ...
    # TODOS
    # tropas elite
    ["norman_helmet", "Leather Helmet with Plum", [("rath_spangenlord3", 0)], itp_merchandise | itp_type_head_armor | itp_fit_to_head, 0, 780, weight(
        1.75) | abundance(40) | head_armor(33) | body_armor(0) | leg_armor(0) | difficulty(6), imodbits_plate],  # cambiado chief
    ["sarranid_helmet1", "North Helmet", [("rath_spangenlord2", 0)], itp_merchandise | itp_type_head_armor | itp_fit_to_head, 0, 780, weight(
        1.75) | abundance(40) | head_armor(33) | body_armor(0) | leg_armor(0) | difficulty(6), imodbits_plate],  # cambiado chief
    ["rath_spangenlord5", "Helmet with Plum", [("rath_spangenlord5", 0)], itp_merchandise | itp_type_head_armor | itp_fit_to_head, 0, 860, weight(
        1.75) | abundance(20) | head_armor(35) | body_armor(0) | leg_armor(0) | difficulty(6), imodbits_plate],  # cambiado chief
    ["rathos_bowl_helmet", "Bowl Helmet with leather neckguard", [("Rathos_bowl_helmet", 0)], itp_merchandise | itp_type_head_armor | itp_fit_to_head, 0, 540, weight(
        1.5) | abundance(80) | head_armor(26) | body_armor(0) | leg_armor(0) | difficulty(3), imodbits_plate],
    ["bowl_helmet_nasal", "Bowl Helmet with Nasal", [("bowl_helmet_nasal", 0)], itp_merchandise | itp_type_head_armor | itp_fit_to_head, 0, 560, weight(
        1.5) | abundance(80) | head_armor(27) | body_armor(0) | leg_armor(0) | difficulty(3), imodbits_plate],
    ["spangenhelm_a", "Brythonic Helmet", [("spangenhelm_a", 0)], itp_merchandise | itp_type_head_armor | itp_fit_to_head, 0, 830, weight(
        1.75) | abundance(40) | head_armor(36) | body_armor(0) | leg_armor(0) | difficulty(6), imodbits_plate],  # cambiado chief
    ["spangenhelm_a_trim", "Germanic Helmet", [("spangenhelm_a_trim", 0)], itp_merchandise | itp_type_head_armor | itp_fit_to_head, 0, 830, weight(
        1.75) | abundance(40) | head_armor(36) | body_armor(0) | leg_armor(0) | difficulty(6), imodbits_plate],  # cambiado chief
    # este da problemas con los lods, puede causar fallos vigilar
    ["khergit_cavalry_helmet", "Cavalry Helmet", [("romanspangenhelm", 0)], itp_merchandise | itp_type_head_armor | itp_fit_to_head, 0, 810, weight(
        1.75) | abundance(40) | head_armor(35) | body_armor(0) | leg_armor(0) | difficulty(6), imodbits_plate],  # cambiado chief
    # este da problemas con los lods, puede causar fallos vigilar
    ["bowl_helmet", "Bowl Helmet", [("bowl_helmet", 0)], itp_merchandise | itp_type_head_armor | itp_fit_to_head, 0, 520, weight(
        1.5) | abundance(80) | head_armor(25) | body_armor(0) | leg_armor(0) | difficulty(3), imodbits_plate],

    # spangenhelmet como el encontrado en hungria del siglo IV
    ["arming_cap", "Basic Late Roman Helmet", [("old_spangenhelm", 0)], itp_merchandise | itp_type_head_armor | itp_fit_to_head, 0, 520, weight(
        1.5) | abundance(80) | head_armor(25) | body_armor(0) | leg_armor(0) | difficulty(3), imodbits_plate],
    ["padded_coif", "Late Roman Helmet", [("old_spangenhelmcheek", 0)], itp_merchandise | itp_type_head_armor | itp_fit_to_head, 0, 700, weight(
        1.5) | abundance(60) | head_armor(33) | body_armor(0) | leg_armor(0) | difficulty(4), imodbits_plate],  # cambiado chief
    ["steppe_cap", "Elite Late Roman Helmet", [("old_spangenhelmaven", 0)], itp_merchandise | itp_type_head_armor | itp_fit_to_head, 0, 810, weight(
        1.75) | abundance(20) | head_armor(35) | body_armor(0) | leg_armor(0) | difficulty(6), imodbits_plate],  # cambiado chief

    # nobles
    ["spangenhelm_a_ornate", "Nobleman Helmet with plum", [("spangenhelm_a_ornate", 0)], itp_type_head_armor | itp_fit_to_head, 0, 940, weight(
        1.75) | abundance(10) | head_armor(38) | body_armor(0) | leg_armor(0) | difficulty(6), imodbits_plate],  # cambiado chief
    ...
    # Rey Briton
    ["dux_ridge_helm_gold", "Dux Helm Gold", [("dux_ridge_helm_gold", 0)], itp_type_head_armor | itp_fit_to_head, 0, 1580, weight(
        2) | abundance(10) | head_armor(50) | body_armor(0) | leg_armor(0) | difficulty(12), imodbits_plate],
    ...
    ["vendel14_3", "King Jute Helmet", [("vendel14_3", 0)], itp_type_head_armor | itp_fit_to_head, 0, 1280, weight(1.5) | abundance(10) | head_armor(50) | body_armor(0) | leg_armor(0) | difficulty(9), imodbits_plate,
     [], jute_kingdoms],
    # Rey anglo
    ["talak_sutton_hoo", "Saxon Prince Helmet", [("talak_sutton_hoo", 0)], itp_type_head_armor | itp_fit_to_head, 0, 1320, weight(
        2.5) | abundance(10) | head_armor(51) | body_armor(0) | leg_armor(0) | difficulty(10), imodbits_plate],
    # rey sajon o juto, o dena pirate
    ["valsgarde_new", "Scandza Helmet", [("valsgarde_new", 0)], itp_type_head_armor | itp_fit_to_head | itp_covers_head, 0, 1400, weight(
        3) | abundance(10) | head_armor(52) | body_armor(0) | leg_armor(0) | difficulty(14), imodbits_plate],
    ...
    ["footman_helmet", "Dena Helmet", [("BL_01_Valsgarde02", 0)], itp_merchandise | itp_type_head_armor | itp_fit_to_head, 0, 850, weight(2) | abundance(30) | head_armor(34) | body_armor(0) | leg_armor(0) | difficulty(7), imodbits_plate,
     [], saxon_kingdoms_plus_east_angle],
    ...
    ["sarranid_horseman_helmet", "No head", [("no_head", 0)], itp_type_head_armor | itp_fit_to_head | itp_covers_head, 0, 180, weight(
        2) | abundance(100) | head_armor(25) | body_armor(0) | leg_armor(0), imodbits_plate],
    ...
    ["wooden_stick",         "Wooden Stick", [("wooden_stick", 0)], itp_type_one_handed_wpn | itp_primary | itp_secondary | itp_wooden_parry | itp_wooden_attack, itc_scimitar,
     2, weight(2) | spd_rtng(82) | weapon_length(80) | swing_damage(16, blunt) | thrust_damage(0,  pierce), imodbits_none],  # chief cambiado
    ...
    ["cudgel",         "Wooden Club", [("palka", 0)], itp_type_one_handed_wpn | itp_can_knock_down | itp_merchandise | itp_primary | itp_secondary | itp_wooden_parry | itp_wooden_attack, itc_scimitar,
     100, weight(2) | spd_rtng(87) | weapon_length(65) | swing_damage(20, blunt) | thrust_damage(0,  pierce), imodbits_none],  # chief cambiado
    ...
    ["spiked_club",         "Spiked Club", [("spiked_club", 0)], itp_type_one_handed_wpn | itp_can_knock_down | itp_merchandise | itp_primary | itp_secondary | itp_wooden_parry, itc_scimitar | itcf_carry_mace_left_hip,
     130, weight(3) | spd_rtng(77) | weapon_length(85) | swing_damage(22, pierce) | thrust_damage(0,  pierce), imodbits_none],  # cambiado chief
    ["sickle",         "Sickle", [("sickle", 0)], itp_type_one_handed_wpn | itp_merchandise | itp_primary | itp_secondary | itp_no_parry | itp_wooden_parry, itc_cleaver,
     100, weight(1.5) | spd_rtng(86) | weapon_length(40) | swing_damage(15, cut) | thrust_damage(0,  pierce), imodbits_none],
    # no filo
    ##############################
    ...
    ["knife",         "Knife", [("peasant_knife", 0)], itp_type_one_handed_wpn | itp_merchandise | itp_primary | itp_secondary | itp_no_parry, itc_dagger | itcf_carry_dagger_front_left,
     205, weight(0.5) | spd_rtng(97) | weapon_length(30) | swing_damage(16, cut) | thrust_damage(16,  pierce), imodbits_sword],  # cambiado chief
    ["butchering_knife", "Butchering Knife", [("khyber_knife", 0)], itp_type_one_handed_wpn | itp_primary | itp_secondary | itp_no_parry, itc_dagger | itcf_carry_dagger_front_right,
     185, weight(0.75) | spd_rtng(82) | weapon_length(40) | swing_damage(19, cut) | thrust_damage(9,  pierce), imodbits_sword],  # chief cambiado

    # todos
    ["hunting_dagger",         "Hunting Seax", [("hunting_dagger", 0), ("seaxsheath", ixmesh_carry)], itp_type_one_handed_wpn | itp_merchandise | itp_primary | itp_secondary | itp_no_parry, itc_dagger |
     itcf_carry_dagger_front_right | itcf_show_holster_when_drawn, 280, weight(0.5) | spd_rtng(97) | weapon_length(60) | swing_damage(17, cut) | thrust_damage(17,  pierce), imodbits_sword],
    ["nordic_sword", "Simple Lang Knife", [("simple_langseax", 0), ("simple_langseax_scab", ixmesh_carry)], itp_type_one_handed_wpn | itp_merchandise | itp_primary | itp_secondary | itp_no_parry, itc_dagger |
     itcf_carry_dagger_front_right | itcf_show_holster_when_drawn, 270, weight(0.5) | spd_rtng(92) | weapon_length(65) | swing_damage(14, cut) | thrust_damage(19,  pierce), imodbits_sword],
    ["broadsword",         "Simple Knife", [("simple_seax", 0), ("simple_seax_scab", ixmesh_carry)], itp_type_one_handed_wpn | itp_merchandise | itp_primary | itp_secondary | itp_no_parry, itc_dagger |
     itcf_carry_dagger_front_right | itcf_show_holster_when_drawn, 270, weight(0.5) | spd_rtng(92) | weapon_length(65) | swing_damage(14, cut) | thrust_damage(19,  pierce), imodbits_sword],
    # irlandeses y pictos
    ...
    ["talak_seax", "Light Seax", [("vikingr_seax", 0), ("vikingr_seax_scab", ixmesh_carry)], itp_type_one_handed_wpn | itp_merchandise | itp_primary | itp_secondary | itp_no_parry, itc_dagger | itcf_carry_dagger_front_right | itcf_show_holster_when_drawn, 280, weight(0.5) | spd_rtng(92) | weapon_length(65) | swing_damage(14, cut) | thrust_damage(19,  pierce), imodbits_sword,
     [], angle_saxon_kingdoms],
    ["had_seax", "Saxon Seax", [("saxon_seax", 0), ("saxon_seax_scab", ixmesh_carry)], itp_type_one_handed_wpn | itp_merchandise | itp_primary | itp_secondary | itp_no_parry, itc_dagger | itcf_carry_dagger_front_right | itcf_show_holster_when_drawn, 280, weight(0.5) | spd_rtng(92) | weapon_length(65) | swing_damage(14, cut) | thrust_damage(19,  pierce), imodbits_sword,
     [], angle_saxon_kingdoms],
    ["langseax", "Lang Seax", [("langseax", 0), ("langseax_scab", ixmesh_carry)], itp_type_one_handed_wpn | itp_merchandise | itp_primary | itp_secondary | itp_no_parry, itc_dagger | itcf_carry_dagger_front_right | itcf_show_holster_when_drawn, 350, weight(0.5) | spd_rtng(88) | weapon_length(82) | swing_damage(17, cut) | thrust_damage(17,  pierce), imodbits_sword,
     [], angle_saxon_kingdoms],
    ["ornate_seax", "Ornate Seax", [("ornate_seax", 0), ("ornate_seax_scab", ixmesh_carry)], itp_type_one_handed_wpn | itp_merchandise | itp_primary | itp_secondary | itp_no_parry, itc_dagger | itcf_carry_dagger_front_right | itcf_show_holster_when_drawn, 280, weight(0.5) | spd_rtng(92) | weapon_length(65) | swing_damage(14, cut) | thrust_damage(19,  pierce), imodbits_sword,
     [], angle_saxon_kingdoms],
    ["dagger",         "Seax", [("seax", 0), ("seax", ixmesh_carry), ("seax", imodbits_good), ("dagger_b_scabbard", ixmesh_carry | imodbits_good)], itp_type_one_handed_wpn | itp_merchandise | itp_primary | itp_secondary | itp_no_parry, itc_dagger | itcf_carry_dagger_front_right | itcf_show_holster_when_drawn, 80, weight(0.5) | spd_rtng(92) | weapon_length(65) | swing_damage(14, cut) | thrust_damage(19,  pierce), imodbits_sword,
     [], angle_saxon_kingdoms],
    ["falchion",         "Cleaver Seax", [("cleaver_seax", 0), ("cleaver_seax_scab", ixmesh_carry)], itp_type_one_handed_wpn | itp_merchandise | itp_primary | itp_secondary | itp_no_parry, itc_dagger | itcf_carry_dagger_front_right | itcf_show_holster_when_drawn, 280, weight(0.5) | spd_rtng(92) | weapon_length(65) | swing_damage(14, cut) | thrust_damage(19,  pierce), imodbits_sword,
     [], angle_saxon_kingdoms],
    ["scimitar",         "Seax", [("seax_hp_tri", 0), ("seaxsheath", ixmesh_carry)], itp_type_one_handed_wpn | itp_merchandise | itp_primary | itp_secondary | itp_no_parry, itc_dagger | itcf_carry_dagger_front_right | itcf_show_holster_when_drawn, 280, weight(0.5) | spd_rtng(92) | weapon_length(65) | swing_damage(14, cut) | thrust_damage(19,  pierce), imodbits_sword,
     [], angle_saxon_kingdoms],
    ...
    ["spatha", "Spatha", [("pattern_spatha", 0), ("roman_cav_sword_2_scabbard", ixmesh_carry)], itp_merchandise | itp_type_one_handed_wpn | itp_merchandise | itp_primary, itc_longsword |
     itcf_carry_sword_left_hip | itcf_show_holster_when_drawn, 900, weight(1.25) | difficulty(8) | spd_rtng(82) | weapon_length(95) | swing_damage(33, cut) | thrust_damage(14,  pierce), imodbits_sword_high],
    # otras basicas
    # scab problem
    ["le_pictishsword2", "Rich Spatha", [("le_pictishsword2", 0), ("scab_vikingsw", ixmesh_carry)], itp_merchandise | itp_type_one_handed_wpn | itp_merchandise | itp_primary, itc_longsword | itcf_carry_sword_left_hip |
    ...
    ["bl_sword01_01", "Sword", [("BL_Sword01_01", 0), ("BL_Sword01_01", ixmesh_carry)], itp_merchandise | itp_type_one_handed_wpn | itp_merchandise | itp_primary, itc_longsword |
     itcf_carry_sword_left_hip, 1000, weight(1.25) | difficulty(8) | spd_rtng(82) | weapon_length(95) | swing_damage(33, cut) | thrust_damage(17,  pierce), imodbits_sword_high],
    ["bl_sword01_02", "Sword", [("BL_Sword01_02", 0), ("BL_Sword01_02", ixmesh_carry)], itp_merchandise | itp_type_one_handed_wpn | itp_merchandise | itp_primary, itc_longsword |
     itcf_carry_sword_left_hip, 1000, weight(1.25) | difficulty(8) | spd_rtng(82) | weapon_length(95) | swing_damage(33, cut) | thrust_damage(17,  pierce), imodbits_sword_high],
    ["new_sword1", "Sword", [("Sword1", 0), ("Sword1", ixmesh_carry)], itp_merchandise | itp_type_one_handed_wpn | itp_merchandise | itp_primary, itc_longsword |
     itcf_carry_sword_left_hip, 1000, weight(1.25) | difficulty(8) | spd_rtng(82) | weapon_length(95) | swing_damage(33, cut) | thrust_damage(17,  pierce), imodbits_sword_high],
    ["new_sword2", "Sword", [("Sword2", 0), ("Sword2", ixmesh_carry)], itp_merchandise | itp_type_one_handed_wpn | itp_merchandise | itp_primary, itc_longsword |
     itcf_carry_sword_left_hip, 1000, weight(1.25) | difficulty(8) | spd_rtng(82) | weapon_length(95) | swing_damage(33, cut) | thrust_damage(17,  pierce), imodbits_sword_high],
    ["bl_sword01_03", "Sword", [("BL_Sword01_03", 0), ("BL_Sword01_03", ixmesh_carry)], itp_merchandise | itp_type_one_handed_wpn | itp_merchandise | itp_primary, itc_longsword |
     itcf_carry_sword_left_hip, 1000, weight(1.25) | difficulty(8) | spd_rtng(82) | weapon_length(95) | swing_damage(33, cut) | thrust_damage(17,  pierce), imodbits_sword_high],
    # scba problem acaba
    ["le_bamburghsword", "Sword", [("le_bamburghsword", 0), ("sword_medieval_b_scabbard2", ixmesh_carry)], itp_merchandise | itp_type_one_handed_wpn | itp_merchandise | itp_primary, itc_longsword |
     itcf_carry_sword_left_hip | itcf_show_holster_when_drawn, 950, weight(1.25) | difficulty(8) | spd_rtng(82) | weapon_length(95) | swing_damage(35, cut) | thrust_damage(13,  pierce), imodbits_sword_high],
    ["bamburghsword2", "Sword", [("BamburghSword2", 0), ("sword_medieval_b_scabbard2", ixmesh_carry)], itp_merchandise | itp_type_one_handed_wpn | itp_merchandise | itp_primary, itc_longsword |
     itcf_carry_sword_left_hip | itcf_show_holster_when_drawn, 950, weight(1.25) | difficulty(8) | spd_rtng(82) | weapon_length(95) | swing_damage(35, cut) | thrust_damage(13,  pierce), imodbits_sword_high],
    ...
    ["new_sword3", "Angle Sword", [("Sword3", 0), ("RichSword3_scab", ixmesh_carry)], itp_type_one_handed_wpn | itp_merchandise | itp_primary, itc_longsword | itcf_carry_sword_left_hip | itcf_show_holster_when_drawn, 1020, weight(1.25) | difficulty(9) | spd_rtng(81) | weapon_length(90) | swing_damage(35, cut) | thrust_damage(14,  pierce), imodbits_sword_high,
     [], angle_saxon_kingdoms],
    ["le_pictishsword3", "Rich Saxon Sword", [("le_pictishsword3", 0), ("Scab_Pict_Sword", ixmesh_carry)], itp_merchandise | itp_type_one_handed_wpn | itp_merchandise | itp_primary, itc_longsword |
     itcf_carry_sword_left_hip | itcf_show_holster_when_drawn, 1200, weight(1.25) | difficulty(9) | spd_rtng(83) | weapon_length(95) | swing_damage(36, cut) | thrust_damage(15,  pierce), imodbits_sword_high],
    ...
    ["sword_of_war", "Widow Maker", [("le_pictishsword7", 0), ("RichSpatha_scab", ixmesh_carry)], itp_type_one_handed_wpn | itp_primary | itp_secondary | itp_next_item_as_melee, itc_longsword |
     itcf_carry_sword_left_hip | itcf_show_holster_when_drawn, 2500, weight(1.25) | difficulty(12) | spd_rtng(85) | weapon_length(95) | swing_damage(34, cut) | thrust_damage(16,  pierce), imodbits_sword_high],
    ...
    ["arabian_sword_d",         "Ri Petroc's Sword", [("BL_Sword01_01", 0), ("RichSword3_scab", ixmesh_carry)], itp_type_one_handed_wpn | itp_primary, itc_longsword | itcf_carry_sword_left_hip |
     itcf_show_holster_when_drawn, 1600, weight(1.25) | difficulty(9) | spd_rtng(85) | weapon_length(95) | swing_damage(35, cut) | thrust_damage(17,  pierce), imodbits_sword_high],

    ["nomad_sabre",         "Ri Allech's Sword", [("BL_Sword01_02", 0), ("RichSword3_scab", ixmesh_carry)], itp_type_one_handed_wpn | itp_primary, itc_longsword | itcf_carry_sword_left_hip |
     itcf_show_holster_when_drawn, 1600, weight(1.25) | difficulty(9) | spd_rtng(85) | weapon_length(95) | swing_damage(35, cut) | thrust_damage(17,  pierce), imodbits_sword_high],

    # espada del rey de kent
    ["scimitar_b",         "Cyning Eadbald's Sword", [("ValsSword1", 0), ("ValsSword1_scab", ixmesh_carry)], itp_type_one_handed_wpn | itp_primary | itp_secondary | itp_next_item_as_melee, itc_longsword |
     itcf_carry_sword_left_hip | itcf_show_holster_when_drawn, 2500, weight(1.25) | difficulty(12) | spd_rtng(85) | weapon_length(95) | swing_damage(34, cut) | thrust_damage(16,  pierce), imodbits_sword_high],
    ...
    #
    ["arabian_sword_a",         "Cyning Cynegils's Sword", [("RichSpatha", 0), ("RichSpatha_scab", ixmesh_carry)], itp_type_one_handed_wpn | itp_primary | itp_secondary | itp_next_item_as_melee, itc_longsword |
     itcf_carry_sword_left_hip | itcf_show_holster_when_drawn, 2500, weight(1.25) | difficulty(12) | spd_rtng(85) | weapon_length(95) | swing_damage(34, cut) | thrust_damage(16,  pierce), imodbits_sword_high],
    ...
    ["bastard_sword_a",         "Ri Cynddylan's Sword", [("RichSpatha", 0), ("RichSpatha_scab", ixmesh_carry)], itp_type_one_handed_wpn | itp_primary | itp_secondary | itp_next_item_as_melee, itc_longsword |
     itcf_carry_sword_left_hip | itcf_show_holster_when_drawn, 2500, weight(1.25) | difficulty(12) | spd_rtng(85) | weapon_length(95) | swing_damage(34, cut) | thrust_damage(16,  pierce), imodbits_sword_high],
    ...
    ["sword_medieval_a",         "Ri Nowy's Sword", [("BL_Sword01_01", 0), ("RichSword3_scab", ixmesh_carry)], itp_type_one_handed_wpn | itp_primary, itc_longsword | itcf_carry_sword_left_hip |
     itcf_show_holster_when_drawn, 1600, weight(1.25) | difficulty(9) | spd_rtng(85) | weapon_length(95) | swing_damage(35, cut) | thrust_damage(17,  pierce), imodbits_sword_high],
    ["sword_medieval_b",         "Ri Rhiwallon's Sword", [("BL_Sword01_01", 0), ("RichSword3_scab", ixmesh_carry)], itp_type_one_handed_wpn | itp_primary, itc_longsword | itcf_carry_sword_left_hip |
     itcf_show_holster_when_drawn, 1600, weight(1.25) | difficulty(9) | spd_rtng(85) | weapon_length(95) | swing_damage(35, cut) | thrust_damage(17,  pierce), imodbits_sword_high],
    ["sword_medieval_c",         "Decapitator", [("BL_Sword01_01", 0), ("RichSword3_scab", ixmesh_carry)], itp_type_one_handed_wpn | itp_primary, itc_longsword | itcf_carry_sword_left_hip |
     itcf_show_holster_when_drawn, 1600, weight(1.25) | difficulty(9) | spd_rtng(85) | weapon_length(95) | swing_damage(35, cut) | thrust_damage(17,  pierce), imodbits_sword_high],
    ["sword_medieval_c_long",         "Archangel", [("BL_Sword01_01", 0), ("RichSword3_scab", ixmesh_carry)], itp_type_one_handed_wpn | itp_primary, itc_longsword | itcf_carry_sword_left_hip |
     itcf_show_holster_when_drawn, 1600, weight(1.25) | difficulty(9) | spd_rtng(85) | weapon_length(95) | swing_damage(35, cut) | thrust_damage(17,  pierce), imodbits_sword_high],
    ["sword_medieval_d_long",         "My Lady Sword", [("BL_Sword01_01", 0), ("RichSword3_scab", ixmesh_carry)], itp_type_one_handed_wpn | itp_primary, itc_longsword | itcf_carry_sword_left_hip |
     itcf_show_holster_when_drawn, 1600, weight(1.25) | difficulty(9) | spd_rtng(85) | weapon_length(95) | swing_damage(35, cut) | thrust_damage(17,  pierce), imodbits_sword_high],
    ["sword_viking_1",         "Dyrnwyn", [("BL_Sword01_01", 0), ("RichSword3_scab", ixmesh_carry)], itp_type_one_handed_wpn | itp_primary, itc_longsword | itcf_carry_sword_left_hip |
     itcf_show_holster_when_drawn, 1600, weight(1.25) | difficulty(9) | spd_rtng(85) | weapon_length(95) | swing_damage(35, cut) | thrust_damage(17,  pierce), imodbits_sword_high],
    ...
    ["sword_viking_3", "Toiseach Gartnait's Sword", [("Kirkburn", 0), ("Kirkburn_scab", ixmesh_carry)], itp_type_one_handed_wpn | itp_primary, itc_longsword | itcf_carry_sword_left_hip |
     itcf_show_holster_when_drawn, 1580, weight(1.25) | difficulty(9) | spd_rtng(85) | weapon_length(95) | swing_damage(36, cut) | thrust_damage(22,  pierce), imodbits_sword_high],
    ...
    ["axe",                 "Engle Axe", [("axefaradon3", 0)], itp_type_one_handed_wpn | itp_merchandise | itp_primary | itp_secondary | itp_bonus_against_shield | itp_wooden_parry, itc_scimitar | itcf_carry_axe_left_hip,
     469, weight(2) | difficulty(9) | spd_rtng(80) | weapon_length(73) | swing_damage(30, pierce) | thrust_damage(0,  pierce), imodbits_axe, [], angle_saxon_kingdoms],
    ["vikingaxeb",                 "Frankish Long Axe", [("vikingaxeb", 0)], itp_type_one_handed_wpn | itp_merchandise | itp_primary | itp_secondary | itp_bonus_against_shield | itp_wooden_parry, itc_scimitar | itcf_carry_axe_left_hip,
     481, weight(2) | difficulty(9) | spd_rtng(79) | weapon_length(80) | swing_damage(31, pierce) | thrust_damage(0,  pierce), imodbits_axe, [], saxon_kingdoms_plus_east_angle],
    ["frankish_axe2",                 "Frankish Axe", [("frankish_Axe2", 0)], itp_type_one_handed_wpn | itp_primary | itp_secondary | itp_bonus_against_shield | itp_wooden_parry, itc_scimitar | itcf_carry_axe_left_hip,
     517, weight(2) | difficulty(7) | spd_rtng(80) | weapon_length(76) | swing_damage(34, pierce) | thrust_damage(0,  pierce), imodbits_axe, [], saxon_kingdoms_plus_east_angle],
    ["vikingaxe",                 "Decorated Axe", [("vikingaxe", 0)], itp_type_one_handed_wpn | itp_merchandise | itp_primary | itp_secondary | itp_bonus_against_shield | itp_wooden_parry, itc_scimitar | itcf_carry_axe_left_hip,
     467, weight(2) | difficulty(9) | spd_rtng(79) | weapon_length(70) | swing_damage(31, pierce) | thrust_damage(0,  pierce), imodbits_axe, [], angle_saxon_kingdoms],
    ["saxon_axe",                 "Saxon Axe", [("p_axe_1", 0)], itp_type_one_handed_wpn | itp_merchandise | itp_primary | itp_secondary | itp_bonus_against_shield | itp_wooden_parry, itc_scimitar | itcf_carry_axe_left_hip,
     461, weight(2) | difficulty(9) | spd_rtng(80) | weapon_length(76) | swing_damage(32, pierce) | thrust_damage(0,  pierce), imodbits_axe, [], angle_saxon_kingdoms],
    ["lui_battleaxetwoh",                 "Germanic Axe", [("lui_battleaxetwoh", 0)], itp_type_one_handed_wpn | itp_merchandise | itp_primary | itp_secondary | itp_bonus_against_shield | itp_wooden_parry, itc_scimitar | itcf_carry_axe_left_hip,
     483, weight(2) | difficulty(9) | spd_rtng(79) | weapon_length(79) | swing_damage(33, pierce) | thrust_damage(0,  pierce), imodbits_axe, [], angle_saxon_kingdoms],
    ...
    ["talak_nordic_axe",                 "Decorated Elite Axe", [("talak_nordic_axe", 0)], itp_type_one_handed_wpn | itp_merchandise | itp_primary | itp_secondary | itp_bonus_against_shield | itp_wooden_parry, itc_scimitar | itcf_carry_axe_left_hip,
     481, weight(2) | difficulty(9) | spd_rtng(80) | weapon_length(79) | swing_damage(33, pierce) | thrust_damage(0,  pierce), imodbits_axe, [], angle_saxon_kingdoms],
    ...
    ["axehammer1",                 "Basic Axe Hammer", [("axehammer", 0)], itp_type_one_handed_wpn | itp_merchandise | itp_primary | itp_secondary | itp_bonus_against_shield | itp_wooden_parry, itc_scimitar | itcf_carry_axe_left_hip,
     439, weight(2) | difficulty(7) | spd_rtng(79) | weapon_length(
         73) | swing_damage(29, pierce) | thrust_damage(0,  pierce), imodbits_axe,
     [], briton_kingdoms],
    ["gallic_axe_1", "Briton Axe", [("gallic_axe_1", 0)], itp_type_one_handed_wpn | itp_primary | itp_secondary | itp_bonus_against_shield | itp_wooden_parry, itc_scimitar | itcf_carry_axe_left_hip,
     433, weight(1.5) | difficulty(8) | spd_rtng(80) | weapon_length(
         63) | swing_damage(30, pierce) | thrust_damage(0,  pierce), imodbits_axe,
     [], pictish_irish_kingdoms],
    ...
    ["pictish_hatchet", "Pictish Hatchet", [("pictish_hatchet", 0)], itp_type_one_handed_wpn | itp_primary | itp_secondary | itp_bonus_against_shield | itp_wooden_parry, itc_scimitar | itcf_carry_axe_left_hip,
     491, weight(1.5) | difficulty(8) | spd_rtng(80) | weapon_length(
         60) | swing_damage(34, pierce) | thrust_damage(0,  pierce), imodbits_axe,
     [], pictish_irish_kingdoms],
    ["one_handed_war_axe_a", "Short Hatchet", [("cavalry_Axe", 0)], itp_type_one_handed_wpn | itp_primary | itp_secondary | itp_bonus_against_shield | itp_wooden_parry, itc_scimitar | itcf_carry_axe_left_hip,
     492, weight(1.5) | difficulty(8) | spd_rtng(79) | weapon_length(
         61) | swing_damage(33, pierce) | thrust_damage(0,  pierce), imodbits_axe,
     [], pictish_irish_kingdoms],
    ...
    ["one_handed_battle_axe_b", "Special Hatchet", [("cavalry_Axe", 0)], itp_type_one_handed_wpn | itp_primary | itp_secondary | itp_bonus_against_shield | itp_wooden_parry, itc_scimitar | itcf_carry_axe_left_hip,
     892, weight(1.5) | difficulty(8) | spd_rtng(82) | weapon_length(
         66) | swing_damage(38, pierce) | thrust_damage(0,  pierce), imodbits_axe,
     [], pictish_irish_kingdoms],
    ...
    ["staff",         "Staff", [("wooden_staff", 0)], itp_type_polearm | itp_offset_lance | itp_merchandise | itp_primary | itp_penalty_with_shield | itp_wooden_parry | itp_wooden_attack, itc_staff | itcf_carry_sword_back,
     70, weight(1.5) | spd_rtng(90) | weapon_length(140) | swing_damage(18, blunt) | thrust_damage(16,  blunt), imodbits_polearm],  # cambiado chief
    ["quarter_staff", "Short Staff", [("staff_new", 0)], itp_type_polearm | itp_offset_lance | itp_merchandise | itp_primary | itp_penalty_with_shield | itp_wooden_parry | itp_wooden_attack, itc_staff | itcf_carry_sword_back,
     90, weight(2) | spd_rtng(90) | weapon_length(130) | swing_damage(18, blunt) | thrust_damage(17,  blunt), imodbits_polearm],  # cambiado chief
    ...
    ["shepherds_crook", "Shepherd's Crook", [("shepherds_crook", 0)], itp_type_polearm | itp_merchandise | itp_cant_use_on_horseback | itp_primary | itp_penalty_with_shield | itp_wooden_parry | itp_wooden_attack, itc_staff | itcf_carry_sword_back,
     190, weight(2) | spd_rtng(87) | weapon_length(150) | swing_damage(19, blunt) | thrust_damage(10,  blunt), imodbits_polearm],
    # campesinos base
    ["pitch_fork",         "Pitch Fork", [("pitchfork_1", 0)], itp_merchandise | itp_type_polearm | itp_offset_lance | itp_primary | itp_penalty_with_shield | itp_wooden_parry | itp_wooden_attack, itc_staff | itcf_carry_sword_back,
     60, weight(3.5) | spd_rtng(70) | weapon_length(154) | swing_damage(17, blunt) | thrust_damage(14,  pierce), imodbit_bent],  # chief cambiado
    ["battle_fork",         "Pitch Fork", [("pitchfork_2", 0)], itp_merchandise | itp_type_polearm | itp_offset_lance | itp_primary | itp_penalty_with_shield | itp_wooden_parry | itp_wooden_attack, itc_staff | itcf_carry_sword_back,
        70, weight(3.5) | spd_rtng(70) | weapon_length(164) | swing_damage(18, blunt) | thrust_damage(15,  pierce), imodbit_bent],  # chief cambiado


    # todos
    # medium spear
    ["spear_1",         "Heavy Spear", [("fjadraspjot", 0)], itp_type_polearm | itp_offset_lance | itp_merchandise | itp_primary | itp_wooden_parry, itc_staff | itcf_carry_spear, 420, weight(
        4) | abundance(80) | difficulty(8) | spd_rtng(95) | weapon_length(160) | swing_damage(16, blunt) | thrust_damage(32,  pierce), imodbits_polearm],
    ["spear_2",         "Medium Spear", [("krokaspjott2", 0)], itp_type_polearm | itp_offset_lance | itp_merchandise | itp_primary | itp_wooden_parry, itc_staff | itcf_carry_spear, 460, weight(
        2.25) | abundance(80) | difficulty(7) | spd_rtng(96) | weapon_length(155) | swing_damage(15, blunt) | thrust_damage(31,  pierce), imodbits_polearm],
    ["spear_3",         "Light Spear", [("hoggkesja", 0)], itp_type_polearm | itp_offset_lance | itp_merchandise | itp_primary | itp_wooden_parry, itc_staff | itcf_carry_spear, 160, weight(
        1.7) | abundance(90) | difficulty(6) | spd_rtng(97) | weapon_length(157) | swing_damage(14, blunt) | thrust_damage(30,  pierce), imodbits_polearm],
    ["spear_6",         "Spear", [("spjot", 0)], itp_type_polearm | itp_offset_lance | itp_merchandise | itp_primary | itp_wooden_parry, itc_staff | itcf_carry_spear, 440, weight(
        1.4) | abundance(90) | difficulty(4) | spd_rtng(98) | weapon_length(145) | swing_damage(13, blunt) | thrust_damage(29,  pierce), imodbits_polearm],
    ...
    # long spear
    ["spear_8",         "Long Spear", [("spjotkesja", 0)], itp_type_polearm | itp_offset_lance | itp_merchandise | itp_primary | itp_wooden_parry, itc_staff | itcf_carry_spear, 180, weight(
        2.55) | abundance(60) | difficulty(8) | spd_rtng(95) | weapon_length(251) | swing_damage(15, blunt) | thrust_damage(30,  pierce), imodbits_polearm],
    ["spear_4",         "Long War Spear", [("langr_bryntvari", 0)], itp_type_polearm | itp_offset_lance | itp_merchandise | itp_primary | itp_wooden_parry, itc_staff | itcf_carry_spear, 495, weight(
        3.28) | abundance(40) | difficulty(10) | spd_rtng(95) | weapon_length(230) | swing_damage(16, blunt) | thrust_damage(32,  pierce), imodbits_polearm],
    ...
    ["spear_7",         "Briton Two-Handed Spear", [("langr_hoggspjott1", 0)], itp_type_polearm | itp_offset_lance | itp_primary | itp_two_handed | itp_wooden_parry, itc_spear | itcf_carry_spear, 600, weight(2.5) | abundance(60) | difficulty(12) | spd_rtng(95) | weapon_length(242) | swing_damage(20, blunt) | thrust_damage(40,  pierce), imodbits_polearm,
     [], briton_kingdoms],
    ["sarranid_two_handed_axe_b",         "Briton Short Spear", [("01atgeirr1", 0)], itp_type_polearm | itp_merchandise | itp_offset_lance | itp_primary | itp_wooden_parry, itc_staff | itcf_carry_spear, 360, weight(0.69) | abundance(100) | spd_rtng(107) | weapon_length(114) | swing_damage(12, cut) | thrust_damage(24,  pierce), imodbits_polearm,
     [], briton_kingdoms],
    ...
    ["twohand_spear",         "Two-Handed Spear", [("saxon2hspear", 0)], itp_type_polearm | itp_offset_lance | itp_primary | itp_two_handed | itp_wooden_parry, itc_spear | itcf_carry_spear, 400, weight(4) | spd_rtng(85) | weapon_length(199) | swing_damage(0, cut) | thrust_damage(40,  pierce), imodbits_polearm,
     [], angle_saxon_kingdoms],
    # spear 2 h cstadi con hoja larga como cuchilla
    ["saxon_spear", "Long Blade Spear", [("ped_heavy_spear_long", 0)], itp_type_polearm | itp_merchandise | itp_offset_lance | itp_primary | itp_two_handed | itp_wooden_parry,
     itc_staff | itcf_carry_spear, 880, weight(3) | difficulty(10) | spd_rtng(94) | weapon_length(136) | swing_damage(40, cut) | thrust_damage(36, pierce), imodbits_polearm],
    # 1 mano
    ["sarranid_axe_a",         "Saxon Short Spear", [("atgeirr1", 0)], itp_type_polearm | itp_merchandise | itp_offset_lance | itp_primary | itp_wooden_parry, itc_staff | itcf_carry_sword_left_hip, 360, weight(0.69) | abundance(100) | spd_rtng(107) | weapon_length(114) | swing_damage(12, cut) | thrust_damage(24,  pierce), imodbits_polearm,
     [], angle_saxon_kingdoms],
    ...
    ["boar_spear",         "Pictish Boar Spear", [("02svia2", 0)], itp_type_polearm | itp_merchandise | itp_offset_lance | itp_primary | itp_wooden_parry, itc_staff | itcf_carry_spear,
     425, weight(1.18) | abundance(80) | difficulty(6) | spd_rtng(88) | weapon_length(
         145) | swing_damage(16, blunt) | thrust_damage(27,  pierce), imodbits_polearm,
     [], pictish_irish_kingdoms],
    ...
    ["long_hafted_knobbed_mace",         "Breath of Dragon", [("05bryntvari2", 0)], itp_type_polearm | itp_offset_lance | itp_primary | itp_wooden_parry, itc_staff | itcf_carry_spear, 360, weight(
        2.55) | difficulty(8) | spd_rtng(86) | weapon_length(155) | swing_damage(15, blunt) | thrust_damage(33,  pierce), imodbit_balanced],
    ["long_hafted_spiked_mace",         "Raven", [("04bryntvari2", 0)], itp_type_polearm | itp_offset_lance | itp_primary | itp_wooden_parry, itc_staff | itcf_carry_spear, 360, weight(
        2.55) | difficulty(8) | spd_rtng(96) | weapon_length(155) | swing_damage(17, blunt) | thrust_damage(33,  pierce), imodbit_balanced],
    # lanzas especiales chief
    ["shortened_spear",         "Dawn Ray", [("krokaspjott1", 0)], itp_type_polearm | itp_offset_lance | itp_merchandise | itp_primary | itp_wooden_parry, itc_staff | itcf_carry_spear, 260, weight(
        2.55) | difficulty(8) | spd_rtng(96) | weapon_length(180) | swing_damage(13, blunt) | thrust_damage(32,  pierce), imodbit_balanced],
    ...
    ["wessexbanner1",         "Boar Banner", [("wessexbanner1", 0)], itp_type_two_handed_wpn | itp_two_handed | itp_primary | itp_cant_use_on_horseback, itc_greatsword, 780, weight(
        2) | difficulty(2) | spd_rtng(75) | weapon_length(140) | swing_damage(18, cut) | thrust_damage(0,  pierce), imodbits_none],  # chief cambiado
    ["wessexbanner2",         "Horse Banner", [("wessexbanner2", 0)], itp_type_two_handed_wpn | itp_two_handed | itp_primary | itp_cant_use_on_horseback, itc_greatsword, 780, weight(
        2) | difficulty(2) | spd_rtng(75) | weapon_length(140) | swing_damage(18, cut) | thrust_damage(0,  pierce), imodbits_none],  # chief cambiado
    ["wessexbanner3",         "Banner", [("wessexbanner3", 0)], itp_type_two_handed_wpn | itp_two_handed | itp_primary | itp_cant_use_on_horseback, itc_greatsword, 780, weight(
        2) | difficulty(2) | spd_rtng(75) | weapon_length(140) | swing_damage(18, cut) | thrust_damage(0,  pierce), imodbits_none],  # chief cambiado
    ["wessexbanner4",         "Banner", [("wessexbanner4", 0)], itp_type_two_handed_wpn | itp_two_handed | itp_primary | itp_cant_use_on_horseback, itc_greatsword, 780, weight(
        2) | difficulty(2) | spd_rtng(75) | weapon_length(140) | swing_damage(18, cut) | thrust_damage(0,  pierce), imodbits_none],  # chief cambiado
    ["wessexbanner5",         "Banner", [("wessexbanner5", 0)], itp_type_two_handed_wpn | itp_two_handed | itp_primary | itp_cant_use_on_horseback, itc_greatsword, 780, weight(
        2) | difficulty(2) | spd_rtng(75) | weapon_length(140) | swing_damage(18, cut) | thrust_damage(0,  pierce), imodbits_none],  # chief cambiado
    ["wessexbanner6",         "Banner", [("wessexbanner6", 0)], itp_type_two_handed_wpn | itp_two_handed | itp_primary | itp_cant_use_on_horseback, itc_greatsword, 780, weight(
        2) | difficulty(2) | spd_rtng(75) | weapon_length(140) | swing_damage(18, cut) | thrust_damage(0,  pierce), imodbits_none],  # chief cambiado
    ["wessexbanner7",         "Banner", [("wessexbanner7", 0)], itp_type_two_handed_wpn | itp_two_handed | itp_primary | itp_cant_use_on_horseback, itc_greatsword, 780, weight(
        2) | difficulty(2) | spd_rtng(75) | weapon_length(140) | swing_damage(18, cut) | thrust_damage(0,  pierce), imodbits_none],  # chief cambiado
    ["wessexbanner8",         "Banner", [("wessexbanner8", 0)], itp_type_two_handed_wpn | itp_two_handed | itp_primary | itp_cant_use_on_horseback, itc_greatsword, 780, weight(
        2) | difficulty(2) | spd_rtng(75) | weapon_length(140) | swing_damage(18, cut) | thrust_damage(0,  pierce), imodbits_none],  # chief cambiado
    ["wessexbanner9",         "Banner", [("wessexbanner9", 0)], itp_merchandise | itp_type_two_handed_wpn | itp_two_handed | itp_primary | itp_cant_use_on_horseback, itc_greatsword, 780, weight(
        2) | difficulty(2) | spd_rtng(75) | weapon_length(140) | swing_damage(18, cut) | thrust_damage(0,  pierce), imodbits_none],  # chief cambiado
    ...
    ["wooden_shield", "Small Round Shield", [("buckler1", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["nordic_shield", "Small Round Shield", [("buckler52", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["talak_buckler", "Small Round Shield", [("talak_buckler", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["ckler", "Small Round Shield", [("ckler", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  200, weight(
        2.5) | hit_points(240) | body_armor(4) | spd_rtng(85) | shield_width(45), imodbits_shield],
    ["buckler6", "Small Round Shield", [("buckler6", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler7", "Small Round Shield", [("buckler7", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler8", "Small Round Shield", [("buckler8", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler9", "Small Round Shield", [("buckler9", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler10", "Small Round Shield", [("buckler10", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler11", "Small Round Shield", [("buckler11", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler12", "Small Round Shield", [("buckler12", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler13", "Small Round Shield", [("buckler13", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler14", "Small Round Shield", [("buckler14", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler15", "Small Round Shield", [("buckler15", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler16", "Small Round Shield", [("buckler16", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler28", "Small Round Shield", [("buckler28", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler32", "Small Round Shield", [("buckler32", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler42", "Small Round Shield", [("buckler42", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],

    # celtas altos
    ["buckler17", "Small Round Shield", [("buckler17", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler18", "Small Round Shield", [("buckler18", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler19", "Small Round Shield", [("buckler19", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler20", "Small Round Shield", [("buckler20", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler21", "Small Round Shield", [("buckler21", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler22", "Small Round Shield", [("buckler22", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler23", "Small Round Shield", [("buckler23", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler24", "Small Round Shield", [("buckler24", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler25", "Small Round Shield", [("buckler25", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler26", "Small Round Shield", [("buckler26", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler27", "Small Round Shield", [("buckler27", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ["buckler29", "Small Round Shield", [("buckler29", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  300, weight(
        2) | hit_points(250) | body_armor(5) | spd_rtng(75) | shield_width(40), imodbits_shield],
    ...
    # escudos cantabros
    ["cantabro_shield_1", "Cantabrian Round Shield", [("cantabro_shield_1", 0)], itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  600, weight(
        4.5) | hit_points(400) | body_armor(10) | spd_rtng(55) | shield_width(70) | difficulty(2), imodbits_shield],
    ["cantabro_shield_2", "Cantabrian Round Shield", [("cantabro_shield_2", 0)], itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  600, weight(
        4.5) | hit_points(400) | body_armor(10) | spd_rtng(55) | shield_width(70) | difficulty(2), imodbits_shield],
    ["cantabro_shield_3", "Cantabrian Round Shield", [("cantabro_shield_3", 0)], itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  600, weight(
        4.5) | hit_points(400) | body_armor(10) | spd_rtng(55) | shield_width(70) | difficulty(2), imodbits_shield],
    ["cantabro_shield_4", "Cantabrian Round Shield", [("cantabro_shield_4", 0)], itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  600, weight(
        4.5) | hit_points(400) | body_armor(10) | spd_rtng(55) | shield_width(70) | difficulty(2), imodbits_shield],
    ["cantabro_shield_5", "Cantabrian Round Shield", [("cantabro_shield_5", 0)], itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  600, weight(
        4.5) | hit_points(400) | body_armor(10) | spd_rtng(55) | shield_width(70) | difficulty(2), imodbits_shield],
    ["cantabro_shield_6", "Cantabrian Round Shield", [("cantabro_shield_6", 0)], itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  600, weight(
        4.5) | hit_points(400) | body_armor(10) | spd_rtng(55) | shield_width(70) | difficulty(2), imodbits_shield],
    ["cantabro_shield_7", "Cantabrian Round Shield", [("cantabro_shield_7", 0)], itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  600, weight(
        4.5) | hit_points(400) | body_armor(10) | spd_rtng(55) | shield_width(70) | difficulty(2), imodbits_shield],
    ["cantabro_shield_8", "Cantabrian Round Shield", [("cantabro_shield_8", 0)], itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  600, weight(
        4.5) | hit_points(400) | body_armor(10) | spd_rtng(55) | shield_width(70) | difficulty(2), imodbits_shield],
    ["cantabro_shield_9", "Cantabrian Round Shield", [("cantabro_shield_9", 0)], itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  600, weight(
        4.5) | hit_points(400) | body_armor(10) | spd_rtng(55) | shield_width(70) | difficulty(2), imodbits_shield],
    ["cantabro_shield_10", "Cantabrian Round Shield", [("cantabro_shield_10", 0)], itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,  600, weight(
        4.5) | hit_points(400) | body_armor(10) | spd_rtng(55) | shield_width(70) | difficulty(2), imodbits_shield],
    ...
    ["tab_shield_round_a", "native", [("tableau_shield_round_5", 0)], itp_unique | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,
     26, weight(2.5) | hit_points(195) | body_armor(
         4) | spd_rtng(93) | shield_width(50), imodbits_shield,
    ...
    ["tab_shield_round_b", "native", [("tableau_shield_round_3", 0)], itp_unique | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,
     65, weight(3) | hit_points(260) | body_armor(
         8) | spd_rtng(90) | shield_width(50), imodbits_shield,
    ...
    ["tab_shield_round_c", "Banner Round Shield", [("tableau_shield_round_2", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,
     400, weight(4.5) | hit_points(350) | body_armor(8) | spd_rtng(
         55) | shield_width(65) | difficulty(2), imodbits_shield,
    ...
    ["tab_shield_round_d", "native", [("tableau_shield_round_1", 0)], itp_unique | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,
     210, weight(4) | hit_points(350) | body_armor(
         15) | spd_rtng(84) | shield_width(50), imodbits_shield,
    ...
    ["tab_shield_round_e", "native", [("tableau_shield_round_4", 0)], itp_unique | itp_type_shield, itcf_carry_round_shield,
     430, weight(4.5) | hit_points(410) | body_armor(
         19) | spd_rtng(81) | shield_width(50), imodbits_shield,
    ...
    ["tab_shield_kite_a", "native",   [("tableau_shield_kite_1", 0)], itp_unique | itp_type_shield | itp_wooden_parry, itcf_carry_kite_shield,
     33, weight(2) | hit_points(165) | body_armor(5) | spd_rtng(
         96) | shield_width(36) | shield_height(70), imodbits_shield,
    ...
    ["tab_shield_kite_b", "native",   [("tableau_shield_kite_3", 0)], itp_unique | itp_type_shield | itp_wooden_parry, itcf_carry_kite_shield,
     70, weight(2.5) | hit_points(215) | body_armor(10) | spd_rtng(
         93) | shield_width(36) | shield_height(70), imodbits_shield,
    ...
    ["tab_shield_kite_c", "native",   [("tableau_shield_kite_2", 0)], itp_unique | itp_type_shield | itp_wooden_parry, itcf_carry_kite_shield,
     156, weight(3) | hit_points(265) | body_armor(13) | spd_rtng(
         90) | shield_width(36) | shield_height(70), imodbits_shield,
    ...
    ["tab_shield_kite_d", "native",   [("tableau_shield_kite_2", 0)], itp_unique | itp_type_shield | itp_wooden_parry, itcf_carry_kite_shield,
     320, weight(3.5) | hit_points(310) | body_armor(18) | spd_rtng(
         87) | shield_width(36) | shield_height(70), imodbits_shield,
     [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"), (store_trigger_param_2, ":troop_no"), (call_script, "script_shield_item_set_banner", "tableau_kite_shield_2", ":agent_no", ":troop_no")])]],
    ["tab_shield_kite_cav_a", "native",   [("tableau_shield_kite_4", 0)], itp_unique | itp_type_shield | itp_wooden_parry, itcf_carry_kite_shield,
     205, weight(2) | hit_points(165) | body_armor(14) | spd_rtng(
         103) | shield_width(30) | shield_height(50), imodbits_shield,
    ...
    ["tab_shield_kite_cav_b", "native",   [("tableau_shield_kite_4", 0)], itp_unique | itp_type_shield, itcf_carry_kite_shield,
     360, weight(2.5) | hit_points(225) | body_armor(23) | spd_rtng(
         100) | shield_width(30) | shield_height(50), imodbits_shield,
     [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"), (store_trigger_param_2, ":troop_no"), (call_script, "script_shield_item_set_banner", "tableau_kite_shield_4", ":agent_no", ":troop_no")])]],

    ["tab_shield_heater_a", "native",   [("tableau_shield_heater_1", 0)], itp_unique | itp_type_shield | itp_wooden_parry, itcf_carry_kite_shield,
     36, weight(2) | hit_points(160) | body_armor(6) | spd_rtng(
         96) | shield_width(36) | shield_height(70), imodbits_shield,
    ...
    ["tab_shield_heater_cav_a", "native",   [("tableau_shield_heater_2", 0)], itp_unique | itp_type_shield | itp_wooden_parry, itcf_carry_kite_shield,
     229, weight(2) | hit_points(160) | body_armor(16) | spd_rtng(
         103) | shield_width(30) | shield_height(50), imodbits_shield,
    ...
    ["tab_shield_heater_cav_b", "native",   [("tableau_shield_heater_2", 0)], itp_unique | itp_type_shield | itp_wooden_parry, itcf_carry_kite_shield,
     390, weight(2.5) | hit_points(220) | body_armor(23) | spd_rtng(
         100) | shield_width(30) | shield_height(50), imodbits_shield,
     [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"), (store_trigger_param_2, ":troop_no"), (call_script, "script_shield_item_set_banner", "tableau_heater_shield_2", ":agent_no", ":troop_no")])]],
    ...
    ["tab_shield_pavise_a", "native",   [("tableau_shield_pavise_2", 0)], itp_unique | itp_type_shield | itp_cant_use_on_horseback | itp_wooden_parry, itcf_carry_board_shield,
     60, weight(3.5) | hit_points(280) | body_armor(4) | spd_rtng(
         89) | shield_width(43) | shield_height(100), imodbits_shield,
    ...
    ["tab_shield_pavise_b", "native",   [("tableau_shield_pavise_2", 0)], itp_unique | itp_type_shield | itp_cant_use_on_horseback | itp_wooden_parry, itcf_carry_board_shield,
     114, weight(4) | hit_points(360) | body_armor(8) | spd_rtng(
         85) | shield_width(43) | shield_height(100), imodbits_shield,
     [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"), (store_trigger_param_2, ":troop_no"), (call_script, "script_shield_item_set_banner", "tableau_pavise_shield_2", ":agent_no", ":troop_no")])]],
    ["tab_shield_pavise_c", "native",   [("tableau_shield_pavise_1", 0)], itp_unique | itp_type_shield | itp_cant_use_on_horseback | itp_wooden_parry, itcf_carry_board_shield,
     210, weight(4.5) | hit_points(430) | body_armor(10) | spd_rtng(
         81) | shield_width(43) | shield_height(100), imodbits_shield,
     [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"), (store_trigger_param_2, ":troop_no"), (call_script, "script_shield_item_set_banner", "tableau_pavise_shield_1", ":agent_no", ":troop_no")])]],
    ["tab_shield_pavise_d", "native",   [("tableau_shield_pavise_1", 0)], itp_unique | itp_type_shield | itp_cant_use_on_horseback | itp_wooden_parry, itcf_carry_board_shield,
     370, weight(5) | hit_points(550) | body_armor(14) | spd_rtng(
         78) | shield_width(43) | shield_height(100), imodbits_shield,
     [(ti_on_init_item, [(store_trigger_param_1, ":agent_no"), (store_trigger_param_2, ":troop_no"), (call_script, "script_shield_item_set_banner", "tableau_pavise_shield_1", ":agent_no", ":troop_no")])]],
    ...
    ["tab_shield_small_round_a", "native", [("tableau_shield_small_round_3", 0)], itp_unique | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,
     96, weight(2) | hit_points(160) | body_armor(
         8) | spd_rtng(105) | shield_width(40), imodbits_shield,
    ...
    ["tab_shield_small_round_b", "native", [("tableau_shield_small_round_1", 0)], itp_unique | itp_type_shield | itp_wooden_parry, itcf_carry_round_shield,
     195, weight(2.5) | hit_points(200) | body_armor(
         14) | spd_rtng(103) | shield_width(40), imodbits_shield,
    ...
    ["darts",         "darts", [("dart_b", 0), ("dart_b_bag", ixmesh_carry)], itp_type_thrown | itp_merchandise | itp_primary, itcf_throw_javelin | itcf_carry_quiver_right_vertical | itcf_show_holster_when_drawn,
     85, weight(2) | difficulty(1) | spd_rtng(90) | shoot_speed(30) | thrust_damage(23,  pierce) | max_ammo(
         7) | weapon_length(32) | accuracy(80), imodbits_thrown, missile_distance_trigger,
     [], pictish_irish_kingdoms],
    ...
    ["javelin_melee",         "Javelin", [("atgeirr1", 0)], itp_type_polearm | itp_primary | itp_secondary | itp_wooden_parry, itc_staff,
     200, weight(2) | spd_rtng(82) | swing_damage(9, cut) | thrust_damage(25,  cut) | weapon_length(65), imodbits_polearm],  # chief cambiado
    ...
    ["throwing_knives",         "Wooden Javelins", [("kijek", 0)], itp_type_thrown | itp_merchandise | itp_primary | itp_secondary | itp_next_item_as_melee, itcf_throw_javelin,
     190, weight(2) | spd_rtng(85) | shoot_speed(33) | thrust_damage(27,  cut) | max_ammo(
         4) | weapon_length(60) | accuracy(90), imodbits_thrown, missile_distance_trigger,  # chief cambiado max_ammo
     [], briton_kingdoms],
    ...
    ["jarid",         "Angons", [("angon1", 0)], itp_type_thrown | itp_merchandise | itp_primary | itp_secondary | itp_bonus_against_shield | itp_next_item_as_melee, itcf_throw_javelin,
     425, weight(2) | difficulty(2) | spd_rtng(65) | shoot_speed(17) | thrust_damage(41,  pierce) | max_ammo(
         1) | weapon_length(100) | accuracy(85), imodbits_thrown, missile_distance_trigger,  # cambiado chief
     [], angle_saxon_kingdoms],
    ...
    ["throwing_spears3",         "Angons", [("05kastad_krokaspjott", 0)], itp_type_thrown | itp_merchandise | itp_primary | itp_secondary | itp_bonus_against_shield | itp_next_item_as_melee, itcf_throw_javelin,
     415, weight(2) | difficulty(2) | spd_rtng(75) | shoot_speed(19) | thrust_damage(37,  pierce) | max_ammo(
         1) | weapon_length(100) | accuracy(85), imodbits_thrown, missile_distance_trigger,  # cambiado chief
     [], angle_saxon_kingdoms],
    ...
    ["throwing_spears4",         "Angons", [("kastspjottmidtaggir", 0)], itp_type_thrown | itp_merchandise | itp_primary | itp_secondary | itp_bonus_against_shield | itp_next_item_as_melee, itcf_throw_javelin,
     435, weight(2) | difficulty(2) | spd_rtng(60) | shoot_speed(15) | thrust_damage(44,  pierce) | max_ammo(
         1) | weapon_length(100) | accuracy(85), imodbits_thrown, missile_distance_trigger,  # cambiado chief
     [], angle_saxon_kingdoms],
    ...
    ["stones",         "Stones", [("throwing_stone", 0)], itp_type_thrown | itp_merchandise | itp_primary | itp_secondary, itcf_throw_stone, 1, weight(1) | difficulty(
        0) | spd_rtng(95) | shoot_speed(20) | thrust_damage(17,  blunt) | max_ammo(6) | weapon_length(8), imodbit_large_bag, missile_distance_trigger],  # chief cambiado
    ...
    ["light_throwing_axes", "Francisca", [("francisca", 0)], itp_type_thrown | itp_merchandise | itp_primary | itp_secondary | itp_bonus_against_shield | itp_next_item_as_melee, itcf_throw_axe,
     380, weight(3) | difficulty(4) | spd_rtng(65) | shoot_speed(15) | thrust_damage(42, cut) | max_ammo(1) | weapon_length(53), imodbits_thrown_minus_heavy, missile_distance_trigger, [], saxon_kingdoms_minus_gewissae],  # cambiado chief
    ["light_throwing_axes_melee", "Francisca", [("francisca", 0)], itp_type_one_handed_wpn | itp_primary | itp_secondary | itp_bonus_against_shield, itc_scimitar,
     380, weight(3) | difficulty(4) | spd_rtng(75) | weapon_length(53) | swing_damage(35, cut), imodbits_thrown_minus_heavy, [], jute_kingdoms],  # cambiado chief
    ["throwing_axes", "Light Francisca", [("francisca_afilada", 0)], itp_type_thrown | itp_merchandise | itp_primary | itp_secondary | itp_bonus_against_shield | itp_next_item_as_melee, itcf_throw_axe,
     360, weight(2) | difficulty(2) | spd_rtng(69) | shoot_speed(18) | thrust_damage(39, cut) | max_ammo(1) | weapon_length(53), imodbits_thrown_minus_heavy, missile_distance_trigger, [], saxon_kingdoms_minus_gewissae],  # cambiado chief
    ["throwing_axes_melee", "Light Francisca", [("francisca_afilada", 0)], itp_type_one_handed_wpn | itp_primary | itp_secondary | itp_bonus_against_shield, itc_scimitar,
     380, weight(2) | difficulty(2) | spd_rtng(75) | weapon_length(53) | swing_damage(35, cut), imodbits_thrown_minus_heavy, [], jute_kingdoms],  # cambiado chief


    ##################chief finales arcos empieza##############################################
    ###########################################################################################
    ["hunting_bow",         "Hunting Bow", [("hunting_bow1", 0), ("hunting_bow_carry1", ixmesh_carry)], itp_type_bow | itp_merchandise | itp_primary | itp_two_handed, itcf_shoot_bow |
     itcf_carry_bow_back, 267, weight(1) | difficulty(1) | spd_rtng(70) | shoot_speed(47) | thrust_damage(18,  pierce) | accuracy(85), imodbits_bow],  # chief cambiado
    ...
    ["hunting_crossbow", "Pictish Crossbow", [("xenoargh_arbalest", 0)], itp_type_crossbow | itp_merchandise | itp_primary | itp_cant_use_on_horseback | itp_two_handed, itcf_shoot_crossbow | itcf_carry_crossbow_back,
     250, weight(2.25) | difficulty(1) | spd_rtng(40) | shoot_speed(45) | thrust_damage(20,  pierce) | max_ammo(1) | accuracy(85), imodbits_crossbow, [], pictish_kingdoms],  # chief cambiado
    ...
    ["flintlock_pistol", "Sling", [("Sling", 0)],
     itp_type_pistol | itp_merchandise | itp_primary | itp_cant_use_on_horseback, itcf_throw_stone, 30, weight(0.5) | spd_rtng(60) | shoot_speed(50) | thrust_damage(19, blunt) | max_ammo(1) | accuracy(90), imodbits_none, [(ti_on_weapon_attack, [(play_sound, "snd_throw_stone")])]],
    ["flintlock_pistol_militar", "Military Sling", [("Slingmilitargrande", 0)],
     itp_type_pistol | itp_merchandise | itp_primary | itp_cant_use_on_horseback, itcf_throw_stone, 90, weight(0.5) | spd_rtng(65) | shoot_speed(55) | thrust_damage(23, blunt) | max_ammo(1) | accuracy(93), imodbits_none, [(ti_on_weapon_attack, [(play_sound, "snd_throw_stone")])]],
    ["heavy_crossbow", "Fustibalus", [("Staf_Sling_fustibalus", 0)],
     itp_type_pistol | itp_merchandise | itp_primary | itp_cant_use_on_horseback, itcf_throw_stone, 110, weight(1) | spd_rtng(70) | shoot_speed(75) | thrust_damage(23, blunt) | max_ammo(1) | accuracy(90), imodbits_none, [(ti_on_weapon_attack, [(play_sound, "snd_throw_stone")])]],
    ...
    ["lyre", "Lyre", [("lyre", 0)], itp_merchandise | itp_type_shield | itp_wooden_parry | itp_civilian,
     itcf_carry_bow_back,  218, weight(2.5) | hit_points(80) | body_armor(1) | spd_rtng(82) | weapon_length(90), 0],
    ["lute", "Lute", [("lute", 0)], itp_type_shield | itp_wooden_parry | itp_civilian, itcf_carry_bow_back,
     218, weight(2.5) | hit_points(80) | body_armor(1) | spd_rtng(82) | weapon_length(90), 0],
    ["instruments_end", "Instruments End", [
        ("leathershield_small_b", 0)], 0, 0, 1, 0, 0],
    ...
    # bebe, hijo de player
    ["baby",         "Baby", [("baby", 0)], itp_always_loot | itp_type_goods, 0,
    ...
    #-#-#-#Hunting chief Mod begin#-#-#-#
    #-#-#-#-#-#-#-#-#-#-#-#-#-#-#
    ["deer", "Deer", [("deer", 0)], itp_unique | itp_type_horse, 0, 1411, abundance(40) | hit_points(30) | body_armor(
        5) | difficulty(11) | horse_speed(50) | horse_maneuver(32) | horse_charge(20), imodbits_horse_basic],
    ["boar", "Boar", [("boar", 0)], itp_unique | itp_type_horse, 0, 1411, abundance(40) | hit_points(80) | body_armor(
        15) | difficulty(11) | horse_speed(25) | horse_maneuver(20) | horse_charge(200) | horse_scale(55), imodbits_horse_basic],
    ["wolf", "Wolf", [("warg", 0)], itp_unique | itp_type_horse, 0, 1411, abundance(40) | hit_points(80) | body_armor(
        10) | difficulty(11) | horse_speed(30) | horse_maneuver(40) | horse_charge(100) | horse_scale(55), imodbits_horse_basic],
    ["coat", "Goat", [("goat", 0)], itp_unique | itp_type_horse, 0, 1411, abundance(40) | hit_points(20) | body_armor(
        8) | difficulty(11) | horse_speed(35) | horse_maneuver(30) | horse_charge(20) | horse_scale(55), imodbits_horse_basic],
    ["coat_b", "Goat", [("goat_c", 0)], itp_unique | itp_type_horse, 0, 1411, abundance(40) | hit_points(20) | body_armor(
        8) | difficulty(11) | horse_speed(35) | horse_maneuver(30) | horse_charge(20) | horse_scale(55), imodbits_horse_basic],
    ["wilddonkey", "Wild Donkey", [("wild_donkey", 0)], itp_unique | itp_type_horse, 0, 1411, abundance(30) | hit_points(40) | body_armor(
        10) | difficulty(11) | horse_speed(25) | horse_maneuver(20) | horse_charge(50) | horse_scale(65), imodbits_horse_basic],
    #-#-#-#-#-#-#-#-#-#-#-#-#-#-#
    #-#-#-#Hunting chief Mod end#-#-#-#
    #-#-#-#-#-#-#-#-#-#-#-#-#-#-#
    ...
    #Otros, cuerno####
    ###########
    ["horn", "Horn", [("horn", 0), ("bolaf", 0)], itp_type_thrown | itp_primary | itp_no_pick_up_from_ground, itcf_throw_knife, 145, weight(1.5) | spd_rtng(50) | shoot_speed(54) | thrust_damage(3,  cut) | max_ammo(3) | weapon_length(0), imodbits_thrown,
     [(ti_on_weapon_attack, [
    ...
    ["trophy_a", "Battle Trophy", [("horn", 0)], itp_type_goods | itp_always_loot, 0,
     210, weight(3) | abundance(90), imodbits_none],
    ["trophy_b", "War Trophy", [("wessexbanner8", 0)], itp_type_goods | itp_always_loot,
     0, 410, weight(7) | abundance(90), imodbits_none],
    ["trophy_c", "Epic King Trophy", [("chest_c", 0)], itp_type_goods | itp_always_loot,
    ...
    ["practice_arrows_2", "Practice Arrows", [("arena_arrow", 0), ("flying_arrow", ixmesh_flying_ammo), ("quiver", ixmesh_carry)], itp_type_arrows,
     itcf_carry_quiver_back, 0, weight(1.5) | weapon_length(95) | max_ammo(80), imodbits_missile, missile_distance_trigger],
    # cuerno multiplayer chief
    ["bodkin_arrows", "Horn", [("horn", 0), ], itp_type_one_handed_wpn | itp_primary | itp_secondary | itp_next_item_as_melee, itc_longsword, 145, weight(
        1.5) | spd_rtng(50) | weapon_length(99) | swing_damage(36, cut) | thrust_damage(12,  pierce), imodbits_none],

    ["steel_bolts",         "Siege Stones", [("siegestone", 0)], itp_type_thrown | itp_primary | itp_secondary, itcf_throw_stone, 10, weight(4) | spd_rtng(60) | shoot_speed(8) | thrust_damage(25,  blunt) | max_ammo(3) | weapon_length(14), imodbits_none,  # chief cambiado
     [
        (ti_on_missile_hit,
         [
             (try_begin),
    ...
    ["scale_gauntlets",         "Boiling Water", [("boiling_water", 0)], itp_type_thrown | itp_can_penetrate_shield | itp_unique | itp_primary | itp_secondary, itcf_throw_stone, 10, weight(5) | spd_rtng(60) | shoot_speed(6) | thrust_damage(35,  blunt) | max_ammo(2) | weapon_length(14), imodbits_none,  # chief cambiado
     [(ti_on_missile_hit,
       [
    ...
    ###########Flechas acaba chief ####################
    # chief original unique para q no se vea en el juego
    ["lamellar_gauntlets", "native", [("scale_gauntlets_a_L", 0)], itp_unique | itp_type_hand_armor, 0, 910, weight(
        0.75) | abundance(100) | body_armor(5), imodbits_armor],
    ["gauntlets", "native", [("gauntlets_L", 0), ("gauntlets_L", imodbit_reinforced)], itp_unique | itp_type_hand_armor,
     0, 1040, weight(1.0) | abundance(100) | body_armor(6), imodbits_armor],
    ...
    ["felt_hat", "native", [("head_wrapping_bry", 0)], itp_unique | itp_type_head_armor | itp_civilian, 0, 4, weight(
        1) | abundance(100) | head_armor(8) | body_armor(0) | leg_armor(0), imodbits_cloth],
    ["felt_hat_b", "native", [("head_wrapping_bry", 0)], itp_unique | itp_type_head_armor | itp_civilian, 0, 4, weight(
        1) | abundance(100) | head_armor(8) | body_armor(0) | leg_armor(0), imodbits_cloth],
    ["woolen_hose", "native", [("head_wrapping_bry", 0)], itp_unique | itp_type_head_armor | itp_civilian, 0, 9, weight(
        1) | abundance(100) | head_armor(10) | body_armor(0) | leg_armor(0), imodbits_cloth],
    # chief unique acaba
    ...
    try:
        ...
        for i_item in range(1, len(orig_items)):
            ...
            if itp_type_one_handed_wpn <= type <= itp_type_polearm and (get_thrust_damage(add_item[i_item][6]) & 0xff) > 0 and "tutorial" not in add_item[i_item][0] and "arena" not in add_item[i_item][0] and "practice" not in add_item[i_item][0] and "tpe" not in add_item[i_item][0]:
                ...
                # add noswing_ to the item's name
                add_item[i_item][0] = 'noswing_'+add_item[i_item][0]
                add_item[i_item][6] = add_item[i_item][6] & ~(
                    ibf_damage_mask << iwf_swing_damage_bits)  # should set new item's swing damage to 0
                # remove itcf_ capabilties to prevent swinging without damage
                add_item[i_item][4] = add_item[i_item][4] & ~itcf_overswing_polearm
                ...
                if type == itp_type_polearm and add_item[i_item][3] & itp_two_handed == 0:
                    # so that the polearms use 'bent elbow' with shields, but normal without
                    add_item[i_item][4] = add_item[i_item][4] | itcf_thrust_onehanded
