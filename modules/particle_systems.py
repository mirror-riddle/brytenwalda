from headers.particle_systems import *
...
#  2) Particle system flags (int). See headers.particle_systems.py for a list of available flags
#  3) mesh-name.
####
...
particle_systems = [
    ...
    ("game_rain", psf_billboard_2d | psf_global_emit_dir | psf_always_emit, "prtcl_rain",
     1000, 0.7, 0.33, 2.0, 10.0, 0.0,  # num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
    ...
    ("agua_hirviendo", psf_billboard_3d | psf_randomize_size | psf_randomize_rotation,  "prt_mesh_smoke_1",
     5000, 5, 1, 0.5, 10, 10,  # num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
