...
from headers.common import bignum
...
# you have to add ico_custom_x (where x is a number between 1 and 7) mesh in order to display it correctly.
def custom_kill_info(x):
